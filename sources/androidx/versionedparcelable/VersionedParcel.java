...
public abstract class VersionedParcel {
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException writing serializable object (name = " + name + Constants.RIGHT_BRACKET_ONLY, e);
        }
    }
    ...
    protected Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException reading a Serializable object (name = " + readString + Constants.RIGHT_BRACKET_ONLY, e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = " + readString + Constants.RIGHT_BRACKET_ONLY, e2);
        }
    }
