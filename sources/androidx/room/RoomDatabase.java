...
public abstract class RoomDatabase {
    ...
    public void init(DatabaseConfiguration databaseConfiguration) {
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                for (Migration migration : getAutoMigrations(this.mAutoMigrationSpecs)) {
                    if (!databaseConfiguration.migrationContainer.getMigrations().containsKey(Integer.valueOf(migration.startVersion))) {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.RoomDatabase$$ExternalSyntheticLambda0
                ...
                public final Object apply(Object obj) {
                    return RoomDatabase.this.m72lambda$beginTransaction$0$androidxroomRoomDatabase((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ Object m72lambda$beginTransaction$0$androidxroomRoomDatabase(SupportSQLiteDatabase supportSQLiteDatabase) {
        internalBeginTransaction();
        return null;
    }
    ...
    public void endTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: androidx.room.RoomDatabase$$ExternalSyntheticLambda1
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    return RoomDatabase.this.m73lambda$endTransaction$1$androidxroomRoomDatabase((SupportSQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ Object m73lambda$endTransaction$1$androidxroomRoomDatabase(SupportSQLiteDatabase supportSQLiteDatabase) {
        internalEndTransaction();
        return null;
    }
        ...
        */
        private java.util.List<androidx.room.migration.Migration> findUpMigrationPath(java.util.List<androidx.room.migration.Migration> r5, boolean r6, int r7, int r8) {
            ...
            L41:
                ...
                androidx.room.migration.Migration r7 = (androidx.room.migration.Migration) r7
                r5.add(r7)
                r7 = 1
                r0 = r7
                r7 = r3
