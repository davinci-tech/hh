...
public final class SavedStateHandle {
    ...
    public static final Bundle m53savedStateProvider$lambda0(SavedStateHandle savedStateHandle) {
        uhy.e((Object) savedStateHandle, "");
        for (Map.Entry entry : ufs.e(savedStateHandle.savedStateProviders).entrySet()) {
        ...
        return BundleKt.bundleOf(to.d(KEYS, arrayList), to.d("values", arrayList2));
    }
    ...
    public SavedStateHandle(Map<String, ? extends Object> map) {
        ...
        this.savedStateProvider = new SavedStateRegistry.SavedStateProvider() { // from class: androidx.lifecycle.SavedStateHandle$$ExternalSyntheticLambda0
            ...
            public final Bundle saveState() {
                Bundle m53savedStateProvider$lambda0;
                m53savedStateProvider$lambda0 = SavedStateHandle.m53savedStateProvider$lambda0(SavedStateHandle.this);
                return m53savedStateProvider$lambda0;
            }
        };
    ...
    public final <T> StateFlow<T> getStateFlow(String key, T initialValue) {
        ...
        if (mutableStateFlow == null) {
            ...
            mutableStateFlow = NONE.b(this.regular.get(key));
            this.flows.put(key, mutableStateFlow);
            map.put(key, mutableStateFlow);
        }
        return unp.e(mutableStateFlow);
    }

    public final Set<String> keys() {
        return ufu.a(ufu.a(this.regular.keySet(), this.savedStateProviders.keySet()), this.liveDatas.keySet());
    }
    ...
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0003\b\u0000\u0018\u0000*\u0004\b\u0000\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B!\b\u0016\u0012\b\u0010\u0003\u001a\u0004\u0018\u00010\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006\u0012\u0006\u0010\u0007\u001a\u00028\u0000¢\u0006\u0002\u0010\bB\u0019\b\u0016\u0012\b\u0010\u0003\u001a\u0004\u0018\u00010\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\tJ\u0006\u0010\n\u001a\u00020\u000bJ\u0015\u0010\f\u001a\u00020\u000b2\u0006\u0010\u0007\u001a\u00028\u0000H\u0016¢\u0006\u0002\u0010\rR\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u000e"}, d2 = {"Landroidx/lifecycle/SavedStateHandle$SavingStateLiveData;", ExifInterface.GPS_DIRECTION_TRUE, "Landroidx/lifecycle/MutableLiveData;", "handle", "Landroidx/lifecycle/SavedStateHandle;", MedalConstants.EVENT_KEY, "", "value", "(Landroidx/lifecycle/SavedStateHandle;Ljava/lang/String;Ljava/lang/Object;)V", "(Landroidx/lifecycle/SavedStateHandle;Ljava/lang/String;)V", "detach", "", "setValue", "(Ljava/lang/Object;)V", "lifecycle-viewmodel-savedstate_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
