...
public final class SavedStateRegistry {
    ...
    public final SavedStateProvider getSavedStateProvider(String key) {
        ...
        while (it.hasNext()) {
            ...
            if (uhy.e((Object) key2, (Object) key)) {
                return value;
            }
        }
        return null;
    ...
    public final void performAttach$savedstate_release(Lifecycle lifecycle) {
        ...
        lifecycle.addObserver(new LifecycleEventObserver() { // from class: androidx.savedstate.SavedStateRegistry$$ExternalSyntheticLambda0
            ...
            public final void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
                SavedStateRegistry.m74performAttach$lambda4(SavedStateRegistry.this, lifecycleOwner, event);
            }
        });
        this.attached = true;
    }
    ...
    public static final void m74performAttach$lambda4(SavedStateRegistry savedStateRegistry, LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        uhy.e((Object) savedStateRegistry, "");
        uhy.e((Object) lifecycleOwner, "");
        uhy.e((Object) event, "");
