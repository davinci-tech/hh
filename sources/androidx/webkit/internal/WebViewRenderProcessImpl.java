...
public class WebViewRenderProcessImpl extends WebViewRenderProcess {
    ...
    public static WebViewRenderProcessImpl forInvocationHandler(InvocationHandler invocationHandler) {
        final WebViewRendererBoundaryInterface webViewRendererBoundaryInterface = (WebViewRendererBoundaryInterface) uxe.b(WebViewRendererBoundaryInterface.class, invocationHandler);
