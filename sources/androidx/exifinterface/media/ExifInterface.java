...
public class ExifInterface {
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag(TAG_NEW_SUBFILE_TYPE, HwWorkoutServiceUtils.HEART_RATE_TRUST_VALUE, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, 258, 3), new ExifTag(TAG_COMPRESSION, 259, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, 270, 2), new ExifTag(TAG_MAKE, OldToNewMotionPath.SPORT_TYPE_BASKETBALL, 2), new ExifTag(TAG_MODEL, 272, 2), new ExifTag(TAG_STRIP_OFFSETS, OldToNewMotionPath.SPORT_TYPE_CROSS_TRAINER, 3, 4), new ExifTag(TAG_ORIENTATION, OldToNewMotionPath.SPORT_TYPE_ROW_MACHINE, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, 277, 3), new ExifTag(TAG_ROWS_PER_STRIP, OldToNewMotionPath.SPORT_TYPE_BODY_BUILDING, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, OldToNewMotionPath.SPORT_TYPE_OTHER_SPORT, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, 283, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, FitWorkout.CATEGORY_REAL_SCENE, 3), new ExifTag(TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, TypedValues.AttributesType.TYPE_PIVOT_TARGET, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, 5), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, d.a.d, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_RW2_SENSOR_TOP_BORDER, 4, 4), new ExifTag(TAG_RW2_SENSOR_LEFT_BORDER, 5, 4), new ExifTag(TAG_RW2_SENSOR_BOTTOM_BORDER, 6, 4), new ExifTag(TAG_RW2_SENSOR_RIGHT_BORDER, 7, 4), new ExifTag(TAG_RW2_ISO, 23, 3), new ExifTag(TAG_RW2_JPG_FROM_RAW, 46, 7), new ExifTag(TAG_XMP, 700, 1)};
        ...
        ExifTag[] exifTagArr5 = {new ExifTag(TAG_NEW_SUBFILE_TYPE, HwWorkoutServiceUtils.HEART_RATE_TRUST_VALUE, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, 258, 3), new ExifTag(TAG_COMPRESSION, 259, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, 270, 2), new ExifTag(TAG_MAKE, OldToNewMotionPath.SPORT_TYPE_BASKETBALL, 2), new ExifTag(TAG_MODEL, 272, 2), new ExifTag(TAG_STRIP_OFFSETS, OldToNewMotionPath.SPORT_TYPE_CROSS_TRAINER, 3, 4), new ExifTag(TAG_THUMBNAIL_ORIENTATION, OldToNewMotionPath.SPORT_TYPE_ROW_MACHINE, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, 277, 3), new ExifTag(TAG_ROWS_PER_STRIP, OldToNewMotionPath.SPORT_TYPE_BODY_BUILDING, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, OldToNewMotionPath.SPORT_TYPE_OTHER_SPORT, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, 283, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, FitWorkout.CATEGORY_REAL_SCENE, 3), new ExifTag(TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, TypedValues.AttributesType.TYPE_PIVOT_TARGET, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, 5), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, d.a.d, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_DNG_VERSION, 50706, 1), new ExifTag(TAG_DEFAULT_CROP_SIZE, 50720, 3, 4)};
        IFD_THUMBNAIL_TAGS = exifTagArr5;
        TAG_RAF_IMAGE_SIZE = new ExifTag(TAG_STRIP_OFFSETS, OldToNewMotionPath.SPORT_TYPE_CROSS_TRAINER, 3);
        ...
        JPEG_INTERCHANGE_FORMAT_LENGTH_TAG = new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, d.a.d, 4);
    ...
    static class Rational {
        ...
        Rational(double d) {
            this((long) (d * 10000.0d), PreConnectManager.CONNECT_INTERNAL);
        }
    ...
    static class ExifAttribute {
        ...
        public String toString() {
            return Constants.LEFT_BRACKET_ONLY + ExifInterface.IFD_FORMAT_NAMES[this.format] + ", data length:" + this.bytes.length + Constants.RIGHT_BRACKET_ONLY;
        }

        /* JADX WARN: Not initialized variable reg: 3, insn: 0x0182: MOVE (r2 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:167:0x0182 */
    ...
    public static boolean isSupportedMimeType(String str) {
        ...
        switch (lowerCase.hashCode()) {
            ...
            case -1487464690:
                ...
                break;
            case -1487394660:
                if (lowerCase.equals(MimeType.JPEG)) {
                    c = 5;
                    break;
                }
                c = 65535;
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(11:10|(1:12)(1:102)|13|14|(8:(2:16|(1:18)(2:71|72))(2:73|(17:75|76|77|78|79|20|21|22|(1:24)(2:63|(1:65)(1:66))|25|27|28|29|30|(1:32)(2:35|(1:37)(2:38|(1:40)))|33|34)(1:97))|27|28|29|30|(0)(0)|33|34)|19|20|21|22|(0)(0)|25) */
    ...
    /* JADX WARN: Removed duplicated region for block: B:24:0x00b1 A[Catch: all -> 0x0104, Exception -> 0x0107, TryCatch #13 {Exception -> 0x0107, all -> 0x0104, blocks: (B:22:0x00a8, B:24:0x00b1, B:25:0x00cb, B:63:0x00b9, B:65:0x00bd), top: B:21:0x00a8 }] */
    /* JADX WARN: Removed duplicated region for block: B:32:0x00da A[Catch: all -> 0x00f9, Exception -> 0x00fc, TryCatch #11 {Exception -> 0x00fc, all -> 0x00f9, blocks: (B:30:0x00d5, B:32:0x00da, B:37:0x00e2, B:40:0x00ea), top: B:29:0x00d5 }] */
    /* JADX WARN: Removed duplicated region for block: B:35:0x00de  */
    /* JADX WARN: Removed duplicated region for block: B:63:0x00b9 A[Catch: all -> 0x0104, Exception -> 0x0107, TryCatch #13 {Exception -> 0x0107, all -> 0x0104, blocks: (B:22:0x00a8, B:24:0x00b1, B:25:0x00cb, B:63:0x00b9, B:65:0x00bd), top: B:21:0x00a8 }] */
    /* JADX WARN: Type inference failed for: r6v2, types: [java.io.FileOutputStream, java.io.OutputStream] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Not initialized variable reg: 3, insn: 0x00b3: MOVE (r1 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:71:0x00b2 */
    /* JADX WARN: Removed duplicated region for block: B:18:0x0060 A[Catch: Exception -> 0x0099, all -> 0x00b1, TRY_ENTER, TRY_LEAVE, TryCatch #0 {all -> 0x00b1, blocks: (B:18:0x0060, B:21:0x0070, B:23:0x007c, B:28:0x0087, B:29:0x008c, B:30:0x008d, B:31:0x0092, B:32:0x0093, B:33:0x0098, B:35:0x00a3), top: B:6:0x000a }] */
    /* JADX WARN: Removed duplicated region for block: B:32:0x0093 A[Catch: Exception -> 0x0099, all -> 0x00b1, TryCatch #0 {all -> 0x00b1, blocks: (B:18:0x0060, B:21:0x0070, B:23:0x007c, B:28:0x0087, B:29:0x008c, B:30:0x008d, B:31:0x0092, B:32:0x0093, B:33:0x0098, B:35:0x00a3), top: B:6:0x000a }] */
    ...
    */
    ...
    private void saveJpegAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        if (DEBUG) {
            Log.d(TAG, "saveJpegAttributes starting with (inputStream: " + inputStream + ", outputStream: " + outputStream + Constants.RIGHT_BRACKET_ONLY);
        }
    ...
    private void savePngAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        if (DEBUG) {
            Log.d(TAG, "savePngAttributes starting with (inputStream: " + inputStream + ", outputStream: " + outputStream + Constants.RIGHT_BRACKET_ONLY);
        }
        DataInputStream dataInputStream = new DataInputStream(inputStream);
        ByteOrderedDataOutputStream byteOrderedDataOutputStream = new ByteOrderedDataOutputStream(outputStream, ByteOrder.BIG_ENDIAN);
    ...
    private void saveWebpAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        ByteArrayOutputStream byteArrayOutputStream;
        if (DEBUG) {
            Log.d(TAG, "saveWebpAttributes starting with (inputStream: " + inputStream + ", outputStream: " + outputStream + Constants.RIGHT_BRACKET_ONLY);
        }
        ...
        try {
            ...
            if (this.mExifOffset != 0) {
                copy(byteOrderedDataInputStream, byteOrderedDataOutputStream2, (r7 - ((r13.length + 4) + r2.length)) - 8);
                byteOrderedDataInputStream.skipBytes(4);
                ...
                if (Arrays.equals(bArr, bArr2)) {
                    ...
                    if (z) {
                        ...
                        while (true) {
                            ...
                            if (!Arrays.equals(bArr4, WEBP_CHUNK_TYPE_ANMF)) {
                                break;
                            } else {
                                copyWebPChunk(byteOrderedDataInputStream, byteOrderedDataOutputStream2, bArr4);
                            }
                        }
                        writeExifSegment(byteOrderedDataOutputStream2);
                    } else {
