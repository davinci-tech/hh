...
class FragmentAnim {
    ...
    private static int transitToAnimResourceId(Context context, int i, boolean z) {
        if (i == 4097) {
            return z ? R.animator._2131034119_res_0x7f050007 : R.animator._2131034120_res_0x7f050008;
        }
        if (i == 8194) {
            return z ? R.animator._2131034115_res_0x7f050003 : R.animator._2131034116_res_0x7f050004;
        }
        if (i == 8197) {
            if (z) {
        ...
        if (i == 4099) {
            return z ? R.animator._2131034117_res_0x7f050005 : R.animator._2131034118_res_0x7f050006;
        }
        if (i != 4100) {
            return -1;
        }
