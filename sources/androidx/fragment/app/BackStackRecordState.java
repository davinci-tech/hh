...
final class BackStackRecordState implements Parcelable {
    ...
    BackStackRecordState(BackStackRecord backStackRecord) {
        ...
        while (i < size) {
            ...
            this.mOps[i2 + 5] = op.mPopExitAnim;
        ...
        for (int i = 0; i < this.mFragmentWhos.size(); i++) {
            ...
            if (str != null) {
                ...
                if (fragment != null) {
                    ...
                    throw new IllegalStateException("Restoring FragmentTransaction " + this.mName + " failed due to missing saved state for Fragment (" + str + Constants.RIGHT_BRACKET_ONLY);
                }
            }
        }
        return backStackRecord;
