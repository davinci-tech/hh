...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public int calculateDyToMakeVisible(View view, int i) {
        ...
        return calculateDtToFit(decoratedTop - i2, layoutManager.getDecoratedBottom(view) + layoutParams.bottomMargin, layoutManager.getPaddingTop(), layoutManager.getHeight() - layoutManager.getPaddingBottom(), i);
    }
    ...
    public int calculateDxToMakeVisible(View view, int i) {
        ...
        return calculateDtToFit(decoratedLeft - i2, layoutManager.getDecoratedRight(view) + layoutParams.rightMargin, layoutManager.getPaddingLeft(), layoutManager.getWidth() - layoutManager.getPaddingRight(), i);
    }
}
