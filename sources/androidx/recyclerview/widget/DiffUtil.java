...
public class DiffUtil {
    ...
    private static Snake forward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        int oldSize = range.oldSize();
        int newSize = range.newSize();
        int i5 = -i;
        for (int i6 = i5; i6 <= i; i6 += 2) {
            ...
            while (i3 < range.oldListEnd && i7 < range.newListEnd) {
                if (!callback.areItemsTheSame(i3, i7)) {
                    break;
                }
                i3++;
                i7++;
            ...
            if (z && (i4 = (oldSize - newSize) - i6) >= i5 + 1 && i4 <= i - 1) {
                if (centeredArray2.get(i4) <= i3) {
    ...
    private static Snake backward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        for (int i6 = i5; i6 <= i; i6 += 2) {
            ...
            int i8 = (i == 0 || i3 != i2) ? i7 : i7 + 1;
            while (i3 > range.oldListStart && i7 > range.newListStart) {
                if (!callback.areItemsTheSame(i3 - 1, i7 - 1)) {
                    break;
                }
                i3--;
                i7--;
            ...
            if (z && (i4 = (oldSize - newSize) - i6) >= i5 && i4 <= i) {
                if (centeredArray.get(i4) >= i3) {
                    Snake snake = new Snake();
                    snake.startX = i3;
                    snake.startY = i7;
                    snake.endX = i2;
