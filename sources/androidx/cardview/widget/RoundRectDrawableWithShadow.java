...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(R.color._2131296595_res_0x7f090153);
        this.mShadowEndColor = resources.getColor(R.color._2131296594_res_0x7f090152);
        this.mInsetShadow = resources.getDimensionPixelSize(R.dimen._2131362015_res_0x7f0a00df);
    ...
    private void buildShadowCorners() {
        ...
        paint.setShader(new RadialGradient(0.0f, 0.0f, f4 + f5, new int[]{i, i, this.mShadowEndColor}, new float[]{0.0f, f4 / (f5 + f4), 1.0f}, Shader.TileMode.CLAMP));
