...
public class PagerTitleStrip extends ViewGroup {
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        int i8 = ((width - i7) - ((int) (((width - (paddingLeft + i6)) - i7) * f2))) - i6;
        ...
        int min2 = Math.min(paddingLeft, (i8 - this.mScaledTextSpacing) - measuredWidth);
        TextView textView22 = this.mPrevText;
        textView22.layout(min2, i3, measuredWidth + min2, textView22.getMeasuredHeight() + i3);
        int max32 = Math.max((width - paddingRight) - measuredWidth3, i9 + this.mScaledTextSpacing);
