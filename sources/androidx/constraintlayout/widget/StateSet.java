...
public class StateSet {
    ...
    private void load(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), new int[]{R.attr._2131099991_res_0x7f060157});
    ...
    static class State {
        ...
        public State(Context context, XmlPullParser xmlPullParser) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), new int[]{android.R.attr.id, R.attr._2131099934_res_0x7f06011e});
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == 0) {
    ...
    static class Variant {
        ...
        public Variant(Context context, XmlPullParser xmlPullParser) {
            ...
            this.mConstraintID = -1;
            this.mIsLayout = false;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), new int[]{R.attr._2131099934_res_0x7f06011e, R.attr._2131100999_res_0x7f060547, R.attr._2131101000_res_0x7f060548, R.attr._2131101001_res_0x7f060549, R.attr._2131101002_res_0x7f06054a});
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == 0) {
