...
public class Flow extends VirtualLayout {
        ...
        if (i2 == 0) {
            ...
            while (i10 < i) {
                ...
                if ((z || i10 <= 0 || (i7 = this.mMaxElementsWrap) <= 0 || i11 <= i7) && !z) {
                    if (i10 > 0) {
                        widgetWidth = i9 + this.mHorizontalGap + widgetWidth;
                    }
                    i9 = widgetWidth;
                    i8 = 0;
                } else {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:22:0x011d -> B:23:0x005c). Please report as a decompilation issue!!! */
    /*
