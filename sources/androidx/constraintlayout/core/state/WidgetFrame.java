...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                i7 = i;
                i21 = (int) (findPreviousPosition.x * i7);
                i9 = i15;
                i8 = i2;
                i14 = (int) (findPreviousPosition.y * i8);
            ...
            if (findNextPosition != null) {
                i6 = (int) (findNextPosition.x * i7);
                i16 = (int) (findNextPosition.y * i8);
                i11 = findNextPosition.frame;
            } else {
                i11 = 100;
                i6 = i9;
            }
        ...
        widgetFrame.top = i23;
        float f6 = 1.0f - f;
        widgetFrame.right = i22 + ((int) ((i3 * f6) + (i19 * f)));
        widgetFrame.bottom = i23 + ((int) ((f6 * i4) + (i20 * f)));
            ...
            if (widgetFrame2.mCustom.containsKey(str)) {
                ...
                if (customVariable.numberOfInterpolatedValues() == 1) {
                    ...
                    for (int i24 = 0; i24 < numberOfInterpolatedValues; i24++) {
                        fArr[i24] = interpolate(fArr[i24], fArr2[i24], 0.0f, f);
    ...
    public boolean setValue(String str, CLElement cLElement) throws CLParsingException {
        ...
        switch (str.hashCode()) {
            ...
            case 115029:
                ...
                break;
            case 3317767:
                if (str.equals(SquareChangeAnimation.LEFT)) {
                    c = 14;
                    break;
                }
                c = 65535;
            ...
            case 92909918:
                ...
                break;
            case 108511772:
                if (str.equals(SquareChangeAnimation.RIGHT)) {
                    c = 16;
                    break;
                }
                c = 65535;
    ...
    public StringBuilder serialize(StringBuilder sb, boolean z) {
        sb.append("{\n");
        add(sb, SquareChangeAnimation.LEFT, this.left);
        add(sb, Constant.MAP_KEY_TOP, this.top);
        add(sb, SquareChangeAnimation.RIGHT, this.right);
