...
public class CLToken extends CLElement {
    ...
    public boolean getBoolean() throws CLParsingException {
        ...
        throw new CLParsingException("this token is not a boolean: <" + content() + HiDataFilter.DataFilterExpression.BIGGER_THAN, this);
    }
    ...
    public boolean isNull() throws CLParsingException {
        ...
        throw new CLParsingException("this token is not a null: <" + content() + HiDataFilter.DataFilterExpression.BIGGER_THAN, this);
    }
    ...
    public CLToken(char[] cArr) {
        ...
        this.tokenNull = Constants.NULL.toCharArray();
    }
    ...
    protected String toJSON() {
        if (CLParser.DEBUG) {
            return HiDataFilter.DataFilterExpression.LESS_THAN + content() + HiDataFilter.DataFilterExpression.BIGGER_THAN;
        }
        return content();
    }
