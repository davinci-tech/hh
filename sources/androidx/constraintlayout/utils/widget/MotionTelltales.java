...
public class MotionTelltales extends MockView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{R.attr._2131101211_res_0x7f06061b, R.attr._2131101212_res_0x7f06061c, R.attr._2131101213_res_0x7f06061d});
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (int i2 = 0; i2 < 5; i2++) {
                ...
                canvas.drawLine(f3, f4, f3 - (f5 * f6), f4 - (f7 * f6), this.mPaintTelltales);
            }
        }
    }
}
