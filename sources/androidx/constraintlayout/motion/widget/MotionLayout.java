                ...
                if (!Float.isNaN(motionController7.mMotionStagger)) {
                    for (int i11 = 0; i11 < childCount; i11++) {
                        ...
                        if (!Float.isNaN(motionController8.mMotionStagger)) {
                            f = Math.min(f, motionController8.mMotionStagger);
                    ...
                    while (i < childCount) {
                        ...
                        if (!Float.isNaN(motionController9.mMotionStagger)) {
                            ...
                            if (z) {
                                motionController9.mStaggerOffset = abs - (((f2 - motionController9.mMotionStagger) / (f2 - f)) * abs);
                            } else {
                                motionController9.mStaggerOffset = abs - (((motionController9.mMotionStagger - f) * abs) / (f2 - f));
                            }
                        }
                        i++;
                    }
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (view instanceof TextView) {
                    name = name + Constants.LEFT_BRACKET_ONLY + ((Object) ((TextView) view).getText()) + Constants.RIGHT_BRACKET_ONLY;
                }
    ...
    */
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, new int[]{R.attr._2131099733_res_0x7f060055, R.attr._2131099963_res_0x7f06013b, R.attr._2131100705_res_0x7f060421, R.attr._2131100868_res_0x7f0604c4, R.attr._2131100879_res_0x7f0604cf, R.attr._2131101105_res_0x7f0605b1});
    ...
    private void checkStructure(int i, ConstraintSet constraintSet) {
        ...
        for (int i3 = 0; i3 < knownIds.length; i3++) {
            ...
            if (constraintSet.getHeight(i4) == -1) {
                Log.w(TAG, "CHECK: " + name + Constants.LEFT_BRACKET_ONLY + name2 + ") no LAYOUT_HEIGHT");
            }
