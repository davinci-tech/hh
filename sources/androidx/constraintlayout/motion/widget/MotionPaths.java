...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        this.width = (int) (f5 + r7);
        this.height = (int) (f7 + r9);
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f11 = motionPaths.height / 2.0f;
        float f12 = (motionPaths2.x + (motionPaths2.width / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = (motionPaths2.y + (motionPaths2.height / 2.0f)) - (f11 + f10);
        float f14 = f12 * f;
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        ...
        if (motionController != null) {
            ...
            double d4 = f8;
            double d5 = f10;
            f13 = (float) (f17 + (Math.sin(d3) * d4) + (Math.cos(d3) * d5));
