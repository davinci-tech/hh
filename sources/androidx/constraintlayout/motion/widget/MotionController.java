...
public class MotionController {
    ...
    private float getPreCycleDistance() {
        ...
        while (i < 100) {
            ...
            if (i2 > 0) {
                f2 = (float) (f6 + Math.hypot(d2 - fArr[1], d - fArr[0]));
            } else {
                f2 = f6;
            }
            d = fArr[0];
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        int length = this.mAttributeNames.length + 18;
        ...
        for (int i12 = 0; i12 < i3; i12++) {
            ...
            dArr3[i12] = motionPathsArr[i12].time;
        }
        int i13 = 0;
        while (true) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i18 = 0; i18 < i3; i18++) {
                ...
                dArr6[i18] = motionPathsArr[i18].time;
                dArr7[i18][0] = motionPathsArr[i18].x;
                dArr7[i18][1] = motionPathsArr[i18].y;
            }
    ...
    boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (this.mQuantizeMotionSteps != Key.UNSET) {
            ...
            float floor = (float) Math.floor(adjustedPosition / f3);
            ...
            adjustedPosition = (f2 * f3) + (floor * f3);
        }
        ...
        if (curveFitArr != null) {
            ...
            int i5 = (int) f7;
            int i6 = (int) (f6 + this.mStartMotionPath.width + ((this.mEndMotionPath.width - this.mStartMotionPath.width) * f5));
            int i7 = (int) (f7 + this.mStartMotionPath.height + ((this.mEndMotionPath.height - this.mStartMotionPath.height) * f5));
            if (this.mEndMotionPath.width != this.mStartMotionPath.width || this.mEndMotionPath.height != this.mStartMotionPath.height || this.mForceMeasure) {
                view.measure(View.MeasureSpec.makeMeasureSpec(i6 - i4, 1073741824), View.MeasureSpec.makeMeasureSpec(i7 - i5, 1073741824));
                this.mForceMeasure = false;
            }
    ...
    void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f10 = this.mStartMotionPath.height;
    ...
    void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            velocityMatrix.setScaleVelocity(viewSpline4, viewSpline5, adjustedPosition);
            velocityMatrix.setRotationVelocity(viewOscillator3, adjustedPosition);
            velocityMatrix.setTranslationVelocity(viewOscillator8, viewOscillator2, adjustedPosition);
