...
public class Debug {
    ...
    public static void dumpPoc(Object obj) {
        ...
        String str = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + Constants.RIGHT_BRACKET_ONLY;
    ...
    public static String getName(Context context, int[] iArr) {
        ...
        try {
            ...
            Log.v(Constants.LOG_DEBUG, e.toString());
            return "UNKNOWN";
        }
    }
    ...
    public static String getState(MotionLayout motionLayout, int i, int i2) {
        ...
        return resourceEntryName.replaceAll(CharBuffer.allocate((resourceEntryName.length() - i2) / length).toString().replace((char) 0, FilenameUtils.EXTENSION_SEPARATOR) + "_", "_");
    }
    ...
    public static String getLocation() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + Constants.RIGHT_BRACKET_ONLY;
    }
