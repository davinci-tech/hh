...
public class AnimatorInflaterCompat {
    ...
    private static void parseAnimatorFromTypeArray(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        ...
        int namedInt3 = TypedArrayUtils.getNamedInt(typedArray, xmlPullParser, ParsedFieldTag.KAKA_VALUE_TYPE, 7, 4);
    ...
    */
        ...
        while (true) {
            ...
            if (eventType != 2) {
                ...
                if (xmlPullParser.getName().equals("propertyValuesHolder")) {
                    ...
                    int namedInt = TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser, ParsedFieldTag.KAKA_VALUE_TYPE, 2, 4);
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            sb.append(fraction < 0.0f ? Constants.NULL : Float.valueOf(keyframe.getFraction()));
            sb.append(", , value : ");
