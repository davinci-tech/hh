...
public final class WindowInsetsControllerCompat {
    ...
    static class Impl23 extends Impl20 {
        ...
        public void setAppearanceLightStatusBars(boolean z) {
            if (z) {
                unsetWindowFlag(AppRouterExtras.COLDSTART);
    ...
    static class Impl26 extends Impl23 {
        ...
        public void setAppearanceLightNavigationBars(boolean z) {
            if (z) {
                unsetWindowFlag(AMapEngineUtils.HALF_MAX_P20_WIDTH);
                setWindowFlag(Integer.MIN_VALUE);
                setSystemUiFlag(16);
                return;
            }
    ...
    static class Impl30 extends Impl {
        ...
        void addOnControllableInsetsChangedListener(final OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            ...
            WindowInsetsController.OnControllableInsetsChangedListener onControllableInsetsChangedListener2 = new WindowInsetsController.OnControllableInsetsChangedListener() { // from class: androidx.core.view.WindowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda0
                ...
                public final void onControllableInsetsChanged(WindowInsetsController windowInsetsController, int i) {
                    WindowInsetsControllerCompat.Impl30.this.m36xe96d8c51(onControllableInsetsChangedListener, windowInsetsController, i);
                }
            };
        ...
        /* synthetic */ void m36xe96d8c51(OnControllableInsetsChangedListener onControllableInsetsChangedListener, WindowInsetsController windowInsetsController, int i) {
