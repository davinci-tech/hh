...
public class AccessibilityNodeInfoCompat {
        ...
        public boolean perform(View view, Bundle bundle) {
            ...
            if (cls != null) {
                ...
                try {
                    ...
                    Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: " + (cls2 == null ? Constants.NULL : cls2.getName()), e);
    ...
    private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        view.setTag(com.huawei.health.R.id.tag_accessibility_clickable_spans, sparseArray);
        return sparseArray;
    }

    private SparseArray<WeakReference<ClickableSpan>> getSpansFromViewTags(View view) {
        return (SparseArray) view.getTag(com.huawei.health.R.id.tag_accessibility_clickable_spans);
    }
    ...
    private void setBooleanProperty(int i, boolean z) {
        ...
        if (extras != null) {
            extras.putInt(BOOLEAN_PROPERTY_KEY, ((~i) & extras.getInt(BOOLEAN_PROPERTY_KEY, 0)) | (z ? i : 0));
        }
    }
