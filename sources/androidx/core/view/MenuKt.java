...
public final class MenuKt {
    ...
    public static final boolean contains(Menu menu, MenuItem menuItem) {
        uhy.e((Object) menu, "");
        uhy.e((Object) menuItem, "");
        int size = menu.size();
        for (int i = 0; i < size; i++) {
            if (uhy.e(menu.getItem(i), menuItem)) {
                return true;
            }
        }
        return false;
    ...
    public static final void forEach(Menu menu, Function1<? super MenuItem, ueu> function1) {
        uhy.e((Object) menu, "");
    ...
    public static final void forEachIndexed(Menu menu, Function2<? super Integer, ? super MenuItem, ueu> function2) {
        uhy.e((Object) menu, "");
