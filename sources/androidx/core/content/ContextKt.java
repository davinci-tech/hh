...
public final class ContextKt {
    public static final /* synthetic */ <T> T getSystemService(Context context) {
        ...
        uhy.c(4, ExifInterface.GPS_DIRECTION_TRUE);
    ...
    public static /* synthetic */ void withStyledAttributes$default(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2, Function1 function1, int i3, Object obj) {
        ...
        uhy.a(obtainStyledAttributes, "");
        function1.invoke(obtainStyledAttributes);
        obtainStyledAttributes.recycle();
    }

    public static final void withStyledAttributes(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2, Function1<? super TypedArray, ueu> function1) {
        uhy.e((Object) context, "");
        uhy.e((Object) iArr, "");
        uhy.e((Object) function1, "");
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i, i2);
    ...
    public static final void withStyledAttributes(Context context, int i, int[] iArr, Function1<? super TypedArray, ueu> function1) {
        uhy.e((Object) context, "");
        uhy.e((Object) iArr, "");
        uhy.e((Object) function1, "");
