...
public class ContextCompat {
    ...
    public static int checkSelfPermission(Context context, String str) {
        ...
        if (BuildCompat.isAtLeastT() || !TextUtils.equals(Constants.POST_NOTIFICATIONS, str)) {
    ...
    static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            hashMap.put(AudioManager.class, PresenterUtils.AUDIO);
            ...
            hashMap.put(WallpaperManager.class, WatchFaceConstant.WALLPAPER_RES);
            hashMap.put(WifiP2pManager.class, "wifip2p");
            hashMap.put(WifiManager.class, "wifi");
            hashMap.put(WindowManager.class, Constants.NATIVE_WINDOW_SUB_DIR);
        }
    }
