...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = OldToNewMotionPath.SPORT_TYPE_TENNIS;
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, OldToNewMotionPath.SPORT_TYPE_TENNIS);
            return (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(OldToNewMotionPath.SPORT_TYPE_TENNIS)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (!keyEvent.isAltPressed()) {
                return arrowScroll(OldToNewMotionPath.SPORT_TYPE_TENNIS);
            }
            return fullScroll(OldToNewMotionPath.SPORT_TYPE_TENNIS);
        }
        if (keyCode != 62) {
            return false;
        }
    ...
    private float getSplineFlingDistance(int i) {
        ...
        return (float) (this.mPhysicalCoeff * SCROLL_FRICTION * Math.exp((d / (d - 1.0d)) * log));
    }
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = OldToNewMotionPath.SPORT_TYPE_TENNIS;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
