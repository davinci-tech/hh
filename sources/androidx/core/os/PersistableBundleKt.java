...
public final class PersistableBundleKt {
    public static final PersistableBundle persistableBundleOf(ueo<String, ? extends Object>... ueoVarArr) {
        uhy.e((Object) ueoVarArr, "");
        PersistableBundle createPersistableBundle = PersistableBundleApi21ImplKt.createPersistableBundle(ueoVarArr.length);
        for (ueo<String, ? extends Object> ueoVar : ueoVarArr) {
            PersistableBundleApi21ImplKt.putValue(createPersistableBundle, ueoVar.b(), ueoVar.d());
        }
