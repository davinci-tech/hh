...
public final class SparseArrayKt {
    ...
    public static final <T> boolean remove(SparseArray<T> sparseArray, int i, T t) {
        ...
        if (indexOfKey < 0 || !uhy.e(t, sparseArray.valueAt(indexOfKey))) {
            return false;
        }
    ...
    public static final <T> void forEach(SparseArray<T> sparseArray, Function2<? super Integer, ? super T, ueu> function2) {
        uhy.e((Object) sparseArray, "");
