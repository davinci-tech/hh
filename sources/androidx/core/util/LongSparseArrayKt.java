...
public final class LongSparseArrayKt {
    ...
    public static final <T> boolean remove(LongSparseArray<T> longSparseArray, long j, T t) {
        ...
        if (indexOfKey < 0 || !uhy.e(t, longSparseArray.valueAt(indexOfKey))) {
            return false;
        }
    ...
    public static final <T> void forEach(LongSparseArray<T> longSparseArray, Function2<? super Long, ? super T, ueu> function2) {
        uhy.e((Object) longSparseArray, "");
