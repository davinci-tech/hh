...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, R.attr._2131100952_res_0x7f060518, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view) {
        this(context, menuBuilder, view, false, R.attr._2131100952_res_0x7f060518, 0);
    }
    ...
    private MenuPopup createPopup() {
        ...
        Display defaultDisplay = ((WindowManager) this.mContext.getSystemService(Constants.NATIVE_WINDOW_SUB_DIR)).getDefaultDisplay();
        Point point = new Point();
        Api17Impl.getRealSize(defaultDisplay, point);
        if (Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(R.dimen._2131361887_res_0x7f0a005f)) {
