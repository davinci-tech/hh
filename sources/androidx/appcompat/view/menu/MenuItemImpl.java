...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(R.string._2130850592_res_0x7f023320));
        }
        int i = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, i, 65536, resources.getString(R.string._2130850588_res_0x7f02331c));
        appendModifier(sb, i, 4096, resources.getString(R.string._2130850584_res_0x7f023318));
        appendModifier(sb, i, 2, resources.getString(R.string._2130850583_res_0x7f023317));
        appendModifier(sb, i, 1, resources.getString(R.string._2130850589_res_0x7f02331d));
        appendModifier(sb, i, 4, resources.getString(R.string._2130850591_res_0x7f02331f));
        appendModifier(sb, i, 8, resources.getString(R.string._2130850587_res_0x7f02331b));
        if (shortcut == '\b') {
            sb.append(resources.getString(R.string._2130850585_res_0x7f023319));
        } else if (shortcut == '\n') {
            sb.append(resources.getString(R.string._2130850586_res_0x7f02331a));
        } else if (shortcut == ' ') {
            sb.append(resources.getString(R.string._2130850590_res_0x7f02331e));
        } else {
            sb.append(shortcut);
        }
        return sb.toString();
