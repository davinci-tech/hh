...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr._2131101078_res_0x7f060596);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        TooltipCompat.setTooltipText(imageView, getResources().getString(R.string._2130850596_res_0x7f023324));
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(R.dimen._2131361920_res_0x7f0a0080);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(R.dimen._2131361919_res_0x7f0a007f);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(R.dimen._2131361906_res_0x7f0a0072) + resources.getDimensionPixelSize(R.dimen._2131361907_res_0x7f0a0073) : 0;
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, R.attr._2131099743_res_0x7f06005f);
        }
