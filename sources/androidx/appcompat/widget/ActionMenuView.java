    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i16 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int measureChildForCells = measureChildForCells(childAt, i13, layoutParams.isOverflowButton ? 1 : i12, childMeasureSpec, paddingTop);
        ...
        while (i18 > 0 && i12 > 0) {
            ...
            while (i29 < childCount) {
                ...
                long j3 = 1 << i29;
                if ((j2 & j3) == 0) {
                    if (layoutParams3.cellsUsed == i25 + 1) {
                        j |= j3;
                    }
                } else {
                    if (z5 && layoutParams3.preventEdgeOffset && i12 == 1) {
        ...
        i5 = i15;
        boolean z8 = !z3 && i17 == 1;
        if (i12 <= 0 || j == 0 || (i12 >= i17 - 1 && !z8 && i4 <= 1)) {
            i6 = 0;
            z2 = z;
        } else {
            ...
            int i35 = bitCount > 0.0f ? (int) ((i12 * i13) / bitCount) : i6;
            boolean z9 = z;
            for (int i36 = i6; i36 < i3; i36++) {
                if ((j & (1 << i36)) != 0) {
