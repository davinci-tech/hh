...
class TooltipPopup {
    ...
    void show(View view, int i, int i2, boolean z, CharSequence charSequence) {
        ...
        ((WindowManager) this.mContext.getSystemService(Constants.NATIVE_WINDOW_SUB_DIR)).addView(this.mContentView, this.mLayoutParams);
    }

    void hide() {
        if (isShowing()) {
            ((WindowManager) this.mContext.getSystemService(Constants.NATIVE_WINDOW_SUB_DIR)).removeView(this.mContentView);
        }
    }
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(R.dimen._2131365122_res_0x7f0a0d02);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.mContext.getResources().getDimensionPixelOffset(R.dimen._2131365121_res_0x7f0a0d01);
        ...
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z ? R.dimen._2131365125_res_0x7f0a0d05 : R.dimen._2131365124_res_0x7f0a0d04);
