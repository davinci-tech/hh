...
public final class ResourceManagerInternal {
    ...
    private Drawable loadDrawableFromDelegates(Context context, int i) {
        ...
        if (typedValue.string != null && typedValue.string.toString().endsWith(WatchFaceConstant.XML_SUFFIX)) {
            try {
    ...
    private void checkVectorDrawableSetup(Context context) {
        ...
        Drawable drawable = getDrawable(context, R.drawable._2131427463_res_0x7f0b0087);
