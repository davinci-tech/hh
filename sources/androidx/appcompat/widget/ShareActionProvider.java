...
public class ShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(R.attr._2131099707_res_0x7f06003b, typedValue, true);
        ...
        activityChooserView.setDefaultActionButtonContentDescription(R.string._2130850600_res_0x7f023328);
        activityChooserView.setExpandActivityOverflowButtonContentDescription(R.string._2130850599_res_0x7f023327);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (min < activityCount) {
            SubMenu addSubMenu = subMenu.addSubMenu(0, min, min, this.mContext.getString(R.string._2130850579_res_0x7f023313));
