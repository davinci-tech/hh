...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, com.huawei.health.R.attr._2131101182_res_0x7f0605fe);
    }
    ...
    */
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (ViewUtils.isLayoutRtl(this)) {
            ...
            width = ((this.mSwitchWidth + i6) - i5) - i11;
        } else {
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(com.huawei.health.R.string._2130850582_res_0x7f023316);
            }
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(com.huawei.health.R.string._2130850581_res_0x7f023315);
            }
            ViewCompat.setStateDescription(this, charSequence);
        }
    }
