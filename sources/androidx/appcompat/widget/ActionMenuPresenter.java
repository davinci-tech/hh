...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
        ...
        while (i12 < i) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (z4) {
                    ...
                    z4 = z5 & (!actionMenuPresenter.mStrictWidthLimit ? i6 + i13 <= 0 : i6 < 0);
                }
                if (z4 && groupId2 != 0) {
    ...
    class OverflowMenuButton extends AppCompatImageView implements ActionMenuView.ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, R.attr._2131099712_res_0x7f060040);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
        ...
        public boolean performClick() {
            if (super.performClick()) {
                ViewClickInstrumentation.clickOnView(this);
                return true;
            }
            playSoundEffect(0);
            ActionMenuPresenter.this.showOverflowMenu();
    ...
    class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z) {
            super(context, menuBuilder, view, z, R.attr._2131099713_res_0x7f060041);
    ...
    class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenuBuilder, View view) {
            super(context, subMenuBuilder, view, false, R.attr._2131099713_res_0x7f060041);
