...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(null, R$styleable.DrawerArrowToggle, R.attr._2131100030_res_0x7f06017e, R.style.Base_Widget_AppCompat_DrawerArrowToggle);
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate(bounds.centerX(), ((((int) ((height - (3.0f * strokeWidth)) - (2.0f * r7))) / 4) * 2) + (strokeWidth * 1.5f) + this.mBarGap);
        if (this.mSpin) {
