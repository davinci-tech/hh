...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(R.attr._2131099721_res_0x7f060049, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, R$styleable.AlertDialog, R.attr._2131099722_res_0x7f06004a, 0);
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (cursor != null) {
                    listAdapter = new SimpleCursorAdapter(this.mContext, i2, cursor, new String[]{this.mLabelColumn}, new int[]{android.R.id.text1});
                } else {
