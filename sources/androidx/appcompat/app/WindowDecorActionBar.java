...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ActionBarOverlayLayout actionBarOverlayLayout = (ActionBarOverlayLayout) view.findViewById(com.huawei.health.R.id.decor_content_parent);
        this.mOverlayLayout = actionBarOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(com.huawei.health.R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(com.huawei.health.R.id.action_context_bar);
        ActionBarContainer actionBarContainer = (ActionBarContainer) view.findViewById(com.huawei.health.R.id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, R$styleable.ActionBar, com.huawei.health.R.attr._2131099686_res_0x7f060026, 0);
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        sb.append(view != 0 ? view.getClass().getSimpleName() : Constants.NULL);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(com.huawei.health.R.attr._2131099691_res_0x7f06002b, typedValue, true);
