...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context context) {
        ...
        androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, com.huawei.health.R.style.Theme_AppCompat_Empty);
    ...
    */
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                viewGroup = (ViewGroup) from.inflate(com.huawei.health.R.layout.abc_dialog_title_material, (ViewGroup) null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(com.huawei.health.R.attr._2131099690_res_0x7f06002a, typedValue, true);
                if (typedValue.resourceId != 0) {
                    context = new androidx.appcompat.view.ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    context = this.mContext;
                }
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(com.huawei.health.R.layout.abc_screen_toolbar, (ViewGroup) null);
                DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(com.huawei.health.R.id.decor_content_parent);
            ...
            viewGroup = this.mOverlayActionMode ? (ViewGroup) from.inflate(com.huawei.health.R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) from.inflate(com.huawei.health.R.layout.abc_screen_simple, (ViewGroup) null);
        }
        if (viewGroup == null) {
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) viewGroup.findViewById(com.huawei.health.R.id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(com.huawei.health.R.id.action_bar_activity_content);
    ...
    */
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme2.resolveAttribute(com.huawei.health.R.attr._2131099690_res_0x7f06002a, typedValue, true);
            if (typedValue.resourceId != 0) {
                theme = context.getResources().newTheme();
                theme.setTo(theme2);
                theme.applyStyle(typedValue.resourceId, true);
                theme.resolveAttribute(com.huawei.health.R.attr._2131099691_res_0x7f06002b, typedValue, true);
            } else {
                theme2.resolveAttribute(com.huawei.health.R.attr._2131099691_res_0x7f06002b, typedValue, true);
                theme = null;
            }
            if (typedValue.resourceId != 0) {
                if (theme == null) {
    ...
    void closePanel(PanelFeatureState panelFeatureState, boolean z) {
        ...
        WindowManager windowManager = (WindowManager) this.mContext.getSystemService(Constants.NATIVE_WINDOW_SUB_DIR);
    ...
    */
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            color = ContextCompat.getColor(this.mContext, com.huawei.health.R.color._2131296348_res_0x7f09005c);
        } else {
            color = ContextCompat.getColor(this.mContext, com.huawei.health.R.color._2131296347_res_0x7f09005b);
        }
    ...
    */
    ...
    protected static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(com.huawei.health.R.attr._2131099683_res_0x7f060023, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(com.huawei.health.R.attr._2131100935_res_0x7f060507, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(com.huawei.health.R.style.Theme_AppCompat_CompactMenu, true);
            }
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, com.huawei.health.R.layout.abc_list_menu_item_layout);
    ...
    class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{com.huawei.health.R.attr._2131100173_res_0x7f06020d});
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & HealthData.TIMELINE) != (configuration2.screenLayout & HealthData.TIMELINE)) {
                configuration3.screenLayout |= configuration2.screenLayout & HealthData.TIMELINE;
            }
