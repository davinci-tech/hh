        ...
        private FontsContractCompat.FontInfo retrieveFontInfo() {
            try {
                ...
                if (fetchFonts.getStatusCode() != 0) {
                    throw new RuntimeException("fetchFonts failed (" + fetchFonts.getStatusCode() + Constants.RIGHT_BRACKET_ONLY);
                }
        ...
        void createMetadata() {
            synchronized (this.mLock) {
                ...
                try {
                    ...
                    if (resultCode != 0) {
                        throw new RuntimeException("fetchFonts result is not OK. (" + resultCode + Constants.RIGHT_BRACKET_ONLY);
                    }
                    try {
