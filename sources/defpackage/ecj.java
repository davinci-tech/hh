...
public class ecj extends nnr {
    private static final String[] k = {"60", "70", "80", "85", "90", "95", "100"};
    private static final float[] j = {60.0f, 70.0f, 80.0f, 85.0f, 90.0f, 95.0f, 100.0f};

    public ecj(Context context, ViewPortHandler viewPortHandler, YAxis yAxis, Transformer transformer, HwHealthBaseBarLineChart hwHealthBaseBarLineChart) {
        ...
        while (true) {
            ...
            if (fArr[i2] < this.f15402a.getContentRect().bottom) {
                ...
                if (this.mYAxis.getAxisMinimum() > 70.0f || (f3 != 95.0f && f3 != 85.0f)) {
                    canvas.drawText(UnitUtil.e(CommonUtil.m(this.b, r2[i]), 2, 0), f, fArr[i2] + d, this.mAxisLabelPaint);
                }
            }
            i++;
        }
