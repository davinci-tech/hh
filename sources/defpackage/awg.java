...
public class awg extends avr {
    ...
    public void getRecord(HealthLifeBean healthLifeBean, TaskDayDataListener taskDayDataListener) {
        if (taskDayDataListener == null) {
            LogUtil.h("HealthLife_SleepManager", "getRecord listener is null");
        } else if (healthLifeBean == null) {
            LogUtil.h("HealthLife_SleepManager", "getRecord bean is null");
    ...
    public void getRecord(SparseArray<HealthLifeBean> sparseArray, TaskDataListener taskDataListener) {
        ...
        if (sparseArray == null) {
            LogUtil.h("HealthLife_SleepManager", "getRecord sparseArray is null");
            taskDataListener.onDataChange(-1, null);
        } else if (sparseArray.size() <= 0) {
            LogUtil.h("HealthLife_SleepManager", "getRecord sparseArray ", sparseArray);
