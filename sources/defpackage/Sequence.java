...
public class Sequence extends asSequence {
    ...
    /* renamed from: ujg$a */
    public static final class a<T> implements kotlin.sequences.Sequence<T> {
    ...
    public static final <T> kotlin.sequences.Sequence<T> e(Iterator<? extends T> it) {
        uhy.e((Object) it, "");
        return ujh.a(new a(it));
    }

    public static final <T> kotlin.sequences.Sequence<T> c() {
        return ujd.b;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <T> kotlin.sequences.Sequence<T> a(kotlin.sequences.Sequence<? extends T> sequence) {
        uhy.e((Object) sequence, "");
        return sequence instanceof uix ? sequence : new uix(sequence);
    }

    public static final <T> kotlin.sequences.Sequence<T> b(T t, Function1<? super T, ? extends T> function1) {
        uhy.e((Object) function1, "");
        if (t == null) {
            return ujd.b;
        }
        return new uje(new b(t), function1);
    }

    /* JADX INFO: Add missing generic type declarations: [T] */
    @Metadata(d1 = {"\u0000\f\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\u0010\u0000\u001a\u0004\u0018\u0001H\u0001\"\b\b\u0000\u0010\u0001*\u00020\u0002H\n¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"<anonymous>", ExifInterface.GPS_DIRECTION_TRUE, "", TrackConstants$Opers.INVOKE, "()Ljava/lang/Object;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    /* renamed from: ujg$b */
