...
public final class uog implements CoroutineContext {
    ...
    public <R> R fold(R initial, Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
        return (R) this.e.fold(initial, operation);
    }
}
