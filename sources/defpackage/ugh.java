...
public final class ugh implements Externalizable {

    /* renamed from: a, reason: collision with root package name */
    public static final c f17417a = new c(null);
    private static final long serialVersionUID = 0;
    private Collection<?> d;
    private final int e;

    public ugh(Collection<?> collection, int i) {
    ...
    public void readExternal(ObjectInput input) {
        ...
        int i2 = 0;
        if (i == 0) {
            List a2 = ufe.a(readInt);
            while (i2 < readInt) {
                a2.add(input.readObject());
                i2++;
            }
            d = ufe.d(a2);
        } else if (i == 1) {
