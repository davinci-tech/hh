...
/* renamed from: unc, reason: from Kotlin metadata */
/* loaded from: classes10.dex */
final /* synthetic */ class DEFAULT_CLOSE_MESSAGE {
    public static final void d(ReceiveChannel<?> receiveChannel, Throwable th) {
        if (th != null) {
            r0 = th instanceof CancellationException ? (CancellationException) th : null;
            if (r0 == null) {
                r0 = CancellationException.a("Channel was consumed, consumer had failed", th);
            }
        }
