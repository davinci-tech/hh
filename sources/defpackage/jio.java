...
public class jio {
    public static void a(long j) {
        ...
        SharedPreferenceManager.e(BaseApplication.getContext(), "100007", "kStorage_FitnessMgr_Long_LastStatusTimeStamp", LoginInit.getInstance(BaseApplication.getContext()).getAccountInfo(1011) + "|" + jpp.b() + "|" + Long.toString(j), storageParams);
    }
    ...
    public static long b() {
        ...
        if (!TextUtils.isEmpty(b)) {
            ...
            try {
                if (split.length == 3 && split[0].equals(accountInfo) && split[1].equals(jpp.b())) {
                    parseInt = Integer.parseInt(split[2]);
                } else if (split.length == 2 && split[0].equals(jpp.b())) {
