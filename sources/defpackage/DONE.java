...
/* renamed from: uol, reason: from Kotlin metadata */
/* loaded from: classes10.dex */
public final class DONE {
    public static final upu b = new upu("NULL");

    /* renamed from: a, reason: collision with root package name */
    public static final upu f17486a = new upu("UNINITIALIZED");
    public static final upu c = new upu("DONE");
}
