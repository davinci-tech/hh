...
final class uoq<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public uoq(Continuation<? super T> continuation, CoroutineContext coroutineContext) {
        this.e = continuation;
