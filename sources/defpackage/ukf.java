...
public final class ukf implements Comparable<ukf> {
    ...
    private static final long f17450a = a(0);
    ...
    public /* synthetic */ int compareTo(ukf ukfVar) {
        return p(ukfVar.getB());
    }

    private static final DurationUnit r(long j) {
        return y(j) ? DurationUnit.NANOSECONDS : DurationUnit.MILLISECONDS;
    }

    public static long a(long j) {
        if (durationAssertionsEnabled.c()) {
            if (y(j)) {
                if (!new uit(-4611686018426999999L, 4611686018426999999L).b(u(j))) {
                    throw new AssertionError(u(j) + " ns is out of nanoseconds range");
                }
            } else {
                if (!new uit(-4611686018427387903L, 4611686018427387903L).b(u(j))) {
                    throw new AssertionError(u(j) + " ms is out of milliseconds range");
                }
                if (new uit(-4611686018426L, 4611686018426L).b(u(j))) {
    ...
    static {
        long h;
        long h2;
        h = MAX_MILLIS.h(4611686018427387903L);
        e = h;
        h2 = MAX_MILLIS.h(-4611686018427387903L);
        c = h2;
    }

    public static final long t(long j) {
        long c2;
        c2 = MAX_MILLIS.c(-u(j), ((int) j) & 1);
        return c2;
    }
    ...
    private static final long d(long j, long j2, long j3) {
        ...
        k = MAX_MILLIS.k(j3);
        long j5 = j2 + k;
        if (new uit(-4611686018426L, 4611686018426L).b(j5)) {
            m = MAX_MILLIS.m(k);
            m2 = MAX_MILLIS.m(j5);
            j4 = MAX_MILLIS.j(m2 + (j3 - m));
            return j4;
        }
        h = MAX_MILLIS.h(uja.e(j5, -4611686018427387903L, 4611686018427387903L));
        return h;
    }
    ...
    public static final long b(long j, int i) {
        ...
        if (!y(j)) {
            if (j4 / j3 != u) {
                return uij.d(u) * uij.d(i) > 0 ? e : c;
            }
            h = MAX_MILLIS.h(uja.c(j4, new uit(-4611686018427387903L, 4611686018427387903L)));
            return h;
        }
        if (new uit(-2147483647L, 2147483647L).b(u)) {
            j2 = MAX_MILLIS.j(j4);
            return j2;
        }
        if (j4 / j3 == u) {
        ...
        m = MAX_MILLIS.m(k);
        long j5 = k * j3;
        k2 = MAX_MILLIS.k((u - m) * j3);
        long j6 = k2 + j5;
        if (j5 / j3 != k || (j6 ^ j5) < 0) {
            return uij.d(u) * uij.d(i) > 0 ? e : c;
        }
        h2 = MAX_MILLIS.h(uja.c(j6, new uit(-4611686018427387903L, 4611686018427387903L)));
        return h2;
    }
    ...
    public static final long d(long j, int i) {
        ...
        long j4 = i;
        long u = u(j) / j4;
        if (new uit(-4611686018426L, 4611686018426L).b(u)) {
            m = MAX_MILLIS.m(u(j) - (u * j4));
            m2 = MAX_MILLIS.m(u);
            j2 = MAX_MILLIS.j(m2 + (m / j4));
            return j2;
        }
        h = MAX_MILLIS.h(u);
        return h;
    ...
    public static final long a(long j, DurationUnit durationUnit) {
        ...
        DurationUnit r = r(j);
        if (durationUnit.compareTo(r) <= 0 || l(j)) {
            return j;
        }
        return MAX_MILLIS.d(u(j) - (u(j) % ukm.a(1L, durationUnit, r)), r);
    }
    ...
    public static final int h(long j) {
        ...
        if (v(j)) {
            u = MAX_MILLIS.m(u(j) % 1000);
        } else {
            u = u(j) % Http2Connection.DEGRADED_PONG_TIMEOUT_NS;
        }
        return (int) u;
    }
    ...
    public static final long e(long j, DurationUnit durationUnit) {
        ...
        return ukm.a(u(j), r(j), durationUnit);
    }
    ...
    public static String s(long j) {
        ...
        if (z4) {
            ...
            if (m != 0 || z || z2 || z3) {
                b(j, sb, m, h, 9, "s", false);
            } else if (h >= 1000000) {
                b(j, sb, h / 1000000, h % 1000000, 6, "ms", false);
            } else if (h >= 1000) {
                b(j, sb, h / 1000, h % 1000, 3, "us", false);
            } else {
                sb.append(h);
                sb.append("ns");
            }
    ...
    private static final void b(long j, StringBuilder sb, int i, int i2, int i3, String str, boolean z) {
        ...
        if (i2 != 0) {
            ...
            String d2 = ujy.d(String.valueOf(i2), i3, '0');
            ...
            int i5 = length + 1;
            if (!z && i5 < 3) {
                sb.append((CharSequence) d2, 0, i5);
                uhy.a(sb, "");
            } else {
                sb.append((CharSequence) d2, 0, ((length + 3) / 3) * 3);
                uhy.a(sb, "");
            }
        }
        sb.append(str);
    ...
    public static boolean e(long j, Object obj) {
        return (obj instanceof ukf) && j == ((ukf) obj).getB();
    }
}
