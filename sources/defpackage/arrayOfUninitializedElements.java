...
/* renamed from: ugb, reason: from Kotlin metadata */
/* loaded from: classes10.dex */
public final class arrayOfUninitializedElements {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final <T> boolean c(T[] tArr, int i, int i2, List<?> list) {
        if (i2 != list.size()) {
            return false;
        }
        for (int i3 = 0; i3 < i2; i3++) {
            if (!uhy.e(tArr[i + i3], list.get(i3))) {
                return false;
            }
        }
        return true;
