...
public final class ump extends CoroutineDispatcher {
    ...
    public void dispatch(CoroutineContext context, Runnable block) {
        umu umuVar = (umu) context.get(umu.e);
        if (umuVar != null) {
            umuVar.b = true;
            return;
        }
