...
public class qpw extends HwHealthBaseScrollBarLineChart.e {
    final /* synthetic */ TemperatureBarChartView e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public qpw(TemperatureBarChartView temperatureBarChartView, TemperatureBarChart temperatureBarChart) {
        super();
