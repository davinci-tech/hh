...
public class qam extends nnr {
    ...
    public qam(Context context, ViewPortHandler viewPortHandler, YAxis yAxis, Transformer transformer, HwHealthBaseBarLineChart hwHealthBaseBarLineChart) {
    ...
    private void dxy_(Canvas canvas, Path path) {
        float xOffset;
        float f;
        if (this.m) {
            ...
            if (this.o != null) {
                canvas.drawPath(dxA_(path, fArr[1]), this.o);
            } else {
    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mAxis.getAxisMaximum() != 2000000.0f && this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            boolean z = false;
            boolean z2 = nng.d(this.b) || this.d;
            ...
            if (z3 || z4) {
                ...
                offsetLeft = (this.mViewPortHandler.offsetLeft() - requiredWidthSpace) + Utils.convertDpToPixel(8.0f);
            } else if (z5 || z) {
                this.mAxisLabelPaint.setTextAlign(Paint.Align.RIGHT);
                offsetLeft = (this.mViewPortHandler.contentRight() + requiredWidthSpace) - Utils.convertDpToPixel(8.0f);
            } else {
                LogUtil.a("SleepYAxisRenderer", "dependency = ", e, "isDrawReverse = ", Boolean.valueOf(z2));
                offsetLeft = 0.0f;
            }
            dxx_(canvas, offsetLeft);
        }
    }

    private void dxx_(Canvas canvas, float f) {
        String formattedValue;
        if (!this.m || this.l == Integer.MIN_VALUE) {
            return;
        }
        Rect rect = new Rect();
        String[] strArr = this.n;
        if (strArr != null && strArr.length != 0) {
            formattedValue = TextUtils.isEmpty(strArr[0]) ? "" : this.n[0];
        } else {
            formattedValue = this.mYAxis.getValueFormatter().getFormattedValue(this.l, this.mYAxis);
        }
        ...
        float f2 = fArr[1];
        if (this.o != null) {
            this.mAxisLabelPaint.setColor(this.o.getColor());
        } else {
    ...
    @Override // defpackage.nnr
    public void c() {
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled() && this.mAxis.getAxisMaximum() != 2000000.0f && this.m) {
            this.mAxisLabelPaint.setTypeface(this.mYAxis.getTypeface());
            this.mAxisLabelPaint.setTextSize(this.mYAxis.getTextSize());
            this.mAxisLabelPaint.setColor(this.mYAxis.getTextColor());
            if (((HwHealthYAxis) this.mYAxis).e() == HwHealthYAxis.HwHealthAxisDependency.THIRD_PARTY) {
            ...
            Rect rect = new Rect();
            String formattedValue = this.mYAxis.getValueFormatter().getFormattedValue(this.l, this.mYAxis);
            this.mAxisLabelPaint.getTextBounds(formattedValue, 0, formattedValue.length(), rect);
            this.mTrans.pointValuesToPixel(new float[]{0.0f, this.l});
        }
    }
