...
public class iie extends DBCommon {
    ...
    public static String d() {
        ...
        sb.append("create table  IF NOT EXISTS hihealth_type_inherit(_id integer primary key not null,type_id integer no null,parent_type_id integer no null)");
        return sb.toString();
    }
