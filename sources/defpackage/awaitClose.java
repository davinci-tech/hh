...
public final class awaitClose {
    ...
    public static final <E> ReceiveChannel<E> d(CoroutineScope coroutineScope, CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow, CoroutineStart coroutineStart, Function1<? super Throwable, ueu> function1, Function2<? super ProducerScope<? super E>, ? super Continuation<? super ueu>, ? extends Object> function2) {
        unm unmVar = new unm(DEBUG_THREAD_NAME_SEPARATOR.d(coroutineScope, coroutineContext), Channel.e(i, bufferOverflow, null, 4, null));
        if (function1 != null) {
            unmVar.invokeOnCompletion(function1);
        }
        unmVar.start(coroutineStart, unmVar, function2);
        return unmVar;
    }
}
