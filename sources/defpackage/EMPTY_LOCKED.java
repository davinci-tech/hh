...
/* renamed from: uqp, reason: from Kotlin metadata */
/* loaded from: classes10.dex */
public final class EMPTY_LOCKED {
    private static final uqr b;
    private static final upu c;
    private static final upu d;
    private static final uqr e;

    /* renamed from: a, reason: collision with root package name */
    private static final upu f17507a = new upu("LOCK_FAIL");
    private static final upu f = new upu("UNLOCK_FAIL");

    static {
        upu upuVar = new upu("LOCKED");
        c = upuVar;
        upu upuVar2 = new upu("UNLOCKED");
        d = upuVar2;
        b = new uqr(upuVar);
        e = new uqr(upuVar2);
    }
