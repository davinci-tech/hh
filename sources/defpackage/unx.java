...
final class unx<T> extends AbstractFlow<T> {
    private final Function2<FlowCollector<? super T>, Continuation<? super ueu>, Object> e;

    /* JADX WARN: Multi-variable type inference failed */
    public unx(Function2<? super FlowCollector<? super T>, ? super Continuation<? super ueu>, ? extends Object> function2) {
        this.e = function2;
    }

    @Override // kotlinx.coroutines.flow.AbstractFlow
    public Object collectSafely(FlowCollector<? super T> flowCollector, Continuation<? super ueu> continuation) {
        Object invoke = this.e.invoke(flowCollector, continuation);
        return invoke == ugw.a() ? invoke : ueu.d;
    }
}
