...
/* renamed from: upm, reason: from Kotlin metadata */
/* loaded from: classes10.dex */
public final class FAST_SERVICE_LOADER_PROPERTY_NAME {
    private static final boolean d = true;

    public static final MainCoroutineDispatcher b(MainDispatcherFactory mainDispatcherFactory, List<? extends MainDispatcherFactory> list) {
        try {
            return mainDispatcherFactory.createDispatcher(list);
        } catch (Throwable th) {
            return c(th, mainDispatcherFactory.hintOnError());
        }
    }

    public static final boolean c(MainCoroutineDispatcher mainCoroutineDispatcher) {
        return mainCoroutineDispatcher.getImmediate() instanceof upl;
    }

    static /* synthetic */ upl c(Throwable th, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            th = null;
        }
        if ((i & 2) != 0) {
    ...
    private static final upl c(Throwable th, String str) {
        if (d) {
            return new upl(th, str);
        }
        if (th != null) {
            throw th;
        }
