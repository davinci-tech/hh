    ...
    */
    public static byte[] a(java.lang.String r5, java.lang.String r6) {
        /*
            ...
            java.security.PublicKey r6 = e(r1, r6)     // Catch: java.lang.Throwable -> L3f java.lang.Exception -> L41
        ...
        L41:
            ...
            r2 = r0
        L43:
            defpackage.ma.c(r5)     // Catch: java.lang.Throwable -> L51
            if (r2 == 0) goto L50
            r2.close()     // Catch: java.io.IOException -> L4c
            goto L50
        L4c:
        ...
        L5d:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ky.a(java.lang.String, java.lang.String):byte[]");
    }

    public static PublicKey e(String str, String str2) throws NoSuchAlgorithmException, Exception {
        return KeyFactory.getInstance(str).generatePublic(new X509EncodedKeySpec(ku.d(str2)));
    }
}
