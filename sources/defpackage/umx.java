...
public class umx<E> extends AbstractCoroutine<ueu> implements Channel<E> {
    ...
    public final void cancel(CancellationException cause) {
        ...
        if (cause == null) {
            umx<E> umxVar = this;
            cause = new umg(umxVar.cancellationExceptionMessage(), null, umxVar);
        }
    ...
    public void cancelInternal(Throwable cause) {
        CancellationException cancellationException$default = umd.toCancellationException$default(this, cause, null, 1, null);
    ...
    public /* synthetic */ void cancel() {
        umx<E> umxVar = this;
        cancelInternal(new umg(umxVar.cancellationExceptionMessage(), null, umxVar));
    }
    ...
    public Object mo979trySendJP2dKIU(E element) {
        return this.e.mo979trySendJP2dKIU(element);
    }

    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk */
    public Object mo978tryReceivePtdJZtk() {
        return this.e.mo978tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    public Object send(E e, Continuation<? super ueu> continuation) {
    ...
    public Object mo977receiveCatchingJP2dKIU(Continuation<? super unf<? extends E>> continuation) {
        Object obj = this.e.mo977receiveCatchingJP2dKIU(continuation);
        ugw.a();
        return obj;
    }
    ...
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    public SelectClause1<unf<E>> getOnReceiveCatching() {
