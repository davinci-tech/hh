...
/* renamed from: uoh, reason: from Kotlin metadata */
/* loaded from: classes10.dex */
public final class withContextUndispatched {
    ...
    public static final <T> FlowCollector<T> a(FlowCollector<? super T> flowCollector, CoroutineContext coroutineContext) {
        return ((flowCollector instanceof uot) || (flowCollector instanceof uom)) ? flowCollector : new uor(flowCollector, coroutineContext);
    }
    ...
    public static /* synthetic */ Object c(CoroutineContext coroutineContext, Object obj, Object obj2, Function2 function2, Continuation continuation, int i, Object obj3) {
        if ((i & 4) != 0) {
            obj2 = NO_THREAD_ELEMENTS.b(coroutineContext);
        }
        return e(coroutineContext, obj, obj2, function2, continuation);
    }

    public static final <T, V> Object e(CoroutineContext coroutineContext, V v, Object obj, Function2<? super V, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        Object d = NO_THREAD_ELEMENTS.d(coroutineContext, obj);
        try {
            Object invoke = ((Function2) uii.e(function2, 2)).invoke(v, new uoq(continuation, coroutineContext));
            NO_THREAD_ELEMENTS.a(coroutineContext, d);
            if (invoke == ugw.a()) {
