...
public final class uot<T> implements FlowCollector<T> {
    private final SendChannel<T> e;

    /* JADX WARN: Multi-variable type inference failed */
    public uot(SendChannel<? super T> sendChannel) {
        this.e = sendChannel;
    }

    @Override // kotlinx.coroutines.flow.FlowCollector
    public Object emit(T t, Continuation<? super ueu> continuation) {
        Object send = this.e.send(t, continuation);
        return send == ugw.a() ? send : ueu.d;
    }
}
