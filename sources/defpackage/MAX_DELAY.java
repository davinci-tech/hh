...
/* renamed from: una, reason: from Kotlin metadata */
/* loaded from: classes10.dex */
public final class MAX_DELAY {
    private static volatile Choreographer choreographer;
    public static final HandlerDispatcher d;

    public static final Handler ffR_(Looper looper, boolean z) {
        if (!z) {
    ...
    static {
        ...
        try {
            uel.b bVar = uel.d;
            b = uel.b(new umw(ffR_(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            uel.b bVar2 = uel.d;
            b = uel.b(createFailure.b(th));
        }
        d = (HandlerDispatcher) (uel.a(b) ? null : b);
    }
}
