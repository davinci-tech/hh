...
public class upq<T> extends AbstractCoroutine<T> implements CoroutineStackFrame {
    ...
    public upq(CoroutineContext coroutineContext, Continuation<? super T> continuation) {
    ...
    public void afterResume(Object state) {
        Continuation<T> continuation = this.e;
        continuation.resumeWith(recoverResult.c(state, continuation));
    }
}
