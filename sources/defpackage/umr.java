...
public final class umr {
    public static final umr d = new umr();
    private static final ThreadLocal<EventLoop> e = new ThreadLocal<>();

    private umr() {
    }

    public final EventLoop e() {
        ThreadLocal<EventLoop> threadLocal = e;
        EventLoop eventLoop = threadLocal.get();
        if (eventLoop != null) {
            return eventLoop;
        }
        EventLoop b = createEventLoop.b();
        threadLocal.set(b);
        return b;
    }
