...
public final class ukv extends JobCancellingNode implements ChildHandle {
    ...
    public ukv(ChildJob childJob) {
        this.f17452a = childJob;
    }
    ...
    public void invoke2(Throwable cause) {
        this.f17452a.parentCancelled(getJob());
    }
