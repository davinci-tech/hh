...
public class kgs implements SampleEventProducer {
    ...
    public cvp createSampleEvent(int i, String str) {
        ...
        byte[] d = new bms().a(2, 0).a(4, Integer.parseInt(str)).d();
        LogUtil.a("LINKAGE_ReplyStartLinkageEvent", "ReplyStartLinkageEvent replyData: ", cvx.d(d));
