...
public class aby implements ClockColorRule {
    ...
    public WatchFaceClock process(WatchFaceClock watchFaceClock, ColorResult colorResult, List<Integer> list) {
        ...
        if (d < 50.0d) {
            ...
            watchFaceClock.setColor(LABToColor2, -16777216);
            watchFaceClock.setColorList(Arrays.asList(Integer.valueOf(LABToColor2), -16777216));
        }
