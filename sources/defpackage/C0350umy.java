...
/* renamed from: umy, reason: from Kotlin metadata and case insensitive filesystem */
/* loaded from: classes.dex */
public final class C0350umy {
    public static final upu c = new upu("EMPTY");

    /* renamed from: a, reason: collision with root package name */
    public static final upu f17474a = new upu("OFFER_SUCCESS");
    public static final upu b = new upu("OFFER_FAILED");
    public static final upu i = new upu("POLL_FAILED");
    public static final upu d = new upu("ENQUEUE_FAILED");
    public static final upu e = new upu("ON_CLOSE_HANDLER_INVOKED");
}
