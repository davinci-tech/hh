...
public class iho extends DBCommon {
    ...
    public static String d() {
        ...
        sb.append("create table  IF NOT EXISTS hihealth_source_order(_id integer primary key not null,type_id integer not null,client_id integer not null,user_weight integer not null,create_time text not null)");
        return sb.toString();
    }

    @Override // com.huawei.hihealthservice.db.table.DBCommon
    public String[] getColumns() {
        return new String[]{"_id", "type_id", "client_id", "user_weight", "create_time"};
    }
