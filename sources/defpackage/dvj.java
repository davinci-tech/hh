...
public class dvj implements LinkageDataHandler {
    ...
    public cvv packageSamplePointInfo(JSONObject jSONObject, String str, int i) {
        try {
            ...
            cvv cvvVar = new cvv();
            cvvVar.d(i);
            cvvVar.b(blq.i(i2 * 10));
            return cvvVar;
        } catch (JSONException e) {
            ReleaseLogUtil.c("R_LINKAGE_Duration", "packageSamplePointInfo JSONException: ", ExceptionUtils.d(e));
            return new cvv();
        }
    }
}
