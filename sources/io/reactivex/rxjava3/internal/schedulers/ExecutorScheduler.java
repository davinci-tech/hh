...
public final class ExecutorScheduler extends Scheduler {
    ...
    public Disposable scheduleDirect(Runnable runnable) {
        ...
        try {
            if (this.executor instanceof ExecutorService) {
                ScheduledDirectTask scheduledDirectTask = new ScheduledDirectTask(onSchedule, this.interruptibleWorker);
    ...
    public Disposable scheduleDirect(Runnable runnable, long j, TimeUnit timeUnit) {
        ...
        delayedRunnable.timed.replace(SingleHolder.HELPER.scheduleDirect(new DelayedDispose(delayedRunnable), j, timeUnit));
    ...
    public Disposable schedulePeriodicallyDirect(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        if (this.executor instanceof ScheduledExecutorService) {
            try {
                ScheduledDirectPeriodicTask scheduledDirectPeriodicTask = new ScheduledDirectPeriodicTask(RxJavaPlugins.onSchedule(runnable), this.interruptibleWorker);
    ...
    public static final class ExecutorWorker extends Scheduler.Worker implements Runnable {
        ...
        public Disposable schedule(Runnable runnable, long j, TimeUnit timeUnit) {
            ...
            if (executor instanceof ScheduledExecutorService) {
                ...
                scheduledRunnable.setFuture(new DisposeOnCancel(SingleHolder.HELPER.scheduleDirect(scheduledRunnable, j, timeUnit)));
            }
