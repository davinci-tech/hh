...
public final class ObservableFlatMap<T, U> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class MergeObserver<T, U> extends AtomicInteger implements Disposable, Observer<T> {
        ...
        boolean addInner(InnerObserver<T, U> innerObserver) {
            ...
            } while (!ProcessGlobalConfig$$ExternalSyntheticBackportWithForwarding0.m(this.observers, innerObserverArr, innerObserverArr2));
            return true;
        }
        ...
        boolean tryEmitScalar(Supplier<? extends U> supplier) {
            try {
                U u = supplier.get();
                if (u == null) {
                    return true;
