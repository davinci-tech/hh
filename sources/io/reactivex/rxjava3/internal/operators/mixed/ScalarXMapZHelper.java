...
final class ScalarXMapZHelper {
    ...
    static <T> boolean tryAsCompletable(Object obj, Function<? super T, ? extends CompletableSource> function, CompletableObserver completableObserver) {
        ...
        try {
            aah aahVar = (Object) ((Supplier) obj).get();
            CompletableSource completableSource = aahVar != null ? (CompletableSource) Objects.requireNonNull(function.apply(aahVar), "The mapper returned a null CompletableSource") : null;
    ...
    static <T, R> boolean tryAsMaybe(Object obj, Function<? super T, ? extends MaybeSource<? extends R>> function, Observer<? super R> observer) {
        ...
        try {
            aah aahVar = (Object) ((Supplier) obj).get();
            MaybeSource maybeSource = aahVar != null ? (MaybeSource) Objects.requireNonNull(function.apply(aahVar), "The mapper returned a null MaybeSource") : null;
            if (maybeSource == null) {
    ...
    static <T, R> boolean tryAsSingle(Object obj, Function<? super T, ? extends SingleSource<? extends R>> function, Observer<? super R> observer) {
        ...
        try {
            aah aahVar = (Object) ((Supplier) obj).get();
            SingleSource singleSource = aahVar != null ? (SingleSource) Objects.requireNonNull(function.apply(aahVar), "The mapper returned a null SingleSource") : null;
