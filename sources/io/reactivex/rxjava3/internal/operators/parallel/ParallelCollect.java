    ...
    public void subscribe(Subscriber<? super C>[] subscriberArr) {
        ...
        if (validate(onSubscribe)) {
            ...
            for (int i = 0; i < length; i++) {
                try {
                    subscriberArr2[i] = new ParallelCollectSubscriber(onSubscribe[i], Objects.requireNonNull(this.initialCollection.get(), "The initialSupplier returned a null value"), this.collector);
                } catch (Throwable th) {
