...
public final class FlowableCollect<T, U> extends AbstractFlowableWithUpstream<T, U> {
    ...
    public void subscribeActual(Subscriber<? super U> subscriber) {
        try {
            this.source.subscribe((FlowableSubscriber) new CollectSubscriber(subscriber, Objects.requireNonNull(this.initialSupplier.get(), "The initial value supplied is null"), this.collector));
        } catch (Throwable th) {
