...
public abstract class ConcurrentLinkedListNode<N extends ConcurrentLinkedListNode<N>> {
    ...
    public final boolean trySetNext(N value) {
        return ProcessGlobalConfig$$ExternalSyntheticBackportWithForwarding0.m(_next$FU, this, (Object) null, value);
    }
    ...
    public final boolean markAsClosed() {
        ...
        upuVar = uoy.e;
        return ProcessGlobalConfig$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, (Object) null, upuVar);
    }

    public final void remove() {
        if (ASSERTIONS_ENABLED.a() && !getRemoved()) {
            throw new AssertionError();
        }
        if (ASSERTIONS_ENABLED.a() && !(!isTail())) {
            throw new AssertionError();
        }
        while (true) {
