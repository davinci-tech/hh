...
public abstract class AtomicOp<T> extends OpDescriptor {
    ...
    private volatile /* synthetic */ Object _consensus = NO_DECISION.d;
    ...
    public final boolean isDecided() {
        return this._consensus != NO_DECISION.d;
    }

    public final Object decide(Object decision) {
        if (ASSERTIONS_ENABLED.a() && decision == NO_DECISION.d) {
            throw new AssertionError();
        }
        Object obj = this._consensus;
        return obj != NO_DECISION.d ? obj : ProcessGlobalConfig$$ExternalSyntheticBackportWithForwarding0.m(_consensus$FU, this, NO_DECISION.d, decision) ? decision : this._consensus;
    }
