...
public interface Channel<E> extends SendChannel<E>, ReceiveChannel<E> {
    ...
    public static final Companion INSTANCE = Companion.f14490a;
    ...
    public static final class a {
        ...
        public static <E> Object a(Channel<E> channel, Continuation<? super E> continuation) {
            return ReceiveChannel.c.e(channel, continuation);
        }

        @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in the favour of 'tryReceive'. Please note that the provided replacement does not rethrow channel's close cause as 'poll' did, for the precise replacement please refer to the 'poll' documentation", replaceWith = @ReplaceWith(expression = "tryReceive().getOrNull()", imports = {}))
        public static <E> E b(Channel<E> channel) {
            return (E) ReceiveChannel.c.a(channel);
        }

        public static <E> SelectClause1<E> e(Channel<E> channel) {
            return ReceiveChannel.c.e(channel);
        }
    }
    ...
    /* renamed from: kotlinx.coroutines.channels.Channel$b, reason: from kotlin metadata */
    /* loaded from: classes10.dex */
    public static final class Companion {

        /* renamed from: a, reason: collision with root package name */
        static final /* synthetic */ Companion f14490a = new Companion();
        private static final int e = upy.d(Channel.DEFAULT_BUFFER_PROPERTY_NAME, 64, 1, 2147483646);
