...
public interface SendChannel<E> {
    ...
    void invokeOnClose(Function1<? super Throwable, ueu> handler);
    ...
    Object send(E e, Continuation<? super ueu> continuation);

    /* renamed from: trySend-JP2dKIU */
    Object mo979trySendJP2dKIU(E element);

    @Metadata(k = 3, mv = {1, 6, 0}, xi = 48)
    public static final class d {
        public static /* synthetic */ boolean e(SendChannel sendChannel, Throwable th, int i, Object obj) {
            if (obj != null) {
        ...
        public static <E> boolean b(SendChannel<? super E> sendChannel, E e) {
            Object mo979trySendJP2dKIU = sendChannel.mo979trySendJP2dKIU(e);
            if (unf.i(mo979trySendJP2dKIU)) {
                return true;
            }
            Throwable c = unf.c(mo979trySendJP2dKIU);
            if (c == null) {
                return false;
            }
