...
public abstract class CoroutineDispatcher extends AbstractCoroutineContextElement implements ContinuationInterceptor {
    ...
    public <E extends CoroutineContext.Element> E get(CoroutineContext.Key<E> key) {
        return (E) ContinuationInterceptor.a.e(this, key);
    }

    @Override // kotlin.coroutines.AbstractCoroutineContextElement, kotlin.coroutines.CoroutineContext.Element, kotlin.coroutines.CoroutineContext
    public CoroutineContext minusKey(CoroutineContext.Key<?> key) {
        return ContinuationInterceptor.a.d(this, key);
    }
    ...
    /* renamed from: kotlinx.coroutines.CoroutineDispatcher$e, reason: from kotlin metadata */
    public static final class Companion extends AbstractCoroutineContextKey<ContinuationInterceptor, CoroutineDispatcher> {
        private Companion() {
            super(ContinuationInterceptor.INSTANCE, new Function1<CoroutineContext.Element, CoroutineDispatcher>() { // from class: kotlinx.coroutines.CoroutineDispatcher.e.3
    ...
    public CoroutineDispatcher limitedParallelism(int parallelism) {
        ...
        return new uph(this, parallelism);
    }
    ...
    public final <T> Continuation<T> interceptContinuation(Continuation<? super T> continuation) {
        return new uoz(this, continuation);
    }
    ...
    public String toString() {
        return classSimpleName.b(this) + '@' + classSimpleName.d(this);
    }
}
