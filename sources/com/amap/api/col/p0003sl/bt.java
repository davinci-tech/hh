...
public final class bt {
    ...
    private static String c(String str) {
        return "000001".equals(str) ? SmartMsgConstant.SHOW_METHOD_SMART_CARD : str;
    }
    ...
    public static String a(Context context, String str) {
        try {
            return dv.a(dp.a(context).open(str));
        } catch (Throwable th) {
            iv.c(th, "MapDownloadManager", "readOfflineAsset");
            th.printStackTrace();
            return null;
        }
    }
    ...
    java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.InsnArg.getType()" because "changeArg" is null
    	...
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.visit(TypeInferenceVisitor.java:75)
     */
    /* JADX WARN: Not initialized variable reg: 3, insn: 0x0084: MOVE (r2 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:72:0x0084 */
    public static java.lang.String c(java.io.File r6) {
        ...
        L4d:
            ...
            com.amap.api.col.p0003sl.iv.c(r1, r0, r4)     // Catch: java.lang.Throwable -> L83
        ...
        L9c:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.col.p0003sl.bt.c(java.io.File):java.lang.String");
    }

    public static void b(String str, Context context) throws IOException, Exception {
        File[] listFiles = new File(dv.c(context)).listFiles();
        if (listFiles == null) {
            return;
        }
    ...
    public static void c(String str, Context context) {
        ...
        if ("".equals(dv.c(context))) {
            return;
        }
        File file = new File(dv.c(context) + "offlinemapv4.png");
        if (!file.exists()) {
            try {
                file.createNewFile();
            } catch (IOException e) {
                iv.c(e, "OfflineUpdateCityHandlerAbstract", "writeSD dirCreate");
                e.printStackTrace();
            }
        }
        if (a() > 1048576) {
            ...
            try {
                ...
                iv.c(e, "OfflineUpdateCityHandlerAbstract", "writeSD filenotfound");
                e.printStackTrace();
                ...
                e = e7;
                fileOutputStream2 = fileOutputStream;
                iv.c(e, "OfflineUpdateCityHandlerAbstract", "writeSD io");
                e.printStackTrace();
                if (fileOutputStream2 != null) {
                    try {
                        fileOutputStream2.close();
    ...
    public static String b(String str) {
        try {
            ...
            iv.c(th, "Utility", "getZipFileNameFromUrl");
            return null;
        }
    }
}
