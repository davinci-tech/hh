...
public final class k implements cq.a {
    ...
    private final String f1245a = "__MACOSX";
    ...
    public final void a() {
        ...
        try {
            ...
            iv.c(th, "AMapCustomStyleManager", "updateStyle");
            dv.a(th);
        }
    }
    ...
    private void a(byte[] bArr) {
        ...
        if (bArr == null || (a2 = cx.a(bArr)) == null || a2.a() == null) {
            return;
        }
        try {
            ...
            if (optJSONObject4 != null && (optJSONObject = optJSONObject4.optJSONObject("multiFillColors")) != null) {
                int a3 = cx.a(optJSONObject.optString("smooth"));
                int a4 = cx.a(optJSONObject.optString("slow"));
                int a5 = cx.a(optJSONObject.optString("congested"));
                int a6 = cx.a(optJSONObject.optString("seriousCongested"));
            ...
            iv.c(th, "AMapCustomStyleManager", "setExtraStyle");
            dv.a(th);
        }
    }
    ...
    private void a(String str, boolean z) {
        boolean z2;
        int a2 = !TextUtils.isEmpty(str) ? cx.a(str) : Integer.MIN_VALUE;
        ...
        if (bArr != null) {
            if (!z) {
                ...
                z2 = true;
                this.b.getGLMapEngine().setBackgroundTexture(this.i, dv.a((byte[]) bArr.clone(), 0, a2, z2));
            }
            z2 = false;
            this.b.getGLMapEngine().setBackgroundTexture(this.i, dv.a((byte[]) bArr.clone(), 0, a2, z2));
        }
    ...
    private static boolean b(byte[] bArr) {
        ...
        try {
            ...
            iv.c(th, "AMapCustomStyleManager", "checkData");
            dv.a(th);
        }
        if (bArr.length < 8) {
            return false;
        }
        return ((bArr[4] & 255) | ((((bArr[7] << 24) & (-16777216)) | ((bArr[6] << BaseType.Union) & HwColorPicker.MASK_RESULT_STATE)) | ((bArr[5] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK))) == 2001;
    }
    ...
    public final void a(CustomMapStyleOptions customMapStyleOptions) {
        ...
        synchronized (this) {
            ...
            if (this.c.isEnable() != customMapStyleOptions.isEnable()) {
                ...
                this.d = true;
                ds.b(this.j, customMapStyleOptions.isEnable());
            }
            if (this.c.isEnable()) {
                if (!TextUtils.equals(this.c.getStyleId(), customMapStyleOptions.getStyleId())) {
                    ...
                    if (!TextUtils.isEmpty(styleId) && (iAMapDelegate = this.b) != null && iAMapDelegate.getMapConfig() != null && this.b.getMapConfig().isProFunctionAuthEnable()) {
                        if (this.u == null) {
                            if (this.A) {
                                this.u = new cq(this.j, this, 2, "abroad_sdk_json_sdk_780_zip");
                            } else {
                                this.u = new cq(this.j, this, 1, "sdk_780");
                            }
                        }
                        this.u.a(styleId);
                        this.u.b();
                        if (this.v == null) {
                            this.v = new cq(this.j, this, 0, null);
                        }
                        this.v.a(styleId);
                        this.v.b();
                    }
    ...
    @Override // com.amap.api.col.3sl.cq.a
