...
public final class z implements IMapFragmentDelegate {

    /* renamed from: a, reason: collision with root package name */
    public static volatile Context f1381a;
    ...
    public final IAMap getMap() throws RemoteException {
        if (this.d == null) {
            ...
            int i = f1381a.getResources().getDisplayMetrics().densityDpi;
            if (i <= 120) {
                v.f1366a = 0.5f;
            } else if (i <= 160) {
                v.f1366a = 0.8f;
            ...
            int i2 = this.e;
            if (i2 == 0) {
                this.d = new n(f1381a, this.c).a();
            } else if (i2 == 1) {
                this.d = new o(f1381a, this.c).a();
            } else {
                this.d = new m(f1381a).a();
            }
        }
        return this.d;
    }
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) throws RemoteException {
        byte[] byteArray;
        if (f1381a == null && layoutInflater != null) {
