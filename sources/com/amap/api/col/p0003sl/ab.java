...
final class ab implements IProjectionDelegate {

    /* renamed from: a, reason: collision with root package name */
    private IAMapDelegate f889a;

    public ab(IAMapDelegate iAMapDelegate) {
        this.f889a = iAMapDelegate;
    }
    ...
    public final LatLng fromScreenLocation(Point point) throws RemoteException {
        ...
        this.f889a.getPixel2LatLng(point.x, point.y, obtain);
    ...
    public final Point toScreenLocation(LatLng latLng) throws RemoteException {
        ...
        this.f889a.getLatLng2Pixel(latLng.latitude, latLng.longitude, obtain);
    ...
    public final VisibleRegion getVisibleRegion() throws RemoteException {
        int mapWidth = this.f889a.getMapWidth();
        int mapHeight = this.f889a.getMapHeight();
    ...
    public final PointF toMapLocation(LatLng latLng) throws RemoteException {
        ...
        this.f889a.getLatLng2Map(latLng.latitude, latLng.longitude, obtain);
    ...
    public final float toMapLenWithWin(int i) {
        ...
        return this.f889a.toMapLenWithWin(i);
    }
    ...
    public final TileProjection fromBoundsToTile(LatLngBounds latLngBounds, int i, int i2) throws RemoteException {
        ...
        this.f889a.latlon2Geo(latLngBounds.southwest.latitude, latLngBounds.southwest.longitude, obtain);
        this.f889a.latlon2Geo(latLngBounds.northeast.latitude, latLngBounds.northeast.longitude, obtain2);
        int i3 = 20 - i;
    ...
    public final LatLngBounds getMapBounds(LatLng latLng, float f) throws RemoteException {
        IAMapDelegate iAMapDelegate = this.f889a;
    ...
    public final AMapCameraInfo getCameraInfo() {
        return this.f889a.getCamerInfo();
    }
    ...
    public final float calculateMapZoomer(LatLng latLng, int i) {
        ...
        MapConfig mapConfig = this.f889a.getMapConfig();
        if (mapProjection == null || mapConfig == null) {
            return 3.0f;
        }
        return dv.a(mapProjection, (int) mapConfig.getSX(), (int) mapConfig.getSY(), latLng.latitude, latLng.longitude, i);
    }
}
