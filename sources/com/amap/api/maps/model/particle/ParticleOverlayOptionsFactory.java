...
public class ParticleOverlayOptionsFactory {
    ...
    private static List<ParticleOverlayOptions> a() {
        ...
        particleOverlayOptions.setDuration(PreConnectManager.CONNECT_INTERNAL);
        ...
        particleOverlayOptions.setParticleLifeTime(PreConnectManager.CONNECT_INTERNAL);
        ...
        particleOverlayOptions2.setDuration(PreConnectManager.CONNECT_INTERNAL);
        ...
        particleOverlayOptions2.setParticleLifeTime(PreConnectManager.CONNECT_INTERNAL);
