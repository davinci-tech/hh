...
public final class GroundOverlayOptions extends BaseOptions implements Parcelable, Cloneable {
    ...
    private void a() {
        ...
        LatLng latLng = new LatLng(this.southwest.latitude + ((1.0f - this.anchorV) * (this.northeast.latitude - this.southwest.latitude)), this.southwest.longitude + (this.anchorU * (this.northeast.longitude - this.southwest.longitude)));
        this.latLng = latLng;
    ...
    public final GroundOverlayOptions m83clone() {
        try {
            super.clone();
