...
public interface IEventListener {
    ...
    public static final int EVENT_ID_CONNECTED = 3100;
    public static final int EVENT_ID_CONNECT_FAILED = 3101;
    ...
    public static final int EVENT_ID_DEVICE_DLNA_CONN_SUCC = 3011;
    public static final int EVENT_ID_DEVICE_REMOVE = 3002;
    public static final int EVENT_ID_DEVICE_REQUEST_CONN = 3012;
    public static final int EVENT_ID_DEVICE_REQUEST_PLAY = 3013;
    ...
    public static final int EVENT_ID_DISCONNECTED = 3102;
    public static final int EVENT_ID_DISPLAY_AVAILABLE = 3700;
    public static final int EVENT_ID_GRAB_STATE_CHANGED = 3014;
    public static final int EVENT_ID_HISIGHT_RELATED_DIALOG_NOT_SHOW = 3107;
    public static final int EVENT_ID_HISIGHT_STATE_AGREE_CONNECTION_REQ = 3109;
    ...
    public static final int EVENT_ID_HISIGHT_STATE_KIT_NOT_CERTIFIED = 3108;
    ...
    public static final int EVENT_ID_HISIGHT_STATE_STREAM = 3110;
    ...
    public static final int EVENT_ID_NOTICE_INIT_RESULT = 2010;
    ...
    public static final String EVENT_TYPE_PLAYER_MEDIA_STOP_QUIT = "EVENT_TYPE_PLAYER_MEDIA_STOP_QUIT";
    ...
    @Deprecated
    default void onDisplayUpdate(int i, String str, String str2, int i2) {
    }
    ...
    @Deprecated
    default void onMirrorUpdate(int i, String str, String str2, int i2, boolean z) {
    }
