...
public class KaleidoscopeArranger extends AbstractArranger {
    ...
    private static final int SAMPLE_DEGREE = 30;
    ...
    private static final float SAMPLE_RADIUS = (float) Math.toRadians(30.0d);
    public static final Parcelable.Creator<KaleidoscopeArranger> CREATOR = new Parcelable.Creator<KaleidoscopeArranger>() { // from class: com.huawei.animationkit.computationalwallpaper.pattern.arranger.impl.KaleidoscopeArranger.2
        @Override // android.os.Parcelable.Creator
        /* renamed from: gb_, reason: merged with bridge method [inline-methods] */
        public KaleidoscopeArranger createFromParcel(Parcel parcel) {
            return new KaleidoscopeArranger(parcel);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: c, reason: merged with bridge method [inline-methods] */
        public KaleidoscopeArranger[] newArray(int i) {
            return new KaleidoscopeArranger[i];
        }
    };
    ...
    private KaleidoscopeArranger(float f) {
        ...
        this.mClipBitmap = Bitmap.createBitmap(sqrt, (int) (sqrt * Math.tan(SAMPLE_RADIUS)), Bitmap.Config.ARGB_8888);
    ...
    private KaleidoscopeArranger(Parcel parcel) {
    ...
    private void initAnimation() {
        ...
        this.mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: adp
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                KaleidoscopeArranger.this.m124x2cf2c0b3(valueAnimator);
            }
        });
    }

    /* renamed from: lambda$initAnimation$0$com-huawei-animationkit-computationalwallpaper-pattern-arranger-impl-KaleidoscopeArranger, reason: not valid java name */
    public /* synthetic */ void m124x2cf2c0b3(ValueAnimator valueAnimator) {
