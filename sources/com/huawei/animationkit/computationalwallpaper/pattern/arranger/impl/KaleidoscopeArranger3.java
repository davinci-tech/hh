...
public class KaleidoscopeArranger3 extends AbstractArranger {
    ...
    private static final int SAMPLE_DEGREE = 60;
    ...
    private static final float SAMPLE_RADIUS = (float) Math.toRadians(60.0d);
    public static final Parcelable.Creator<KaleidoscopeArranger3> CREATOR = new Parcelable.Creator<KaleidoscopeArranger3>() { // from class: com.huawei.animationkit.computationalwallpaper.pattern.arranger.impl.KaleidoscopeArranger3.5
        @Override // android.os.Parcelable.Creator
        /* renamed from: gd_, reason: merged with bridge method [inline-methods] */
        public KaleidoscopeArranger3 createFromParcel(Parcel parcel) {
            return new KaleidoscopeArranger3(parcel);
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public KaleidoscopeArranger3[] newArray(int i) {
            return new KaleidoscopeArranger3[i];
        }
    };
    ...
    private KaleidoscopeArranger3(float f) {
        ...
        this.mClipBitmap = Bitmap.createBitmap(sqrt, (int) (sqrt * Math.sin(SAMPLE_RADIUS)), Bitmap.Config.ARGB_8888);
    ...
    private KaleidoscopeArranger3(Parcel parcel) {
    ...
    private void initAnimation() {
        ...
        this.mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: ads
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                KaleidoscopeArranger3.this.m126x716555e0(valueAnimator);
            }
        });
    }

    /* renamed from: lambda$initAnimation$0$com-huawei-animationkit-computationalwallpaper-pattern-arranger-impl-KaleidoscopeArranger3, reason: not valid java name */
    public /* synthetic */ void m126x716555e0(ValueAnimator valueAnimator) {
    ...
    private Bitmap mirrorBitmap(Bitmap bitmap) {
        ...
        canvas.drawBitmap(bitmap, f, f2, this.mPaint);
        canvas.scale(-1.0f, 1.0f, this.mClipLength, f2);
        canvas.rotate(-60.0f, this.mClipLength, f2);
        canvas.drawBitmap(bitmap, f, f2, this.mPaint);
        canvas.rotate(60.0f, this.mClipLength, f2);
        canvas.scale(1.0f, -1.0f, this.mClipLength, f2);
        canvas.rotate(-60.0f, this.mClipLength, f2);
    ...
    private Path getClipPath() {
        int sin = (int) (this.mClipLength * Math.sin(SAMPLE_RADIUS));
        Path path = new Path();
        path.moveTo(-1.0f, 0.0f);
        path.lineTo(this.mClipLength + 1, 0.0f);
        path.lineTo(this.mClipLength / 2.0f, sin + 2);
        path.close();
        return path;
    }
