...
public class zyx extends HttpsURLConnection {
    public static final AgentLog abc = AgentLogManager.getAgentLog();
    public HttpsURLConnection bcd;
    public wxy cde;
    public tsr def;
    ...
    public class abc implements qpo {
        ...
        public void bcd(rqp rqpVar) {
            ...
            zyx.abc(zyx.this, this.abc);
            long contentLength = zyx.this.bcd.getContentLength();
            long j = rqpVar.abc;
            this.abc.def(contentLength);
            this.abc.abc(j);
            zyx.this.abc(this.abc);
        }
    }
    ...
    public class bcd implements qpo {
        ...
        public void bcd(rqp rqpVar) {
            ...
            zyx.abc(zyx.this, this.abc);
            String requestProperty = zyx.this.bcd.getRequestProperty("Content-length");
            long j = rqpVar.abc;
            if (requestProperty != null) {
                try {
                    j = Long.parseLong(requestProperty);
                } catch (Throwable th) {
                    zyx.abc.warn("failed to get content length: " + th.getMessage());
                }
            }
            this.abc.bcd(j);
            zyx.this.abc(this.abc);
    ...
    public zyx(HttpsURLConnection httpsURLConnection) {
        super(httpsURLConnection.getURL());
        this.def = null;
        this.bcd = httpsURLConnection;
        bcd();
        if (httpsURLConnection.getURL() != null) {
            xyz.abc(httpsURLConnection.getURL().getHost(), this.cde);
        }
        if (Agent.isNuwaTracerEnable()) {
            String bcd2 = k0.bcd();
            String abc2 = k0.abc();
            abc(httpsURLConnection, bcd2, abc2);
            this.cde.fgh(bcd2);
            this.cde.efg(abc2);
        }
    }

    public static void abc(zyx zyxVar, wxy wxyVar) {
        zyxVar.getClass();
        try {
            wxyVar.bcd(zyxVar.bcd.getResponseCode());
        } catch (Throwable th) {
            abc.warn("failed to get status code: " + th.getMessage());
        }
    }
    ...
    public String getCipherSuite() {
        return this.bcd.getCipherSuite();
    }
    ...
    public InputStream getErrorStream() {
        ...
        try {
            ...
            if (tsrVar == null || tsrVar.available() == 0) {
                if (this.bcd.getErrorStream() == null) {
                    abc.debug("error stream is null.");
            ...
            abc.warn("failed to get error stream: " + th.toString());
            return this.bcd.getErrorStream();
        }
    }
    ...
    public HostnameVerifier getHostnameVerifier() {
        return this.bcd.getHostnameVerifier();
    }
    ...
    public Certificate[] getLocalCertificates() {
        return this.bcd.getLocalCertificates();
    }

    @Override // javax.net.ssl.HttpsURLConnection
    public Principal getLocalPrincipal() {
        return this.bcd.getLocalPrincipal();
    }
    ...
    public Principal getPeerPrincipal() throws SSLPeerUnverifiedException {
        return this.bcd.getPeerPrincipal();
    }
    ...
    public SSLSocketFactory getSSLSocketFactory() {
        return this.bcd.getSSLSocketFactory();
    }

    @Override // javax.net.ssl.HttpsURLConnection
    public Certificate[] getServerCertificates() throws SSLPeerUnverifiedException {
        try {
            return this.bcd.getServerCertificates();
    ...
    public void setHostnameVerifier(HostnameVerifier hostnameVerifier) {
        this.bcd.setHostnameVerifier(hostnameVerifier);
    }
    ...
    public void setSSLSocketFactory(SSLSocketFactory sSLSocketFactory) {
        this.bcd.setSSLSocketFactory(sSLSocketFactory);
    }
    ...
    public final void abc(HttpsURLConnection httpsURLConnection, String str, String str2) {
        if (TextUtils.isEmpty(httpsURLConnection.getRequestProperty("net-msg-id"))) {
            httpsURLConnection.setRequestProperty("net-msg-id", str);
        }
        if (TextUtils.isEmpty(httpsURLConnection.getRequestProperty(HeaderType.X_NUWA_SPAN_ID))) {
            httpsURLConnection.setRequestProperty(HeaderType.X_NUWA_SPAN_ID, str2);
        }
        if (TextUtils.isEmpty(httpsURLConnection.getRequestProperty(HeaderType.X_NUWA_MICROSERVICE_NAME))) {
            httpsURLConnection.setRequestProperty(HeaderType.X_NUWA_MICROSERVICE_NAME, HiAnalyticsManager.APM_EVENT_ID);
        }
    }
}
