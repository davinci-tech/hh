...
public class edc extends ForwardingSource {
    public long abc;
    public boolean bcd;
    public boolean cde;
    public final /* synthetic */ dcb def;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public edc(dcb dcbVar, Source source) {
        super(source);
        this.def = dcbVar;
        this.bcd = false;
        this.cde = false;
    ...
    public final void abc(String str) {
        ...
        wxyVar2.uvw = xyz.abc(wxyVar2);
        wxyVar2.abc(xyz.abc(wxyVar2));
        wxyVar2.d();
        vwx e = wxyVar2.e();
        if (e != null) {
    ...
    */
    public long read(okio.Buffer r7, long r8) throws java.io.IOException {
        /*
            ...
            r1 = 1
            if (r0 != 0) goto L12
            com.huawei.agconnect.apms.dcb r0 = r6.def
            com.huawei.agconnect.apms.wxy r0 = r0.abc
            int r2 = com.huawei.agconnect.apms.xyz.abc(r0)
            long r2 = (long) r2
            r0.tuv = r2
            r6.cde = r1
        L12:
        ...
        L36:
            ...
            com.huawei.agconnect.apms.dcb r9 = r6.def     // Catch: java.io.IOException -> L5e
            com.squareup.okhttp.ResponseBody r9 = r9.bcd     // Catch: java.io.IOException -> L5e
            long r2 = r9.contentLength()     // Catch: java.io.IOException -> L5e
        ...
        L5e:
            r7 = move-exception
            com.huawei.agconnect.apms.dcb r8 = r6.def
        ...
        L72:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.agconnect.apms.edc.read(okio.Buffer, long):long");
    }
}
