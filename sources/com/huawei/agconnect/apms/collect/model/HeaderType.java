...
public interface HeaderType {
    ...
    public static final String X_NUWA_CALL_SEQ = "x-nuwa-call-seq";
    ...
    public static final String X_NUWA_TRACE_ID = "net-msg-id";
    public static final String X_NUWA_TRACE_NE_IN = "network-in";
    public static final String X_NUWA_TRACE_NE_OUT = "network-out";
}
