...
public class o {
    ...
    private JSONObject a(JSONObject jSONObject) throws JSONException {
        ...
        jSONObject2.put(MessageConstant.GROUP_MEDAL_TYPE, this.f5682a);
    ...
    private boolean f(JSONObject jSONObject) {
        ...
        try {
            ...
            if (jSONObject2.has(TemplateStyleRecord.STYLE)) {
                this.t = jSONObject2.getInt(TemplateStyleRecord.STYLE);
            }
    ...
    private void g(JSONObject jSONObject) {
        this.f5682a = jSONObject.optString(MessageConstant.GROUP_MEDAL_TYPE);
        HMSLog.d("PushSelfShowLog", "NOTIFY_GROUP:" + this.f5682a);
    ...
    private JSONObject q() throws JSONException {
        ...
        jSONObject.put(TemplateStyleRecord.STYLE, this.t);
    ...
    public byte[] n() {
        try {
            return a(a(b(u()), q())).toString().getBytes(m.f5679a);
        } catch (JSONException e) {
    ...
    public byte[] x() {
        return this.s.getBytes(m.f5679a);
    }
