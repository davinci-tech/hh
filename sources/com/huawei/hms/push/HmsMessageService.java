...
public class HmsMessageService extends Service {
    ...
    private final Messenger f5664a = new Messenger(new f(new b(this, null)));
    ...
    class a implements Runnable {
        ...
        public void run() {
            ...
            if (this.b.equals(BaseUtils.getLocalToken(applicationContext, this.f5665a))) {
                return;
            }
            HMSLog.i("HmsMessageService", "receive a new token, refresh the local token");
            BaseUtils.saveToken(applicationContext, this.f5665a, this.b);
        }
    }
    ...
    public void handleIntentMessage(Intent intent) {
        ...
        try {
            ...
            if ("new_token".equals(stringExtra2)) {
                ...
                b(stringExtra3, stringExtra, intent.getIntExtra(VastAttribute.ERROR, ErrorEnum.ERROR_UNKNOWN.getInternalCode()));
    ...
    private void a(Intent intent, String str) {
        int intExtra = intent.getIntExtra(VastAttribute.ERROR, ErrorEnum.SUCCESS.getInternalCode());
