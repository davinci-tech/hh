...
public abstract class HmsClient extends BaseHmsClient implements AnyClient {
    ...
    static class a implements BaseAdapter.BaseCallBack {

        /* renamed from: a, reason: collision with root package name */
        private final AnyClient.CallBack f4455a;
        private final WeakReference<HmsClient> b;

        a(HmsClient hmsClient, AnyClient.CallBack callBack) {
            this.f4455a = callBack;
        ...
        public void onError(String str) {
            ...
            if (!responseWrap.fromJson(str)) {
                this.f4455a.onCallback(new ResponseHeader(1, CommonCode.ErrorCode.ARGUMENTS_INVALID, "response header json error"), new JSONObject().toString());
                return;
            }
            ...
            this.f4455a.onCallback(responseHeader, responseWrap.getBody());
        }
        ...
        private void a(String str, String str2) {
            ...
            if (responseHeader.fromJson(str)) {
                ...
                a(responseHeader.getSessionId());
                this.f4455a.onCallback(responseHeader, str2);
                return;
            }
            this.f4455a.onCallback(new ResponseHeader(1, CommonCode.ErrorCode.ARGUMENTS_INVALID, "response header json error"), new JSONObject().toString());
        }
