...
public class aacg {
    ...
    public Task<List<String>> aaba(final String str) {
        ...
        return aacq.aab(new Callable() { // from class: com.huawei.hms.health.aacg$$ExternalSyntheticLambda0
    ...
    public Task<String> aab(final String str, final String str2) {
        ...
        final HealthKitApiInvoker healthKitApiInvoker = new HealthKitApiInvoker(aaba);
        return aacq.aab(new Callable() { // from class: com.huawei.hms.health.aacg$$ExternalSyntheticLambda2
            @Override // java.util.concurrent.Callable
            public final Object call() {
                String aab2;
    ...
    public Task<List<String>> aab(final String str) {
        ...
        final HealthKitApiInvoker healthKitApiInvoker = new HealthKitApiInvoker(aaba);
        return aacq.aab(new Callable() { // from class: com.huawei.hms.health.aacg$$ExternalSyntheticLambda1
            @Override // java.util.concurrent.Callable
            public final Object call() {
                List aab2;
