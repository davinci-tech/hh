...
public class x {
    ...
    private String f4622a = q0.i().getFilesDir().getPath();
    ...
    public String a() {
        ...
        return HexUtil.byteArray2HexStr(PBKDF2.pbkdf2(a(b, b2, b3, d), HexUtil.hexStr2ByteArray(b4), 10000, 16));
    }
    ...
    private String a(String str) {
        return this.f4622a + "/hms/component/".replace("component", str);
    }
