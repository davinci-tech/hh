...
public class x0 extends o {
    public static Pair<String, String> e(Context context) {
        ...
        if (telephonyManager != null && telephonyManager.getSimState() == 5) {
            ...
            return (TextUtils.isEmpty(networkOperator) || TextUtils.equals(networkOperator, Constants.NULL)) ? new Pair<>("", "") : networkOperator.length() > 3 ? new Pair<>(networkOperator.substring(0, 3), networkOperator.substring(3)) : new Pair<>("", "");
        }
        return new Pair<>("", "");
    }
