...
public class HianalyticsHelper {
    ...
    private HianalyticsHelper() {
        ...
        try {
            if (ContextHolder.getAppContext().getPackageManager().getPackageInfo(Constants.WELINK_PKG_NAME, 0) == null) {
                z = false;
            }
        ...
        if (getInstance().isEnableReportNoSeed(ContextHolder.getAppContext())) {
            ...
            InitReport.reportWhenInit(new Runnable() { // from class: com.huawei.hms.framework.common.hianalytics.HianalyticsHelper.1
                ...
                public void run() {
                    ...
                    crashHianalyticsData.put("sdk_version", "8.0.1.307");
                    crashHianalyticsData.put("crash_type", TrackConstants$Events.EXCEPTION);
