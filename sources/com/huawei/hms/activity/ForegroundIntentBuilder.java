...
public class ForegroundIntentBuilder {
    ...
    public Intent build() {
        String packageName;
        String appId;
        Intent intentStartBridgeActivity = BridgeActivity.getIntentStartBridgeActivity(this.f4258a, ForegroundBusDelegate.class.getName());
        Context context = this.f;
        if (context != null) {
            packageName = context.getPackageName();
            appId = Util.getAppId(this.f);
        } else {
            packageName = this.f4258a.getPackageName();
            appId = Util.getAppId(this.f4258a);
        }
    ...
    public ForegroundIntentBuilder setInnerHms() {
        this.e = this.f4258a.getPackageName();
        return this;
    }
