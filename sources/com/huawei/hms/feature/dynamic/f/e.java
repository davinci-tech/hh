...
public class e {
    ...
    private static final String f4525a = "X509CertUtil";
    ...
    private static List<String> c(String str) {
        try {
            ...
            Log.e(f4525a, "Failed to getCertChain,JSONException:", e2);
            return Collections.emptyList();
        }
    }
    ...
    public static List<X509Certificate> b(List<String> list) {
        if (list == null) {
            Log.w(f4525a, "base64 CertChain is null.");
        ...
        while (it.hasNext()) {
            ...
            if (a2 == null) {
                Log.e(f4525a, "Failed to get cert from CertChain");
            } else {
                arrayList.add(a2);
            }
        }
    ...
    public static boolean a(X509Certificate x509Certificate, byte[] bArr, byte[] bArr2) {
        if (x509Certificate == null || bArr == null || bArr2 == null) {
            Log.w(f4525a, "checkSignature parameter is null");
            return false;
        }
        try {
            ...
            Log.e(f4525a, "failed checkSignature,Exception:", e2);
            return false;
        }
    }
    ...
    public static X509Certificate a(byte[] bArr) {
        ...
        try {
            ...
            Log.e(f4525a, "Failed to get cert,CertificateException:", e2);
        }
        return null;
    }
