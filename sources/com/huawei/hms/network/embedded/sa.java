...
public final class sa implements HostnameVerifier {

    /* renamed from: a, reason: collision with root package name */
    public static final sa f5480a = new sa();
    ...
    public boolean a(String str, X509Certificate x509Certificate) {
        return f8.e(str) ? c(str, x509Certificate) : b(str, x509Certificate);
    }
    ...
    public boolean a(String str, String str2) {
        if (str != null && str.length() != 0 && !str.startsWith(".") && !str.endsWith("..") && str2 != null && str2.length() != 0 && !str2.startsWith(".") && !str2.endsWith("..")) {
            ...
            if (!lowerCase.startsWith(v6.b.e) || lowerCase.indexOf(42, 1) != -1 || str.length() < lowerCase.length() || v6.b.e.equals(lowerCase)) {
                return false;
            }
