...
final class HuaweiApiAvailabilityImpl extends HuaweiApiAvailability {
    ...
    private static final HuaweiApiAvailabilityImpl f4406a = new HuaweiApiAvailabilityImpl();

    class a implements BusResponseCallback {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ TaskCompletionSource[] f4407a;

        a(TaskCompletionSource[] taskCompletionSourceArr) {
            this.f4407a = taskCompletionSourceArr;
        }
        ...
        public BusResponseResult innerError(Activity activity, int i, String str) {
            ...
            this.f4407a[0].setException(new AvailabilityException());
            return null;
        }
    ...
    public PendingIntent getResolveErrorPendingIntent(Activity activity, int i) {
        ...
        if (resolveErrorIntent != null) {
            return PendingIntent.getActivity(activity, 0, resolveErrorIntent, AppRouterExtras.COLDSTART);
        }
        return null;
    }
    ...
    public PendingIntent getErrPendingIntent(Context context, int i, int i2) {
        ...
        if (resolveErrorIntent != null) {
            return PendingIntent.getActivity(context, i2, resolveErrorIntent, AppRouterExtras.COLDSTART);
        }
        return null;
    }
    ...
    public PendingIntent getResolveErrorPendingIntent(Context context, int i) {
        ...
        Intent resolveErrorIntent = getResolveErrorIntent(context, i);
        if (resolveErrorIntent != null) {
            return PendingIntent.getActivity(context, 0, resolveErrorIntent, AppRouterExtras.COLDSTART);
        }
        return null;
    }
