...
public class HiAnalyticsUtils {
    ...
    class a implements Runnable {
        ...
        public void run() {
            HiAnalyticsUtils.getInstance().onEvent(this.f5987a, this.b, this.c);
        }
    }
    ...
    class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            HiAnalyticsUtils.getInstance().onEvent2(this.f5988a, this.b, this.c);
        }
    }
    ...
    class c implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            HiAnalyticsUtils.getInstance().onNewEvent(this.f5989a, this.b, this.c);
        }
    }
    ...
    class d implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            HiAnalyticsUtils.getInstance().onNewEvent(this.f5990a, this.b, this.c, this.d);
        }
    }
    ...
    class e implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            HiAnalyticsUtils.getInstance().onReport(this.f5991a, this.b, this.c);
        }
    }
    ...
    class f implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            HiAnalyticsUtils.getInstance().onReport(this.f5992a, this.b, this.c, this.d);
        }
    }
    ...
    public int getOobeAnalyticsState(Context context) {
        ...
        bundle.putString(u3.p, "content://com.huawei.hms.contentprovider/com.huawei.hms.privacy.HmsAnalyticsStateProvider");
        try {
            Bundle call = context.getApplicationContext().getContentResolver().call(Uri.parse(r5.i), "getAnalyticsState", (String) null, bundle);
            if (call == null) {
                return a2;
            }
