...
public final class HealthFields {
    ...
    public static final Field FIELD_SPHYGMUS = Field.newDoubleField(BleConstants.BLOODPRESSURE_SPHYGMUS);
    ...
    public static final Field FIELD_TEMPERATURE = Field.newDoubleField(HwExerciseConstants.JSON_NAME_WORKOUT_TEMPERATURE);
    ...
    public static final Field FIELD_AMOUNT = Field.newIntField(HwPayConstant.KEY_AMOUNT);
    ...
    public static final Field FIELD_AVG_HEART_RATE = Field.newDoubleField("avg_heart_rate");
    public static final Field FIELD_MAX_HEART_RATE = Field.newDoubleField("max_heart_rate");
    public static final Field FIELD_MIN_HEART_RATE = Field.newDoubleField("min_heart_rate");
    public static final Field FIELD_RECORD_DAY = Field.newIntField(ParsedFieldTag.RECORD_DAY);
