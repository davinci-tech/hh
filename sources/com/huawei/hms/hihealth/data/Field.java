...
public class Field implements Parcelable {
    ...
    public static final Field FIELD_DISTANCE = newDoubleField("distance");
    ...
    public static final Field FIELD_STEPS = newIntField(MedalConstants.EVENT_STEPS);
    ...
    public static final Field FIELD_LATITUDE = newDoubleField(JsbMapKeyNames.H5_LOC_LAT);
    public static final Field FIELD_LONGITUDE = newDoubleField(JsbMapKeyNames.H5_LOC_LON);
    ...
    public static final Field FIELD_BMI = newDoubleField(BleConstants.BMI);
    ...
    public static final Field FIELD_MOISTURE = newDoubleField(BleConstants.MOISTURE);
    ...
    public static final Field FIELD_IMPEDANCE = newDoubleField(BleConstants.IMPEDANCE);
    ...
    public static final Field FIELD_ROTATION = newIntField(Key.ROTATION);
    public static final Field FIELD_CALORIES = newDoubleField("calories");
    ...
    public static final Field FIELD_MIN = newDoubleField("min");
    ...
    public static final Field SCORE = newIntField(JsUtil.SCORE);
    ...
    public static final Field EVENT_NAME = newIntField("eventName");
    ...
    public static final Field CNS = newIntField(HwExerciseConstants.EXTRA_CNS);
    ...
    public static final Field TEMPERATURE = newDoubleField(HwExerciseConstants.JSON_NAME_WORKOUT_TEMPERATURE);
    ...
    public static final Field GOLF_SWING_COUNT = newIntField(HwExerciseConstants.JSON_NAME_WORKOUT_GOLF_SWING_COUNT);
    public static final Field GOLF_SWING_SPEED = newIntField(HwExerciseConstants.JSON_NAME_WORKOUT_GOLF_SWING_SPEED);
    public static final Field GOLF_MAX_SWING_SPEED = newIntField(HwExerciseConstants.JSON_NAME_WORKOUT_GOLF_MAX_SWING_SPEED);
    public static final Field GOLF_SWING_TEMPO = newDoubleField(HwExerciseConstants.JSON_NAME_WORKOUT_GOLF_SWING_TEMPO);
    public static final Field GOLF_DOWN_SWING_TIME = newIntField(HwExerciseConstants.JSON_NAME_WORKOUT_GOLF_DOWN_SWING_TIME);
    public static final Field GOLF_BACK_SWING_TIME = newIntField(HwExerciseConstants.JSON_NAME_WORKOUT_GOLF_BACK_SWING_TIME);
    ...
    public static final Field SN = newIntField("sn");
    public static final Field TYPE = newIntField("type");
    public static final Field LONGITUDE = newDoubleField(JsbMapKeyNames.H5_LOC_LON);
    public static final Field LATITUDE = newDoubleField(JsbMapKeyNames.H5_LOC_LAT);
    public static final Field COLOR = newIntField("color");
    public static final Field MODE = newIntField(Wpt.MODE);
    ...
    public static String getFieldString(String str, int i) {
        Locale locale = Locale.ENGLISH;
        Object[] objArr = new Object[2];
        objArr[0] = str;
        objArr[1] = i == 1 ? "i" : it.i;
    ...
    public Field(String str, int i) {
        Preconditions.checkArgument(aacs.aabc(str), "Field Name Length Is Illegal!");
        boolean z = true;
    ...
    class aab implements Parcelable.Creator<Field> {
