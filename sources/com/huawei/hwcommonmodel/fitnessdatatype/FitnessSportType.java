...
public class FitnessSportType {
    ...
    public static final int BY_CAR = 14;
    ...
    public static final int SIT_UPS = 16;
    public static final int SKIPPING_ROPE = 15;
    public static final int STILLNESS = 10;
    public static final int TO_ASLEEP = 11;
}
