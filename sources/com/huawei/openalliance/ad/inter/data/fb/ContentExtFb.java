...
public final class ContentExtFb extends Table {
    ...
    public ContentExtFb __assign(int i, ByteBuffer byteBuffer) {
        __init(i, byteBuffer);
        return this;
    }
    ...
    public static int createContentExtFb(FlatBufferBuilder flatBufferBuilder, int i, int i2) {
        flatBufferBuilder.startTable(2);
    ...
    public static final class Vector extends BaseVector {
        public ContentExtFb get(ContentExtFb contentExtFb, int i) {
            return contentExtFb.__assign(ContentExtFb.__indirect(__element(i), this.bb), this.bb);
        }

        public ContentExtFb get(int i) {
            return get(new ContentExtFb(), i);
        }
