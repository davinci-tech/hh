...
public class be extends ba {
    ...
    public void a(Context context, String str, RemoteCallResultCallback<String> remoteCallResultCallback) {
        ho.a("JsbReportPlayEndEvent", "start");
        ...
        if (d != null && adEventReport != null) {
            d.c(adEventReport.e() == null ? 0L : adEventReport.e().longValue(), adEventReport.f() != null ? adEventReport.f().longValue() : 0L, adEventReport.g() == null ? 0 : adEventReport.g().intValue(), adEventReport.h() != null ? adEventReport.h().intValue() : 0);
        }
