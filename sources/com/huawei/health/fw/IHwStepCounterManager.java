...
public interface IHwStepCounterManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwStepCounterManager {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 6:
                    ...
                    return true;
                case 7:
                    boolean insertDiffStep = insertDiffStep((Bundle) b.Xp_(parcel, Bundle.CREATOR));
                    parcel2.writeNoException();
        ...
        static class b implements IHwStepCounterManager {
            private IBinder d;
    ...
    public static class b {
        ...
        public static <T> T Xp_(Parcel parcel, Parcelable.Creator<T> creator) {
            if (parcel.readInt() != 0) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static <T extends Parcelable> void Xq_(Parcel parcel, T t, int i) {
            if (t != null) {
                parcel.writeInt(1);
