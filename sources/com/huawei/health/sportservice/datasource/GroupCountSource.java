...
@SportComponentType(classify = 3, name = ComponentName.GROUP_COUNT_SOURCE)
/* loaded from: classes8.dex */
public class GroupCountSource extends BaseSource<Integer> implements SportLifecycle, IndoorToSource {
    private static final String TAG = "SportService_GroupCountSource";
    private int mGroupCount = 0;

    @Override // com.huawei.health.sportservice.datasource.BaseSource
    protected void updateSourceData() {
        BaseSportManager.getInstance().updateSourceData(TAG, "GROUP_COUNT_DATA", Integer.valueOf(this.mGroupCount));
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.huawei.health.sportservice.datasource.BaseSource
    public void generateData(Integer num) {
        this.mGroupCount = num.intValue();
        updateSourceData();
    }
    ...
    public void onIndoorDataChanged(int i, Object obj) {
        if ((obj instanceof Integer) && i == 40) {
