...
import com.huawei.health.suggestion.ui.fragment.ActivePeakFragment;
...
public class ActivePeakFragment extends PostureSuggestBaseFragment {
    ...
    protected void e() {
        ...
        super.e();
        this.h.setText(getString(R$string.IDS_bolt_average_peak_impact));
        String e = UnitUtil.e(this.o.getValue(), 1, 1);
        if (LanguageUtil.b(this.c)) {
            String quantityString = this.c.getResources().getQuantityString(R.plurals._2130903337_res_0x7f030129, (int) this.o.getValue(), "");
            this.l.setText(e);
            this.g.setText(quantityString);
        } else if (LanguageUtil.bp(this.c)) {
            this.l.setText(R.string._2130845180_res_0x7f021dfc);
            ...
            this.l.setText(e);
            this.g.setText(R.string._2130845180_res_0x7f021dfc);
        }
        this.d.setVisibility(0);
        this.d.setOnClickListener(new View.OnClickListener() { // from class: fsl
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ActivePeakFragment.this.aFM_(view);
            }
        });
    }

    public /* synthetic */ void aFM_(View view) {
        caj.a().a("GROUND_IMPACT_PEAK");
        d(21);
