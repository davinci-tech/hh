...
public final class AppRouter$$Root$$Main implements RouteRoot {
    @Override // com.huawei.haf.router.facade.template.RouteRoot
    public void loadInto(Map<String, Class<? extends RouteGroup>> map) {
        map.put("Main", AppRouter$$Group$$Main.class);
        map.put("ThirdPartySyncData", AppRouter$$Group$$ThirdPartySyncData.class);
    }
}
