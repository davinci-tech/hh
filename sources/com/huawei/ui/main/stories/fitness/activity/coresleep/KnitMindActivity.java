...
public class KnitMindActivity extends KnitHealthDetailActivity {
    ...
    public void configTitleBar(CustomTitleBar customTitleBar) {
        customTitleBar.setTitleText(getString(R$string.IDS_mind_title_text));
