...
public abstract class WeekClassifiedView extends ObserveredClassifiedView {
    ...
    public WeekClassifiedView(Activity activity) {
        super(activity);
        this.mActivity = activity;
    }

    public WeekClassifiedView(Activity activity, AttributeSet attributeSet) {
        super(activity, attributeSet);
        this.mActivity = activity;
    }

    public WeekClassifiedView(Activity activity, AttributeSet attributeSet, int i) {
        super(activity, attributeSet, i);
        this.mActivity = activity;
    }

    public WeekClassifiedView(Activity activity, AttributeSet attributeSet, int i, int i2) {
    ...
    public void onSelected() {
        super.onSelected();
        ClassifiedViewsBIMarker.duw_(this.mActivity, ClassifiedViewsBIMarker.Type.WeekView);
    }
}
