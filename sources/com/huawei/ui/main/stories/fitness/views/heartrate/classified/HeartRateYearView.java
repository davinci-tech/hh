...
public class HeartRateYearView extends ObserveredClassifiedView {
    private Activity d;
    ...
    public HeartRateYearView(Activity activity) {
        super(activity);
        this.d = activity;
    }
    ...
    public void onSelected() {
        super.onSelected();
        ClassifiedViewsBIMarker.duw_(this.d, ClassifiedViewsBIMarker.Type.YearView);
    }
}
