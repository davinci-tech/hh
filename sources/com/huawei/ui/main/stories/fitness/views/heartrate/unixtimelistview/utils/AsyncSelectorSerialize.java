...
public abstract class AsyncSelectorSerialize {
    ...
    public void postError() {
        synchronized (this) {
            ...
            this.mHandler.post(new Runnable() { // from class: com.huawei.ui.main.stories.fitness.views.heartrate.unixtimelistview.utils.AsyncSelectorSerialize.4
    ...
    public void next(final Map map) {
        synchronized (this) {
            ...
            if (!iterator.hasNext()) {
                this.mIsFinished = true;
                this.mHandler.post(new Runnable() { // from class: com.huawei.ui.main.stories.fitness.views.heartrate.unixtimelistview.utils.AsyncSelectorSerialize.3
                    @Override // java.lang.Runnable
                    public void run() {
                ...
                this.mHandler.post(new Runnable() { // from class: com.huawei.ui.main.stories.fitness.views.heartrate.unixtimelistview.utils.AsyncSelectorSerialize.5
                    @Override // java.lang.Runnable
                    public void run() {
                        next.execute(map);
                    }
