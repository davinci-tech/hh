...
public abstract class YearClassifiedView extends ObserveredClassifiedView {
    ...
    public YearClassifiedView(Activity activity, AttributeSet attributeSet) {
        super(activity, attributeSet);
        this.mActivity = activity;
    }

    public YearClassifiedView(Activity activity, AttributeSet attributeSet, int i) {
    ...
    public void onSelected() {
        super.onSelected();
        ClassifiedViewsBIMarker.duw_(this.mActivity, ClassifiedViewsBIMarker.Type.YearView);
    }
}
