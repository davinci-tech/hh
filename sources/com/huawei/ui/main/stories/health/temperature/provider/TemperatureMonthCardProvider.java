...
public class TemperatureMonthCardProvider extends MinorProvider<qpg> {
    private static final String e = "KnitHealthData_CardSelected_" + DataInfos.TemperatureMonthDetail;
    ...
    private HashMap<String, Object> e(Context context) {
        ...
        LogUtil.a("TemperatureMonthCardProvider", "generateDefaultViewMap");
    ...
    public void parseParams(Context context, HashMap<String, Object> hashMap, qpg qpgVar) {
        LogUtil.a("TemperatureMonthCardProvider", "parseParams");
        this.f10245a = context;
        Map<String, SpannableStringBuilder> a2 = qpgVar.a();
        qny qnyVar = new qny();
        if (!a2.isEmpty()) {
            LogUtil.a("TemperatureMonthCardProvider", "putTemperature");
    ...
    private void c(HashMap<String, Object> hashMap, qpg qpgVar) {
        if (this.b) {
    ...
    private void b(Map<String, Object> map) {
        map.put("CLICK_EVENT_LISTENER", new OnClickSectionListener() { // from class: com.huawei.ui.main.stories.health.temperature.provider.TemperatureMonthCardProvider.1
            ...
            public void onClick(String str) {
                if ("TEMPERATURE_SELECT".equals(str)) {
                    LogUtil.a("TemperatureMonthCardProvider", "begin to sendBroadcast");
                    ObserverManagerUtil.c(TemperatureMonthCardProvider.e, "TEMPERATURE_MIN_MAX");
                    return;
                }
                if ("SKIN_TEMPERATURE_SELECT".equals(str)) {
                    ObserverManagerUtil.c(TemperatureMonthCardProvider.e, "SKIN_TEMPERATURE_MIN_MAX");
                    return;
                }
                if ("REMIND_HISTORY_VIEW".equals(str)) {
                    if (nsn.o()) {
                        LogUtil.b("TemperatureMonthCardProvider", "remind histroy text isFastClick");
                        return;
                    }
                    gge.e(AnalyticsValue.TEMPERATURE_REMIND_2060078.value());
                    try {
                        TemperatureMonthCardProvider.this.f10245a.startActivity(new Intent(TemperatureMonthCardProvider.this.f10245a, (Class<?>) TemperatureWarningActivity.class));
                        return;
                    } catch (ActivityNotFoundException e2) {
                        LogUtil.b("TemperatureMonthCardProvider", " jump to TemperatureWarningActivity", e2.getMessage());
                        return;
                    }
                }
                LogUtil.a("TemperatureMonthCardProvider", "useless click");
            }
    ...
    public void onSetSectionBeanData(SectionBean sectionBean, qpg qpgVar) {
        LogUtil.a("TemperatureMonthCardProvider", "onSetSectionBeanData");
        if (qpgVar.a().isEmpty() || this.b) {
    ...
    public String getLogTag() {
        return "TemperatureMonthCardProvider";
    }
}
