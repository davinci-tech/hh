...
@StasticViewType(getDataType = "TOTAL_DIVING_COUNT")
/* loaded from: classes9.dex */
public class DivingTimesShower extends BaseStasticItemShower {
    ...
    public double standardize() {
        ...
        if (!this.mItemDataMap.containsKey("TOTAL_DIVING_COUNT")) {
            LogUtil.h("Track_BaseStasticItemShower", "mItemDataMap is not containsKey TOTAL_DIVING_COUNT");
            return 0.0d;
        }
        return this.mItemDataMap.get("TOTAL_DIVING_COUNT").doubleValue();
    }
    ...
    public String getMainStaticName() {
        return BaseApplication.getContext().getResources().getString(R$string.IDS_diving_total_time);
    }
}
