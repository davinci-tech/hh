...
public class BloodOxygenCardConstructor extends BaseCardConstructor {
    private static final String TAG = "FunctionSet_BloodOxygenCardConstructor";

    public BloodOxygenCardConstructor(CardConfig cardConfig) {
        super(cardConfig);
    }
    ...
    public FunctionSetSubCardData createCardReader(Context context) {
        return new oim(context, this.mCardConfig);
    }
