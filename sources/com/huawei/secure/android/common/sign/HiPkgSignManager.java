...
public class HiPkgSignManager {
    ...
    private static final String f8613a = "HiPkgSignManager";
    ...
    private static PackageInfo a(Context context, String str) {
        try {
            ...
            LogsUtil.e(f8613a, "Exception : " + e.getMessage(), true);
            return null;
        }
    }
    ...
    private static String b(byte[] bArr) {
        try {
            ...
            LogsUtil.e(f8613a, "NoSuchAlgorithmException" + e.getMessage());
            return "";
        }
    }
    ...
    public static byte[] getInstalledAPPSignature(Context context, String str) {
        ...
        if (context == null || TextUtils.isEmpty(str)) {
            LogsUtil.e(f8613a, "packageName is null or context is null");
            return new byte[0];
        }
        try {
            PackageManager packageManager = context.getPackageManager();
            ...
            LogsUtil.e(f8613a, "PackageManager.NameNotFoundException : " + e.getMessage(), true);
        } catch (Exception e2) {
            LogsUtil.e(f8613a, "Exception : " + e2.getMessage(), true);
        }
        return new byte[0];
    }
    ...
    public static String getUnInstalledAPPPackageName(Context context, String str) {
        if (context == null || TextUtils.isEmpty(str)) {
            LogsUtil.e(f8613a, "archiveFilePath is null or context is null");
            return "";
        }
    ...
    public static byte[] getUnInstalledAPPSignature(Context context, String str) {
        ...
        if (a2 != null) {
            ...
            LogsUtil.e(f8613a, "PackageInfo is null ");
        }
        return new byte[0];
    }
