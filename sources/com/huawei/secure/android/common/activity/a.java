...
public class a {
    ...
    private static final Pattern f8561a = Pattern.compile("[0-9]*[a-z|A-Z]*[一-龥]*");
    private static final char b = '*';
    private static final String c = "SecurityComp10300302: ";
    ...
    private static String a(String str) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (f8561a.matcher(String.valueOf(charAt)).matches()) {
                if (i % 2 == 0) {
                    charAt = '*';
                }
                i++;
