...
public class CipherUtil {
    ...
    private static final String f8587a = "CipherUtil";
    ...
    private static Cipher a(byte[] bArr, byte[] bArr2, int i) {
        ...
        b.b(f8587a, "cbc iv param is not right");
        return null;
    }
    ...
    private static Cipher b(byte[] bArr, byte[] bArr2, int i) {
        ...
        b.b(f8587a, "gcm iv param is not right");
        return null;
    }
    ...
    public static Cipher getAesGcmEncryptCipher(byte[] bArr) {
        ...
        b.a(f8587a, "getEncryptCipher: iv is : " + HexUtil.byteArray2HexStr(generateSecureRandom));
    ...
    public static int getContent(Cipher cipher, byte[] bArr, byte[] bArr2) {
        if (cipher == null || bArr == null) {
            b.b(f8587a, "getEncryptCOntent: cipher is null or content is null");
            return -1;
        }
        try {
            return cipher.doFinal(bArr, 0, bArr.length, bArr2);
        } catch (BadPaddingException unused) {
            b.b(f8587a, "getContent: BadPaddingException");
            return -1;
        } catch (IllegalBlockSizeException unused2) {
            b.b(f8587a, "getContent: IllegalBlockSizeException");
            return -1;
        } catch (ShortBufferException unused3) {
            b.b(f8587a, "getContent: ShortBufferException");
            return -1;
        }
    }
    ...
    private static Cipher a(byte[] bArr, byte[] bArr2, int i, String str) {
        ...
        if (bArr != null && bArr.length >= 16 && AesGcm.isBuildVersionHigherThan19()) {
            try {
                ...
                b.b(f8587a, "GCM encrypt data error" + e2.getMessage());
                return null;
            }
        }
        b.b(f8587a, "gcm encrypt param is not right");
        return null;
    }
