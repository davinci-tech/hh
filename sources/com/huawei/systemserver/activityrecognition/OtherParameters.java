...
public class OtherParameters implements Parcelable {
    public static final Parcelable.Creator<OtherParameters> CREATOR = new Parcelable.Creator<OtherParameters>() { // from class: com.huawei.systemserver.activityrecognition.OtherParameters.3
        @Override // android.os.Parcelable.Creator
        /* renamed from: cve_, reason: merged with bridge method [inline-methods] */
