...
public class ContentType {
    ...
    public static final int KAKA_DELAY = 26;
    ...
    public static final int KAKA_SCROLL_TASK = 27;
    public static final int KAKA_TOTAL_NUM = 28;
    public static final int LANGUAGE_RES_URL = 6;
    public static final int LEVEL_HISTORY_RECORD = 25;
    public static final int LEVEL_IMAGE_LABEL = 24;
