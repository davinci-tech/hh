...
public class KakaConstants {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf(TASK_RUN_BEHAVIOR_1KM), 20002);
        hashMap.put(Integer.valueOf(TASK_RUN_BEHAVIOR_3KM), 20002);
        hashMap.put(Integer.valueOf(TASK_RUN_BEHAVIOR), 20002);
        hashMap.put(Integer.valueOf(TASK_FITNESS_BEHAVIOR), 20004);
        hashMap.put(Integer.valueOf(TASK_FITNESS_BEHAVIOR_NEW), 20004);
        Integer valueOf = Integer.valueOf(OnRegisterSkinAttrsListener.REGISTER_BY_SCAN);
        hashMap.put(Integer.valueOf(TASK_MEASURE_TODAY_BLOOD_PRESSURE), valueOf);
        hashMap.put(Integer.valueOf(TASK_MEASURE_TODAY_BLOOD_PRESSURE_NEW), valueOf);
        hashMap.put(Integer.valueOf(TASK_MEASURE_TODAY_BLOOD_SUGAR), 30004);
        hashMap.put(Integer.valueOf(TASK_MEASURE_TODAY_BLOOD_SUGAR_NEW), 30004);
        hashMap.put(Integer.valueOf(TASK_MEASURE_TODAY_WEIGHT), 30005);
