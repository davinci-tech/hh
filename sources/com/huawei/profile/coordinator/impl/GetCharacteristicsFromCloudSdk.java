...
public class GetCharacteristicsFromCloudSdk implements ProfileRequestInterface {
    private static final String TAG = "GetCharacteristicsFromCloud";
    private String baseUrl = CloudSettings.getWiseDeviceUrl() + "/wisedevice/scenario-service/v2/devices/reported?devId=";
    ...
    public void request(Context context, ProfileRequestInputParams profileRequestInputParams, ProfileRequestCallback profileRequestCallback) {
        ...
        try {
            ...
            DsLog.et(TAG, "Failed to get service characteristic from cloud, status code = " + e.getErrorType().getExceptionTypeValue() + " message = " + e.getMessage(), new Object[0]);
