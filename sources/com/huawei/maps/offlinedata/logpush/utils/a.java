...
public class a {
    ...
    private static DynamicModule f6456a = null;
    ...
    public static boolean a(Context context) {
        ...
        try {
            ...
            g.d("DynamicUtil", "Failed to judge phone.");
        }
        g.a("DynamicUtil", "isHuaweiPhone : " + d);
        return d;
    }

    private static boolean d() {
        g.a("DynamicUtil", "the mobile model is " + Build.MODEL);
    ...
    private static boolean e() {
        ...
        g.a("DynamicUtil", "isFlyingSkyDevice extChannel: " + property);
        return !TextUtils.isEmpty(property) && property.startsWith(com.huawei.hms.ads.dynamic.a.t);
    }
    ...
    */
    public static boolean b(android.content.Context r3) {
        /*
            ...
            r1 = 0
            android.content.pm.PackageManager r3 = r3.getPackageManager()     // Catch: java.lang.Exception -> L2a
            java.lang.String r2 = "com.hihonor.software.features.handset"
            boolean r3 = r3.hasSystemFeature(r2)     // Catch: java.lang.Exception -> L2a
            if (r3 != 0) goto L1c
            java.lang.String r3 = "HONOR"
            java.lang.String r2 = android.os.Build.BRAND     // Catch: java.lang.Exception -> L2a
            boolean r3 = android.text.TextUtils.equals(r3, r2)     // Catch: java.lang.Exception -> L2a
            if (r3 == 0) goto L1a
            goto L1c
        L1a:
            r3 = r1
        ...
        L1d:
            if (r3 == 0) goto L28
            boolean r2 = a()     // Catch: java.lang.Exception -> L26
            if (r2 == 0) goto L28
            goto L2f
        L26:
            r1 = r3
        ...
        L2a:
            ...
            com.huawei.maps.offlinedata.utils.g.d(r0, r3)
        L2f:
            ...
            com.huawei.maps.offlinedata.utils.g.a(r0, r3)
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.maps.offlinedata.logpush.utils.a.b(android.content.Context):boolean");
    }
    ...
    public static int b() {
        ...
        b = a(EmuiUtil.BUILDEX_VERSION);
        g.a("DynamicUtil", "emuiVersionCodeValue: " + b);
        if (b == 0) {
            b = c();
        }
        return b;
    ...
    public static int c() {
        b = a("com.hihonor.android.os.Build$VERSION");
        g.a("DynamicUtil", "MagicVersionCodeValue: " + b);
        return b;
    }
    ...
    private static int a(String str) {
        try {
            ...
            g.d("DynamicUtil", "ClassCastException: ");
        } catch (ClassNotFoundException unused2) {
            g.d("DynamicUtil", "ClassNotFoundException: ");
        } catch (IllegalAccessException unused3) {
            g.d("DynamicUtil", "IllegalAccessException: ");
        } catch (NoSuchFieldException unused4) {
            g.d("DynamicUtil", "NoSuchFieldException: ");
        } catch (Exception unused5) {
            g.d("DynamicUtil", IntentFailError.UNKNOWN_EXCEPTION);
        }
        return 0;
    }
}
