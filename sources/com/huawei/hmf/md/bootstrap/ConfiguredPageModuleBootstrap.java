...
import com.huawei.ui.main.stories.configuredpage.impl.ConfiguredPageModule;
...
public final class ConfiguredPageModuleBootstrap {
    public static final void register(Repository repository) {
        ...
        new ModuleProviderWrapper(new ConfiguredPageModule(), 1).bootstrap(repository, name(), builder.build());
    }
