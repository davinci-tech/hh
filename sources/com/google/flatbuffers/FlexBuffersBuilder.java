...
public class FlexBuffersBuilder {
    ...
    private int align(int i) {
        int i2 = 1 << i;
        for (int paddingBytes = Value.paddingBytes(this.bb.writePosition(), i2); paddingBytes != 0; paddingBytes--) {
            this.bb.put((byte) 0);
        }
        return i2;
    }
    ...
    static class Value {
        ...
        public static int elemWidth(int i, int i2, long j, int i3, int i4) {
            ...
            for (int i5 = 1; i5 <= 32; i5 *= 2) {
                int widthUInBits = FlexBuffersBuilder.widthUInBits(((paddingBytes(i3, i5) + i3) + (i4 * i5)) - j);
