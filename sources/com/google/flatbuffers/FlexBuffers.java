...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        StringBuilder toString(StringBuilder sb) {
            ...
            if (i != 36) {
                switch (i) {
                    case 0:
                        sb.append(com.huawei.operation.utils.Constants.NULL);
                        return sb;
                    case 1:
                    case 6:
                        sb.append(asLong());
    ...
    public static class Map extends Vector {
        ...
        private int binarySearch(CharSequence charSequence) {
            ...
            int indirect = FlexBuffers.indirect(this.bb, i2, this.byteWidth);
            int readInt = FlexBuffers.readInt(this.bb, i2 + this.byteWidth, this.byteWidth);
            int i3 = 0;
            while (i3 <= i) {
                int i4 = (i3 + i) >>> 1;
                int compareCharSequence = compareCharSequence(FlexBuffers.indirect(this.bb, (i4 * readInt) + indirect, readInt), charSequence);
        ...
        private int binarySearch(byte[] bArr) {
            ...
            while (i3 <= i) {
                int i4 = (i3 + i) >>> 1;
                int compareBytes = compareBytes(this.bb, FlexBuffers.indirect(this.bb, (i4 * readInt) + indirect, readInt), bArr);
                if (compareBytes < 0) {
                    i3 = i4 + 1;
                } else {
                    if (compareBytes <= 0) {
        ...
        private int compareCharSequence(int i, CharSequence charSequence) {
            ...
            int i2 = 0;
            while (i2 < length) {
                byte charAt = charSequence.charAt(i2);
                if (charAt >= 128) {
                    break;
                }
