...
public final class Service extends Table {
    ...
    public RPCCall calls(RPCCall rPCCall, int i) {
        ...
        if (__offset != 0) {
            return rPCCall.__assign(__indirect(__vector(__offset) + (i * 4)), this.bb);
        }
        return null;
    }
    ...
    public RPCCall callsByKey(String str) {
        int __offset = __offset(6);
        if (__offset != 0) {
            return RPCCall.__lookup_by_key(null, __vector(__offset), str, this.bb);
        }
        return null;
    }
    ...
    public RPCCall callsByKey(RPCCall rPCCall, String str) {
        int __offset = __offset(6);
        if (__offset != 0) {
            return RPCCall.__lookup_by_key(rPCCall, __vector(__offset), str, this.bb);
        }
        return null;
    }
        ...
        while (i2 != 0) {
            ...
            if (compareStrings > 0) {
                ...
                if (compareStrings >= 0) {
                    ...
                    return service.__assign(__indirect, byteBuffer);
                }
                int i5 = i4 + 1;
                i3 += i5;
                i2 -= i5;
    ...
    public static final class Vector extends BaseVector {
        ...
        public Service get(Service service, int i) {
            return service.__assign(Service.__indirect(__element(i), this.bb), this.bb);
        }

        public Service getByKey(String str) {
            return Service.__lookup_by_key(null, __vector(), str, this.bb);
        }

        public Service getByKey(Service service, String str) {
            return Service.__lookup_by_key(service, __vector(), str, this.bb);
        }
    }
}
