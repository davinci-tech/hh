...
public final class Enum extends Table {
    ...
    public EnumVal values(EnumVal enumVal, int i) {
        ...
        if (__offset != 0) {
            return enumVal.__assign(__indirect(__vector(__offset) + (i * 4)), this.bb);
        }
        return null;
    }
    ...
    public EnumVal valuesByKey(long j) {
        int __offset = __offset(6);
        if (__offset != 0) {
            return EnumVal.__lookup_by_key(null, __vector(__offset), j, this.bb);
        }
        return null;
    }
    ...
    public EnumVal valuesByKey(EnumVal enumVal, long j) {
        int __offset = __offset(6);
        if (__offset != 0) {
            return EnumVal.__lookup_by_key(enumVal, __vector(__offset), j, this.bb);
        }
        return null;
    }
        ...
        while (i2 != 0) {
            ...
            if (compareStrings > 0) {
                ...
                if (compareStrings >= 0) {
                    ...
                    return r6.__assign(__indirect, byteBuffer);
                }
                int i5 = i4 + 1;
                i3 += i5;
                i2 -= i5;
    ...
    public static final class Vector extends BaseVector {
        ...
        public Enum get(Enum r2, int i) {
            return r2.__assign(Enum.__indirect(__element(i), this.bb), this.bb);
        }

        public Enum getByKey(String str) {
            return Enum.__lookup_by_key(null, __vector(), str, this.bb);
        }

        public Enum getByKey(Enum r3, String str) {
            return Enum.__lookup_by_key(r3, __vector(), str, this.bb);
        }
    }
}
