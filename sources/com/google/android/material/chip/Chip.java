...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate {
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, com.huawei.health.R.attr._2131099888_res_0x7f0600f0);
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        this.fontCallback = new ResourcesCompat.FontCallback() { // from class: com.google.android.material.chip.Chip.1
            ...
            public void m16xb24343b7(int i2) {
            }
        ...
        ChipDrawable createFromAttributes = ChipDrawable.createFromAttributes(context, attributeSet, i, com.huawei.health.R.style.Widget_MaterialComponents_Chip_Action);
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, WatchFaceProvider.BACKGROUND_LABEL) != null) {
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (Chip.this.hasCloseIcon()) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    accessibilityNodeInfoCompat.setContentDescription(context.getString(com.huawei.health.R.string._2130851400_res_0x7f023648, objArr).trim());
                }
