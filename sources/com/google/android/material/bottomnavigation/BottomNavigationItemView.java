...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(com.huawei.health.R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(com.huawei.health.R.drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(com.huawei.health.R.dimen._2131362388_res_0x7f0a0254);
        this.icon = (ImageView) findViewById(com.huawei.health.R.id.icon);
        TextView textView = (TextView) findViewById(com.huawei.health.R.id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(com.huawei.health.R.id.largeLabel);
