...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.collapsingTitleEnabled = obtainStyledAttributes.getBoolean(14, true);
        ...
        this.scrimVisibleHeightTrigger = obtainStyledAttributes.getDimensionPixelSize(11, -1);
        this.scrimAnimationDuration = obtainStyledAttributes.getInt(10, 600);
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{R.attr._2131100713_res_0x7f060429, R.attr._2131100714_res_0x7f06042a});
