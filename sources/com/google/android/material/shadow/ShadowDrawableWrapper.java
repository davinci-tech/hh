...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = ContextCompat.getColor(context, R.color._2131297054_res_0x7f09031e);
        this.shadowMiddleColor = ContextCompat.getColor(context, R.color._2131297053_res_0x7f09031d);
        this.shadowEndColor = ContextCompat.getColor(context, R.color._2131297052_res_0x7f09031c);
