...
public abstract class CodedInputStream {
            ...
            if (i3 != i2) {
                ...
                if (i3 - i4 >= 9) {
                    ...
                    if (i6 < 0) {
                        ...
                        int i7 = i2 + 3;
                        int i8 = (bArr[i5] << BaseType.Vector) ^ i6;
                        if (i8 >= 0) {
                            i = i8 ^ 16256;
                        } else {
                            int i9 = i2 + 4;
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (i4 != i3) {
                ...
                if (i4 - i5 >= 9) {
                    ...
                    if (i7 >= 0) {
                        i = i3 + 3;
                        int i8 = (bArr[i6] << BaseType.Vector) ^ i7;
                        if (i8 >= 0) {
                            j2 = i8 ^ 16256;
                        } else {
                            int i9 = i3 + 4;
                            int i10 = i8 ^ (bArr[i] << 21);
                            if (i10 < 0) {
                                i2 = (-2080896) ^ i10;
                                i6 = i9;
                            } else {
    ...
    static final class UnsafeDirectNioDecoder extends CodedInputStream {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:33:0x008c, code lost:
            ...
            if (com.google.protobuf.UnsafeUtil.getByte(r7) < 0) goto L34;
         */
        @Override // com.google.protobuf.CodedInputStream
        /*
        ...
        */
        public int readRawVarint32() throws java.io.IOException {
            ...
            L52:
                ...
                if (r3 >= 0) goto L97
                long r7 = r7 + r0
                byte r3 = com.google.protobuf.UnsafeUtil.getByte(r5)
                if (r3 >= 0) goto L94
                r3 = 10
                long r5 = r0 + r3
                byte r0 = com.google.protobuf.UnsafeUtil.getByte(r7)
                if (r0 >= 0) goto L97
            L8e:
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.limit != j4) {
                ...
                if (this.limit - j5 >= 9) {
                    ...
                    if (i2 >= 0) {
                        long j7 = 3 + j4;
                        int i3 = i2 ^ (UnsafeUtil.getByte(j6) << BaseType.Vector);
                        if (i3 >= 0) {
                            j = i3 ^ 16256;
                        } else {
                            j6 = 4 + j4;
                                        ...
                                        if (j9 >= 0) {
                                            ...
                                            if (j11 < 0) {
                                                ...
                                                if (j13 >= 0) {
                                                    j = j13;
                                                    j7 = j12;
                                                } else if (UnsafeUtil.getByte(j12) >= 0) {
                                                    j6 = j4 + 10;
                                                    j = j13;
                                                    this.pos = j6;
                                                    return j;
    ...
    static final class IterableDirectByteBufferDecoder extends CodedInputStream {
            ...
            if (this.currentByteBufferLimit != j) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i2 < 0) {
                        ...
                        long j4 = 3 + j;
                        int i3 = (UnsafeUtil.getByte(j3) << BaseType.Vector) ^ i2;
                        if (i3 >= 0) {
                            i = i3 ^ 16256;
                        } else {
                            long j5 = 4 + j;
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.currentByteBufferLimit != j4) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i2 >= 0) {
                        long j7 = 3 + j4;
                        int i3 = (UnsafeUtil.getByte(j6) << BaseType.Vector) ^ i2;
                        if (i3 >= 0) {
                            j = i3 ^ 16256;
                        } else {
                            long j8 = 4 + j4;
                            ...
                            if (i4 < 0) {
                                ...
                                long j9 = 5 + j4;
                                long j10 = (UnsafeUtil.getByte(j8) << 28) ^ i4;
                                if (j10 < 0) {
                                    long j11 = 6 + j4;
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            if (currentRemaining() >= 8) {
                ...
                long j4 = (UnsafeUtil.getByte(j + 4) & 255) << 32;
                long j5 = (UnsafeUtil.getByte(j + 5) & 255) << 40;
                readRawByte = j5 | j4 | ((UnsafeUtil.getByte(j + 2) & 255) << 16) | (j2 & 255) | ((j3 & 255) << 8) | ((UnsafeUtil.getByte(j + 3) & 255) << 24) | ((UnsafeUtil.getByte(6 + j) & 255) << 48);
