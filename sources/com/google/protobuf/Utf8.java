                    ...
                    if (i6 != length) {
                        try {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                i = i3 + 1;
                                try {
                                    byteBuffer.put(i3, (byte) ((codePoint >>> 18) | GlMapUtil.DEVICE_DISPLAY_DPI_MEDIAN));
                                    int i7 = i3 + 2;
                                    try {
            ...
            while (true) {
                ...
                while (addressOffset < j) {
                    ...
                    if (DecodeUtil.isOneByte(b2)) {
                        ...
                        DecodeUtil.handleThreeBytes(b2, UnsafeUtil.getByte(j2), UnsafeUtil.getByte(2 + addressOffset), cArr, i4);
                        i4++;
                        addressOffset += 3;
                    } else {
                        if (j2 >= j - 2) {
                        ...
                        long j3 = 3 + addressOffset;
                        byte b5 = UnsafeUtil.getByte(2 + addressOffset);
                        addressOffset += 4;
                        DecodeUtil.handleFourBytes(b2, b4, b5, UnsafeUtil.getByte(j3), cArr, i4);
                        i3 = i4 + 2;
                    }
                }
            ...
            while (i4 < length) {
                ...
                if (charAt2 >= 128 || j4 >= j5) {
                    if (charAt2 >= 2048 || j4 > j5 - 2) {
                            ...
                            if (j4 <= j5 - 4) {
                                ...
                                if (i5 != length) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        int codePoint = Character.toCodePoint(charAt2, charAt3);
                                        j2 = 1;
                                        UnsafeUtil.putByte(bArr, j4, (byte) ((codePoint >>> 18) | GlMapUtil.DEVICE_DISPLAY_DPI_MEDIAN));
                                        j3 = j5;
                        ...
                        UnsafeUtil.putByte(bArr, j4 + 2, (byte) ((charAt2 & '?') | 128));
                        j4 += 3;
                    } else {
                        str = str3;
                        str2 = str4;
                        UnsafeUtil.putByte(bArr, j4, (byte) ((charAt2 >>> 6) | 960));
                        UnsafeUtil.putByte(bArr, j4 + j, (byte) ((charAt2 & '?') | 128));
                        j4 += 2;
                    }
                    j3 = j5;
                    j2 = 1;
            ...
            while (i3 < length) {
                ...
                if (charAt2 >= c || position >= limit) {
                    if (charAt2 >= 2048 || position > limit - 2) {
                        ...
                        if ((charAt2 >= 55296 && 57343 >= charAt2) || position > limit - 3) {
                            if (position <= limit - 4) {
                                ...
                                if (i2 != length) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        int codePoint = Character.toCodePoint(charAt2, charAt3);
                                        UnsafeUtil.putByte(position, (byte) ((codePoint >>> 18) | GlMapUtil.DEVICE_DISPLAY_DPI_MEDIAN));
                                        c2 = 128;
                                        UnsafeUtil.putByte(position + 1, (byte) (((codePoint >>> 12) & 63) | 128));
                                        UnsafeUtil.putByte(position + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                        UnsafeUtil.putByte(position + 3, (byte) ((codePoint & 63) | 128));
                                        position += 4;
                                    } else {
                                        i3 = i2;
                                    }
                        ...
                        UnsafeUtil.putByte(position + j, (byte) (((charAt2 >>> 6) & 63) | 128));
                        UnsafeUtil.putByte(position + 2, (byte) ((charAt2 & '?') | 128));
                        position += 3;
                    } else {
                        j2 = addressOffset;
                        UnsafeUtil.putByte(position, (byte) ((charAt2 >>> 6) | 960));
                        UnsafeUtil.putByte(position + j, (byte) ((charAt2 & '?') | 128));
                        position += 2;
                    }
                    i2 = i3;
                    c2 = 128;
