...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i, int i2, List<TypeAdapterFactory> list) {
        ...
        TypeAdapterFactory typeAdapterFactory3;
        boolean z = SqlTypesSupport.SUPPORTS_SQL_TYPES;
        if (str != null && !str.trim().isEmpty()) {
            typeAdapterFactory = DefaultDateTypeAdapter.DateType.DATE.createAdapterFactory(str);
            if (z) {
                typeAdapterFactory2 = SqlTypesSupport.TIMESTAMP_DATE_TYPE.createAdapterFactory(str);
                typeAdapterFactory3 = SqlTypesSupport.DATE_DATE_TYPE.createAdapterFactory(str);
            }
            ...
            if (z) {
                TypeAdapterFactory createAdapterFactory2 = SqlTypesSupport.TIMESTAMP_DATE_TYPE.createAdapterFactory(i, i2);
                TypeAdapterFactory createAdapterFactory3 = SqlTypesSupport.DATE_DATE_TYPE.createAdapterFactory(i, i2);
