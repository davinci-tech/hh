    ...
    public Object read2(JsonReader jsonReader) throws IOException {
        ...
        while (true) {
            if (jsonReader.hasNext()) {
                ...
                Object readTerminal = tryBeginNesting2 == null ? readTerminal(jsonReader, peek2) : tryBeginNesting2;
                if (tryBeginNesting instanceof List) {
                    ((List) tryBeginNesting).add(readTerminal);
                } else {
                    ((Map) tryBeginNesting).put(nextName, readTerminal);
                }
                if (z) {
