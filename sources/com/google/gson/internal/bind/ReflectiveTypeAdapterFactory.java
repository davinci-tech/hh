    ...
    private Map<String, BoundField> getBoundFields(Gson gson, TypeToken<?> typeToken, Class<?> cls, boolean z, boolean z2) {
        ...
        while (cls2 != Object.class) {
            ...
            while (i3 < length) {
                ...
                boolean includeField = reflectiveTypeAdapterFactory.includeField(field, z8);
                ...
                if (includeField || includeField2) {
                    ...
                    while (r1 < size) {
                        ...
                        boolean z9 = r1 != 0 ? false : includeField;
                        int i4 = r1;
                        ...
                        int i7 = length;
                        boolean z10 = z8;
                        boundField = boundField2 == null ? (BoundField) linkedHashMap.put(str, createBoundField(gson, field, method, str, TypeToken.get(resolve), z9, z4, z3)) : boundField2;
                        includeField = z9;
                        i3 = i6;
                        size = i5;
                        fieldNames = list;
