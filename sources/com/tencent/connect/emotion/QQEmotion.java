...
public class QQEmotion extends BaseApi {
    ...
    public void setEmotions(Activity activity, ArrayList<Uri> arrayList, IUiListener iUiListener) {
        ...
        IUiListener iUiListener2 = this.f11305a;
        if (iUiListener2 != null) {
            iUiListener2.onCancel();
        }
        this.f11305a = iUiListener;
        if (!k.b(activity)) {
        ...
        if (!TextUtils.isEmpty(a3)) {
            sb.append(a3);
            stringBuffer.append("&set_uri_list=" + Base64.encodeToString(m.j(a3), 2));
            stringBuffer.append("&ppsts=").append(k.a(activity, sb.toString()));
