...
public class a extends Dialog {
    ...
    public a(Context context, String str, String str2, IUiListener iUiListener, QQToken qQToken) {
        ...
        this.m = false;
        this.q = 0L;
        this.r = OpAnalyticsConstants.H5_LOADING_DELAY;
        this.k = context;
        this.f11268a = str2;
    ...
    class b extends DefaultUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            h.a().a(this.d + "_H5", SystemClock.elapsedRealtime(), 0L, 0L, jSONObject.optInt("ret", -6), this.f11275a, false);
        ...
        public void onError(UiError uiError) {
            ...
            if (uiError.errorMessage != null) {
                str = uiError.errorMessage + this.f11275a;
            } else {
                str = this.f11275a;
            }
    ...
    class C0287a extends WebViewClient {
            ...
            if (str.startsWith("auth://browser")) {
                ...
                if (!a.this.m) {
                    if (c.optString("fail_cb", null) != null) {
                        ...
                        sb.append(a.this.f11268a);
                        sb.append(a.this.f11268a.indexOf("?") > -1 ? "&" : "?");
                        aVar2.f11268a = sb.toString();
                        a.this.f11268a = a.this.f11268a + "browser_error=1";
                        com.tencent.open.c.d dVar = a.this.j;
                        String str2 = a.this.f11268a;
                        dVar.loadUrl(str2);
                        WebViewInstrumentation.loadUrl(dVar, str2);
                    } else {
                        String optString = c.optString("redir", null);
                        if (optString != null) {
                            com.tencent.open.c.d dVar2 = a.this.j;
                            dVar2.loadUrl(optString);
                            WebViewInstrumentation.loadUrl(dVar2, optString);
                        }
                    }
                }
                return true;
        ...
        public void onReceivedError(WebView webView, int i, String str, String str2) {
            ...
            long j = a.this.q;
            if (a.this.n >= 1 || elapsedRealtime - j >= a.this.r) {
                com.tencent.open.c.d dVar = a.this.j;
                String a2 = a.this.a();
                dVar.loadUrl(a2);
                WebViewInstrumentation.loadUrl(dVar, a2);
                return;
            }
            a.m(a.this);
            a.this.d.postDelayed(new Runnable() { // from class: com.tencent.connect.auth.a.a.1
                ...
                public void run() {
                    ...
                    dVar2.loadUrl(str3);
                    WebViewInstrumentation.loadUrl(dVar2, str3);
                }
            }, 500L);
        }
    ...
    class d implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            SLog.v("openSDK_LOG.AuthDialog", "-->timeoutUrl: " + this.f11277a + " | mRetryUrl: " + a.this.o);
            if (this.f11277a.equals(a.this.o)) {
    ...
    private void b() {
        try {
            ...
            String string = m.b(this.f11268a).getString(TemplateStyleRecord.STYLE);
    ...
    private void c() {
        ...
        if (this.i.equals("action_login")) {
            ...
            if (Locale.getDefault().getLanguage().equals(MLAsrConstants.LAN_ZH)) {
    ...
    private void d() {
        ...
        if (dVar instanceof WebView) {
            APMSH5LoadInstrument.setWebViewClient(dVar, c0287a);
        } else {
            dVar.setWebViewClient(c0287a);
        }
        ...
        SLog.v("openSDK_LOG.AuthDialog", "-->mUrl : " + this.f11268a);
        String str = this.f11268a;
        this.o = str;
        com.tencent.open.c.d dVar2 = this.j;
        dVar2.loadUrl(str);
        WebViewInstrumentation.loadUrl(dVar2, str);
    ...
    public boolean e() {
        ...
        Bundle b2 = m.b(this.f11268a);
        b2.putString("token_key", c2);
        b2.putString(k.f.f5336a, a3);
    ...
    public void a(String str, String str2) {
        String str3 = com.huawei.operation.utils.Constants.JAVA_SCRIPT + str + com.huawei.operation.utils.Constants.LEFT_BRACKET_ONLY + str2 + ");void(" + System.currentTimeMillis() + ");";
        com.tencent.open.c.d dVar = this.j;
        dVar.loadUrl(str3);
        WebViewInstrumentation.loadUrl(dVar, str3);
    }
