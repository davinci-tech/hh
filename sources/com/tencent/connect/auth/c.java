...
public class c {
    ...
    private int a(Activity activity, Fragment fragment, String str, IUiListener iUiListener, String str2, boolean z, Map<String, Object> map) {
        ...
        BaseApi.isOEM = false;
        return this.f11280a.doLogin(activity, str, iUiListener, false, fragment, z, map);
    }
    ...
    public int a(Activity activity, String str, IUiListener iUiListener, boolean z, String str2, String str3, String str4) {
        ...
        BaseApi.isOEM = true;
        if (str2.equals("")) {
            str2 = com.huawei.operation.utils.Constants.NULL;
        }
        if (str3.equals("")) {
            str3 = com.huawei.operation.utils.Constants.NULL;
        }
        if (str4.equals("")) {
            str4 = com.huawei.operation.utils.Constants.NULL;
        }
        BaseApi.installChannel = str3;
        BaseApi.registerChannel = str2;
        BaseApi.businessId = str4;
        return this.f11280a.a(activity, str, iUiListener, false, null, z);
    }

    public int b(Activity activity, String str, IUiListener iUiListener) {
        SLog.i("openSDK_LOG.QQAuth", "reAuth()");
        return this.f11280a.a(activity, str, iUiListener, true, null, false);
    }

    public void a() {
        this.f11280a.a((IUiListener) null);
    }

    public void a(IUiListener iUiListener) {
        this.f11280a.b(iUiListener);
    }
    ...
    public boolean c() {
        SLog.i("openSDK_LOG.QQAuth", "isSessionValid(), result = ".concat(this.b.isSessionValid() ? "true" : "false"));
