...
public class d extends com.tencent.open.c implements a.InterfaceC0291a {
    static Toast c;
    private String d;
    ...
    public d(Context context, String str, String str2, IUiListener iUiListener, QQToken qQToken) {
        ...
        this.g = new HandlerC0292d(this.f, context.getMainLooper());
        this.e = iUiListener;
    ...
    private void c() {
        ...
        if (bVar instanceof WebView) {
            APMSH5LoadInstrument.setWebViewClient(bVar, aVar);
        } else {
            bVar.setWebViewClient(aVar);
        }
        ...
        this.f11347a.a(new b(), "sdk_js_if");
        this.i.clearView();
    ...
    class HandlerC0292d extends Handler {
        private c b;

        public HandlerC0292d(c cVar, Looper looper) {
            super(looper);
            this.b = cVar;
        }
    ...
    static class c extends DefaultUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            h.a().a(this.d + "_H5", SystemClock.elapsedRealtime(), 0L, 0L, jSONObject.optInt("ret", -6), this.f11353a, false);
        ...
        public void onError(UiError uiError) {
            ...
            if (uiError.errorMessage != null) {
                str = uiError.errorMessage + this.f11353a;
            } else {
                str = this.f11353a;
            }
            h a2 = h.a();
    ...
    @Override // com.tencent.open.c.a.InterfaceC0291a
    public void a(int i) {
        WeakReference<Context> weakReference = this.j;
        if (weakReference != null && weakReference.get() != null) {
