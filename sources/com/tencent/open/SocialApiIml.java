...
public class SocialApiIml extends BaseApi {
    ...
    public void a(Context context, String str, Bundle bundle, String str2, IUiListener iUiListener) {
        ...
        if (SocialConstants.ACTION_CHALLENGE.equals(str) || SocialConstants.ACTION_BRAG.equals(str)) {
            ...
            new d(this.f11315a, str, str3, iUiListener, this.c).show();
        } else {
            new TDialog(this.f11315a, str, str3, iUiListener, this.c).show();
        }
    }
    ...
    class a extends DefaultUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            socialApiIml.a((Context) socialApiIml.f11315a, this.c, this.e, this.d, this.b);
