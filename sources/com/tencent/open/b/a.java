...
public class a {
    ...
    protected static final Uri f11335a = Uri.parse("content://telephony/carriers/preferapn");
    ...
    public static String c(Context context) {
        try {
            Cursor query = context.getContentResolver().query(f11335a, null, null, null, null);
            if (query == null) {
                return null;
            }
            query.moveToFirst();
