...
public class HttpUtils {
    ...
    public static JSONObject request(QQToken qQToken, Context context, String str, Bundle bundle, String str2) throws IOException, JSONException, NetworkUnavailableException, HttpStatusException {
        ...
        int i4 = a2;
        SLog.v("OpenConfig_test", "config 1:Common_HttpRetryCount            result_value:" + i4 + "   appid:" + qQToken.getAppId() + "     url:" + str4);
        int i5 = 0;
        ...
        while (true) {
            ...
            try {
                try {
                    try {
                        ...
                        if (d != 200) {
                            ...
                            i2 = i;
                            try {
                                com.tencent.open.b.h.a().a(str4, j3, 0L, 0L, d);
                                ...
                                if (i2 < i4) {
                                    ...
                                    if (i2 >= i4) {
                                        ...
                                        j2 = 0;
                                        i = -8;
                                        com.tencent.open.b.h.a().a(str4, j3, j, j2, i);
                                        return jSONObject;
                                    }
                                    i5 = i2;
                                    str3 = str5;
                                } else {
                                    com.tencent.open.b.h.a().a(str4, j3, 0L, 0L, -8);
                                    throw e;
                                }
                            }
                        } else {
                        ...
                        e2.printStackTrace();
                        com.tencent.open.b.h.a().a(str4, j3, 0L, 0L, -4);
                        throw e2;
                    }
                ...
                e4.printStackTrace();
                com.tencent.open.b.h.a().a(str4, j3, 0L, 0L, -3);
                throw e4;
            } catch (IOException e5) {
                e5.printStackTrace();
                com.tencent.open.b.h.a().a(str4, j3, 0L, 0L, getErrorCodeFromException(e5));
                throw e5;
            }
        }
        com.tencent.open.b.h.a().a(str4, j3, j, j2, i);
