...
public class i {
    ...
    private static Map<String, i> f11377a = Collections.synchronizedMap(new HashMap());
    ...
    public static i a(Context context, String str) {
        ...
        synchronized (f11377a) {
            ...
            iVar = f11377a.get(str);
            if (iVar == null) {
                iVar = new i(context, str);
                f11377a.put(str, iVar);
            }
    ...
    private void b() {
        ...
        hashMap.put("sdkp", VideoPlayFlag.PLAY_IN_ALL);
