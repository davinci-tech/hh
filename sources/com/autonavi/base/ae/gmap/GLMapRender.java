...
public class GLMapRender implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        try {
            ...
            this.mDrawFrameTickCount.set(j3);
            if (j3 > 0) {
                max = Math.max(16L, this.mTargetFrameDurationMillis - (currentTimeMillis - j));
            } else if (j3 > -5) {
                max = 60;
            } else if (j3 > -7) {
                max = 100;
                ...
                long j4 = this.mIsTrafficMode ? PreConnectManager.CONNECT_INTERNAL : 500L;
            ...
            iv.c(th, "GLMapRender", "onDrawFrame");
        }
    }
