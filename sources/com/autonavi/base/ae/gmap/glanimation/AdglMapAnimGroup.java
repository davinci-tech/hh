    ...
    public void commitAnimation(Object obj) {
        ...
        if (this.needZoom) {
            ...
            if (this.hasMidZoom) {
                ...
                if (Math.abs(toValue - r2) < 1.0E-6d || Math.abs(fromValue - toValue2) < 1.0E-6d) {
                    this.hasMidZoom = false;
        ...
        if (this.needRotateMap && this.rotateMapParam != null) {
            ...
            if (mapAngle > 180.0f && toValue3 == 0.0f) {
                toValue3 = 360.0f;
            }
            float f = ((int) toValue3) - ((int) mapAngle);
            if (f > 180.0f) {
                toValue3 -= 360.0f;
            } else if (f < -180.0f) {
                toValue3 += 360.0f;
            ...
            this.rotateMapParam.setToValue(toValue3);
