...
public class FPointBounds {
    ...
    public String toString() {
        return "southwest = (" + this.southwest.x + "," + this.southwest.y + ") northeast = (" + this.northeast.x + "," + this.northeast.y + Constants.RIGHT_BRACKET_ONLY;
    }
    ...
    public static final class Builder {
        ...
        private boolean containsx(double d) {
            ...
            float f2 = this.mEast;
            double d2 = f;
            return f <= f2 ? d2 <= d && d <= ((double) f2) : d2 <= d || d <= ((double) f2);
        }
