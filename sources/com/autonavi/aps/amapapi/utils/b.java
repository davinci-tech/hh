...
public final class b {
    ...
    public static String f1647a = "5.3";
    static String l;
    ...
    public static void a(Context context) {
        try {
            ...
            f();
            String a2 = com.autonavi.aps.amapapi.security.a.a(hn.f(context));
            l = a2;
            a(a2);
        } catch (Throwable th) {
    ...
    private static void a(String str) {
        ...
        if (str != null) {
            try {
                ...
                String str3 = (str2 == null || str2.length() <= 0) ? null : new String(com.autonavi.aps.amapapi.security.a.b(b(str2), str), "utf-8");
    ...
    public static hz c() {
        try {
            if (q == null) {
                q = new hz.a("loc", "6.1.0", "AMAP_Location_SDK_Android 6.1.0").a(e()).a("6.1.0").a();
            }
        } catch (Throwable th) {
    ...
    public static void a(Throwable th, String str, String str2) {
        if ("reportError".equals(str2) || (th instanceof hm)) {
            return;
        }
        try {
            iv.c(th, str, str2);
