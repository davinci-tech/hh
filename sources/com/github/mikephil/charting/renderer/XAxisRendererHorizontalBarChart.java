...
public class XAxisRendererHorizontalBarChart extends XAxisRenderer {
    ...
    protected void computeSize() {
        ...
        FSize sizeOfRotatedRectangleByDegrees = Utils.getSizeOfRotatedRectangleByDegrees((int) (r0.width + (this.mXAxis.getXOffset() * 3.5f)), Utils.calcTextSize(this.mAxisLabelPaint, this.mXAxis.getLongestLabel()).height, this.mXAxis.getLabelRotationAngle());
