    ...
    public void drawValues(Canvas canvas) {
        ...
        if (isDrawingValuesAllowed(this.mChart)) {
            ...
            for (int i2 = 0; i2 < dataSets.size(); i2++) {
                ...
                if (iCandleDataSet.getEntryCount() != 0 && shouldDrawValues(iCandleDataSet) && iCandleDataSet.getEntryCount() >= 1) {
                    ...
                    while (i3 < generateTransformedValuesCandle.length) {
                        ...
                        if (this.mViewPortHandler.isInBoundsLeft(f3) && this.mViewPortHandler.isInBoundsY(f4)) {
                            ...
                            if (iCandleDataSet.isDrawValuesEnabled()) {
                                ...
                                i = i3;
                                mPPointF = mPPointF2;
                                drawValue(canvas, iCandleDataSet.getValueFormatter(), candleEntry.getHigh(), candleEntry, i2, f3, f5, iCandleDataSet.getValueTextColor(i4));
                            } else {
                                f = f4;
                                f2 = f3;
                                i = i3;
