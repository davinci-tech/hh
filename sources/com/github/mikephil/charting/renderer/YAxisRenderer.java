...
public class YAxisRenderer extends AxisRenderer {
    ...
    private float calculateAxisLabelsXPosition(YAxis.AxisDependency axisDependency, YAxis.YAxisLabelPosition yAxisLabelPosition) {
        return (axisDependency == YAxis.AxisDependency.LEFT ? this.mViewPortHandler.offsetLeft() : this.mViewPortHandler.contentRight()) + (this.mYAxis.getXOffset() * (yAxisLabelPosition == YAxis.YAxisLabelPosition.OUTSIDE_CHART ? -1 : 1));
    }

    private Paint.Align getAxisLabelTextAlign(YAxis.AxisDependency axisDependency, YAxis.YAxisLabelPosition yAxisLabelPosition) {
        if ((axisDependency == YAxis.AxisDependency.LEFT) ^ (yAxisLabelPosition == YAxis.YAxisLabelPosition.OUTSIDE_CHART)) {
    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            this.mAxisLabelPaint.setTextAlign(getAxisLabelTextAlign(axisDependency, labelPosition));
            drawYLabels(canvas, calculateAxisLabelsXPosition, transformedPositions, (Utils.calcTextHeight(this.mAxisLabelPaint, "A") / 2.5f) + yOffset);
        }
    }
