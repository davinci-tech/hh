...
public class XAxisRenderer extends AxisRenderer {
    ...
    protected void computeSize() {
        ...
        FSize sizeOfRotatedRectangleByDegrees = Utils.getSizeOfRotatedRectangleByDegrees(calcTextSize.width, Utils.calcTextHeight(this.mAxisLabelPaint, "Q"), this.mXAxis.getLabelRotationAngle());
        this.mXAxis.mLabelWidth = Math.round(sizeOfRotatedRectangleByDegrees.width);
        this.mXAxis.mLabelHeight = Math.round(sizeOfRotatedRectangleByDegrees.height);
    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mXAxis.isEnabled() && this.mXAxis.isDrawLabelsEnabled()) {
            ...
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP) {
                ...
                mPPointF.x = 0.5f;
                mPPointF.y = 1.0f;
                drawLabels(canvas, this.mViewPortHandler.contentTop() + yOffset + this.mXAxis.mLabelHeight, mPPointF);
                ...
                mPPointF.x = 0.5f;
                mPPointF.y = 0.0f;
                drawLabels(canvas, (this.mViewPortHandler.contentBottom() - yOffset) - this.mXAxis.mLabelHeight, mPPointF);
            } else {
                mPPointF.x = 0.5f;
                mPPointF.y = 1.0f;
                drawLabels(canvas, this.mViewPortHandler.contentTop() - yOffset, mPPointF);
