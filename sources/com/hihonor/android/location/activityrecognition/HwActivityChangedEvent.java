...
public class HwActivityChangedEvent implements Parcelable {
    public static final Parcelable.Creator<HwActivityChangedEvent> CREATOR = new Parcelable.Creator<HwActivityChangedEvent>() { // from class: com.hihonor.android.location.activityrecognition.HwActivityChangedEvent.3
        @Override // android.os.Parcelable.Creator
        /* renamed from: cL_, reason: merged with bridge method [inline-methods] */
    ...
    public static boolean checkActivityReportLen(int i) {
        ...
        ul.c(TAG, "report activity invalid.");
        return false;
    }
}
