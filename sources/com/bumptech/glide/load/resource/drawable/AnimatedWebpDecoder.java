...
public final class AnimatedWebpDecoder {
    ...
    static final class AnimatedImageDrawableResource implements Resource<Drawable> {
    ...
    static final class StreamAnimatedWebpDecoder implements ResourceDecoder<InputStream, Drawable> {
    ...
    static final class ByteBufferAnimatedWebpDecoder implements ResourceDecoder<ByteBuffer, Drawable> {
        private final AnimatedWebpDecoder delegate;
