...
public final class Path {
    ...
    public static final okio.Path commonParent(okio.Path path) {
        uhy.e((Object) path, "");
        if (uhy.e(path.getBytes(), DOT) || uhy.e(path.getBytes(), SLASH) || uhy.e(path.getBytes(), BACKSLASH) || lastSegmentIsDotDot(path)) {
            return null;
        }
        int indexOfLastSlash = getIndexOfLastSlash(path);
    ...
    public static final okio.Path commonRelativeTo(okio.Path path, okio.Path path2) {
        uhy.e((Object) path, "");
        uhy.e((Object) path2, "");
        if (!uhy.e(path.getRoot(), path2.getRoot())) {
    ...
    public static final boolean commonEquals(okio.Path path, Object obj) {
        uhy.e((Object) path, "");
        return (obj instanceof okio.Path) && uhy.e(((okio.Path) obj).getBytes(), path.getBytes());
    }
    ...
    public static final okio.Path toPath(Buffer buffer, boolean z) {
        ...
        boolean z2 = i >= 2 && uhy.e(byteString2, byteString);
        if (z2) {
            uhy.d(byteString2);
        ...
        while (!buffer.exhausted()) {
            ...
            if (uhy.e(readByteString, byteString3)) {
                if (!z3 || !arrayList.isEmpty()) {
                    if (!z || (!z3 && (arrayList.isEmpty() || uhy.e(ufe.g((List) arrayList), byteString3)))) {
                        arrayList.add(readByteString);
                    } else if (!z2 || arrayList.size() != 1) {
                        ufe.b((List) arrayList);
                    }
                }
            } else if (!uhy.e(readByteString, DOT) && !uhy.e(readByteString, ByteString.EMPTY)) {
                arrayList.add(readByteString);
            }
        }
    ...
    private static final boolean startsWithVolumeLetterAndColon(Buffer buffer, ByteString byteString) {
        if (!uhy.e(byteString, BACKSLASH) || buffer.size() < 2 || buffer.getByte(1L) != 58) {
            return false;
        }
