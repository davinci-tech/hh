...
public final class RealBufferedSource implements BufferedSource {
    ...
    public String readUtf8LineStrict(long limit) {
        ...
        long j = limit == LocationRequestCompat.PASSIVE_INTERVAL ? Long.MAX_VALUE : limit + 1;
        long indexOf = indexOf((byte) 10, 0L, j);
        if (indexOf != -1) {
            return okio.internal.Buffer.readUtf8Line(this.bufferField, indexOf);
        }
        if (j < LocationRequestCompat.PASSIVE_INTERVAL && request(j) && this.bufferField.getByte(j - 1) == 13 && request(1 + j) && this.bufferField.getByte(j) == 10) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x002c, code lost:
        ...
        r1 = java.lang.Integer.toString(r8, defpackage.ujm.e(defpackage.ujm.e(16)));
        defpackage.uhy.a(r1, "");
        r0.append(r1);
     */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0034, code lost:
        ...
        r1 = java.lang.Integer.toString(r2, defpackage.ujm.e(defpackage.ujm.e(16)));
        defpackage.uhy.a(r1, "");
        r0.append(r1);
     */
    ...
    */
    ...
    public String toString() {
        return "buffer(" + this.source + g4.l;
    }
}
