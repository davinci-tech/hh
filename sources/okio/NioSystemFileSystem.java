...
public class NioSystemFileSystem extends JvmSystemFileSystem {
    ...
    protected final FileMetadata metadataOrNull(java.nio.file.Path nioPath) {
        ...
        try {
            ...
            return new FileMetadata(isRegularFile, isDirectory, path, Long.valueOf(size), zeroToNull, zeroToNull2, lastAccessTime != null ? zeroToNull(lastAccessTime) : null, null, 128, null);
