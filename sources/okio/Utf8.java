...
public final class Utf8 {
    ...
    public static final void processUtf8Bytes(String str, int i, int i2, Function1<? super Byte, ueu> function1) {
        int i3;
        char charAt;
        uhy.e((Object) str, "");
        ...
        while (i < i2) {
            ...
            if (uhy.c(charAt2, 128) < 0) {
                ...
                if (uhy.c(charAt2, 2048) < 0) {
                    ...
                    function1.invoke(Byte.valueOf((byte) ((charAt2 & '?') | 128)));
                } else if (uhy.c(charAt2, 56319) > 0 || i2 <= (i3 = i + 1) || 56320 > (charAt = str.charAt(i3)) || charAt >= 57344) {
                    function1.invoke(Byte.valueOf(REPLACEMENT_BYTE));
                } else {
                    int charAt3 = ((charAt2 << '\n') + str.charAt(i3)) - 56613888;
                    function1.invoke(Byte.valueOf((byte) ((charAt3 >> 18) | GlMapUtil.DEVICE_DISPLAY_DPI_MEDIAN)));
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x00eb, code lost:
        ...
        if ((r9[r0] & 192) == 128) goto L78;
     */
    /* JADX WARN: Code restructure failed: missing block: B:56:0x007d, code lost:
    
        if ((r9[r0] & 192) == 128) goto L80;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void processUtf8CodePoints(byte[] r9, int r10, int r11, kotlin.jvm.functions.Function1<? super java.lang.Integer, defpackage.ueu> r12) {
        /*
    ...
    /* JADX WARN: Code restructure failed: missing block: B:57:0x007f, code lost:
        ...
        if ((r9[r0] & 192) == 128) goto L82;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void processUtf16Chars(byte[] r9, int r10, int r11, kotlin.jvm.functions.Function1<? super java.lang.Character, defpackage.ueu> r12) {
        /*
    ...
    public static final int process2Utf8Bytes(byte[] bArr, int i, int i2, Function1<? super Integer, ueu> function1) {
        uhy.e((Object) bArr, "");
        uhy.e((Object) function1, "");
        int i3 = i + 1;
        if (i2 <= i3) {
    ...
    public static final int process3Utf8Bytes(byte[] bArr, int i, int i2, Function1<? super Integer, ueu> function1) {
        uhy.e((Object) bArr, "");
        uhy.e((Object) function1, "");
        int i3 = i + 2;
        if (i2 <= i3) {
        ...
        int i5 = ((b3 ^ (-123008)) ^ (b2 << 6)) ^ (b << BaseType.Double);
        if (i5 < 2048) {
            function1.invoke(65533);
            return 3;
        }
    ...
    public static final int process4Utf8Bytes(byte[] bArr, int i, int i2, Function1<? super Integer, ueu> function1) {
        uhy.e((Object) bArr, "");
        uhy.e((Object) function1, "");
        int i3 = i + 3;
        if (i2 <= i3) {
        ...
        int i6 = (((b4 ^ 3678080) ^ (b3 << 6)) ^ (b2 << BaseType.Double)) ^ (b << BaseType.Vector64);
        if (i6 > 1114111) {
            function1.invoke(65533);
            return 4;
        }
