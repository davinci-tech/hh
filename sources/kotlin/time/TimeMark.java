...
public interface TimeMark {
    ...
    TimeMark mo973minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo975plusLRDsOJo(long duration);

    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    /* loaded from: classes10.dex */
    public static final class e {
        public static boolean d(TimeMark timeMark) {
            return !ukf.o(timeMark.mo972elapsedNowUwyO8pc());
        }

        public static boolean e(TimeMark timeMark) {
            return ukf.o(timeMark.mo972elapsedNowUwyO8pc());
        }
    }
}
