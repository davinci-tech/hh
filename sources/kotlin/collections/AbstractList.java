...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E>, KMappedMarker {
    ...
    public int lastIndexOf(E element) {
        ...
        while (listIterator.hasPrevious()) {
            if (uhy.e(listIterator.previous(), element)) {
    ...
    static final class b<E> extends AbstractList<E> implements RandomAccess {
        private int b;
        private final int d;
        private final AbstractList<E> e;

        /* JADX WARN: Multi-variable type inference failed */
        public b(AbstractList<? extends E> abstractList, int i, int i2) {
            uhy.e((Object) abstractList, "");
            this.e = abstractList;
            this.d = i;
            AbstractList.INSTANCE.c(i, i2, abstractList.size());
            this.b = i2 - i;
        }

        @Override // kotlin.collections.AbstractList, java.util.List
        public E get(int index) {
            AbstractList.INSTANCE.e(index, this.b);
            return this.e.get(this.d + index);
        }
    ...
    class a implements Iterator<E>, KMappedMarker {
        private int c;
    ...
    class d extends a implements ListIterator, KMappedMarker {
        public d(int i) {
            super();
            AbstractList.INSTANCE.b(i, AbstractList.this.size());
            b(i);
        }
    ...
    /* renamed from: kotlin.collections.AbstractList$e, reason: from kotlin metadata */
