...
import defpackage.COROUTINES_DEBUG_METADATA_VERSION;
...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            probeCoroutineCreated.d(continuation);
            ...
            try {
                ...
                uel.b bVar = uel.d;
                result = uel.b(createFailure.b(th));
            }
            if (invokeSuspend == ugw.a()) {
                return;
            }
            uel.b bVar2 = uel.d;
            result = uel.b(invokeSuspend);
    ...
    public Continuation<ueu> create(Continuation<?> completion) {
        uhy.e((Object) completion, "");
        throw new UnsupportedOperationException("create(Continuation) has not been overridden");
    }

    public Continuation<ueu> create(Object value, Continuation<?> completion) {
        uhy.e((Object) completion, "");
    ...
    public StackTraceElement getStackTraceElement() {
        return COROUTINES_DEBUG_METADATA_VERSION.c(this);
    }
}
