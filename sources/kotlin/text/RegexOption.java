...
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\r\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u00012\u00020\u0002B\u0019\b\u0002\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0004¢\u0006\u0002\u0010\u0006R\u0014\u0010\u0005\u001a\u00020\u0004X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0014\u0010\u0003\u001a\u00020\u0004X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\bj\u0002\b\nj\u0002\b\u000bj\u0002\b\fj\u0002\b\rj\u0002\b\u000ej\u0002\b\u000fj\u0002\b\u0010¨\u0006\u0011"}, d2 = {"Lkotlin/text/RegexOption;", "", "Lkotlin/text/FlagEnum;", "value", "", Constant.MASK, "(Ljava/lang/String;III)V", "getMask", "()I", "getValue", "IGNORE_CASE", "MULTILINE", "LITERAL", "UNIX_LINES", "COMMENTS", "DOT_MATCHES_ALL", "CANON_EQ", "kotlin-stdlib"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
public final class RegexOption implements FlagEnum {
    ...
    /* synthetic */ RegexOption(String str, int i, int i2, int i3, int i4, uib uibVar) {
    ...
    static {
        ...
        int i3 = 2;
        uib uibVar = null;
        MULTILINE = new RegexOption("MULTILINE", 1, 8, i2, i3, uibVar);
        int i4 = 0;
        int i5 = 2;
        uib uibVar2 = null;
        LITERAL = new RegexOption("LITERAL", i, 16, i4, i5, uibVar2);
        UNIX_LINES = new RegexOption("UNIX_LINES", 3, 1, i2, i3, uibVar);
        COMMENTS = new RegexOption("COMMENTS", 4, 4, i4, i5, uibVar2);
        DOT_MATCHES_ALL = new RegexOption("DOT_MATCHES_ALL", 5, 32, i2, i3, uibVar);
        CANON_EQ = new RegexOption("CANON_EQ", 6, 128, i4, i5, uibVar2);
