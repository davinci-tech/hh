...
public final class MediaType {
    ...
    public final String parameter(String name) {
        uhy.e((Object) name, "");
        int i = 0;
        int c = differenceModulo.c(0, this.parameterNamesAndValues.length - 1, 2);
        if (c < 0) {
            return null;
        }
        while (!ujy.c(this.parameterNamesAndValues[i], name, true)) {
            if (i == c) {
                return null;
            }
            i += 2;
    ...
    public boolean equals(Object other) {
        return (other instanceof MediaType) && uhy.e((Object) ((MediaType) other).mediaType, (Object) this.mediaType);
    }
    ...
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0015\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\u0007H\u0007¢\u0006\u0002\b\rJ\u0017\u0010\u000e\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\f\u001a\u00020\u0007H\u0007¢\u0006\u0002\b\u000fJ\u0011\u0010\u0010\u001a\u00020\u000b*\u00020\u0007H\u0007¢\u0006\u0002\b\nJ\u0013\u0010\u0011\u001a\u0004\u0018\u00010\u000b*\u00020\u0007H\u0007¢\u0006\u0002\b\u000eR\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0007X\u0082T¢\u0006\u0002\n\u0000R\u0016\u0010\t\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0012"}, d2 = {"Lokhttp3/MediaType$Companion;", "", "()V", "PARAMETER", "Ljava/util/regex/Pattern;", "kotlin.jvm.PlatformType", "QUOTED", "", "TOKEN", "TYPE_SUBTYPE", "get", "Lokhttp3/MediaType;", "mediaType", "-deprecated_get", "parse", "-deprecated_parse", "toMediaType", "toMediaTypeOrNull", y.b.j}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Companion {
        ...
        public final MediaType get(String str) {
            ...
            while (end < str.length()) {
                ...
                if (group3 == null) {
                    ...
                    } else if (ujy.c(group4, "'", false, 2, (Object) null) && ujy.b(group4, "'", false, 2, (Object) null) && group4.length() > 2) {
        ...
        public final MediaType m1056deprecated_get(String mediaType) {
        ...
        public final MediaType m1057deprecated_parse(String mediaType) {
            uhy.e((Object) mediaType, "");
    ...
    public /* synthetic */ MediaType(String str, String str2, String str3, String[] strArr, uib uibVar) {
