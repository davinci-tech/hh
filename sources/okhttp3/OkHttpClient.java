...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
            ...
            while (it.hasNext()) {
                if (((ConnectionSpec) it.next()).getIsTls()) {
                    if (builder.getSslSocketFactoryOrNull() != null) {
                        ...
                        uhy.d(certificateChainCleaner2);
    ...
    private final void verifyClientState() {
        uhy.b(this.interceptors, "");
        if (!(!r0.contains(null))) {
            throw new IllegalStateException(("Null interceptor: " + this.interceptors).toString());
        }
        uhy.b(this.networkInterceptors, "");
        if (!(!r0.contains(null))) {
        ...
        if (!uhy.e(this.certificatePinner, CertificatePinner.DEFAULT)) {
            throw new IllegalStateException("Check failed.".toString());
        }
    }
    ...
    public final List<Interceptor> m1078deprecated_interceptors() {
        return this.interceptors;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "networkInterceptors", imports = {}))
    /* renamed from: -deprecated_networkInterceptors, reason: not valid java name */
    public final List<Interceptor> m1079deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final SSLSocketFactory m1088deprecated_sslSocketFactory() {
        return sslSocketFactory();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m1070deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "protocols", imports = {}))
    /* renamed from: -deprecated_protocols, reason: not valid java name */
    public final List<Protocol> m1081deprecated_protocols() {
        return this.protocols;
    }
    ...
    public static final class Builder {
        ...
        public final void setCertificatePinner$okhttp(CertificatePinner certificatePinner) {
            uhy.e((Object) certificatePinner, "");
        ...
        public Builder(OkHttpClient okHttpClient) {
            ...
            ufe.d(this.interceptors, okHttpClient.interceptors());
            ufe.d(this.networkInterceptors, okHttpClient.networkInterceptors());
        ...
        public final Builder addInterceptor(Interceptor interceptor) {
            uhy.e((Object) interceptor, "");
            this.interceptors.add(interceptor);
            return this;
        }

        /* renamed from: -addInterceptor, reason: not valid java name */
        public final Builder m1090addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            uhy.e((Object) block, "");
        ...
        public final Builder m1091addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            uhy.e((Object) block, "");
        ...
        public final Builder eventListenerFactory(EventListener.Factory eventListenerFactory) {
            uhy.e((Object) eventListenerFactory, "");
        ...
        public final Builder proxySelector(ProxySelector proxySelector) {
            uhy.e((Object) proxySelector, "");
            if (!uhy.e(proxySelector, this.proxySelector)) {
                this.routeDatabase = null;
            }
            this.proxySelector = proxySelector;
            return this;
        ...
        public final Builder proxyAuthenticator(Authenticator proxyAuthenticator) {
            uhy.e((Object) proxyAuthenticator, "");
            if (!uhy.e(proxyAuthenticator, this.proxyAuthenticator)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder socketFactory(SocketFactory socketFactory) {
            ...
            if (!uhy.e(socketFactory, this.socketFactory)) {
                this.routeDatabase = null;
            }
            this.socketFactory = socketFactory;
            return this;
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory) {
            ...
            if (!uhy.e(sslSocketFactory, this.sslSocketFactoryOrNull)) {
                this.routeDatabase = null;
            }
            this.sslSocketFactoryOrNull = sslSocketFactory;
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory, X509TrustManager trustManager) {
            uhy.e((Object) sslSocketFactory, "");
            uhy.e((Object) trustManager, "");
            if (!uhy.e(sslSocketFactory, this.sslSocketFactoryOrNull) || !uhy.e(trustManager, this.x509TrustManagerOrNull)) {
                this.routeDatabase = null;
            }
            this.sslSocketFactoryOrNull = sslSocketFactory;
        ...
        public final Builder connectionSpecs(List<ConnectionSpec> connectionSpecs) {
            uhy.e((Object) connectionSpecs, "");
            if (!uhy.e(connectionSpecs, this.connectionSpecs)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder protocols(List<? extends Protocol> protocols) {
            ...
            List d = ufe.d((Collection) protocols);
            if (!d.contains(Protocol.H2_PRIOR_KNOWLEDGE) && !d.contains(Protocol.HTTP_1_1)) {
                throw new IllegalArgumentException(("protocols must contain h2_prior_knowledge or http/1.1: " + d).toString());
            }
            if (d.contains(Protocol.H2_PRIOR_KNOWLEDGE) && d.size() > 1) {
            ...
            uhy.b(d, "");
            if (!(true ^ d.contains(null))) {
                throw new IllegalArgumentException("protocols must not contain null".toString());
            }
            d.remove(Protocol.SPDY_3);
            if (!uhy.e(d, this.protocols)) {
                this.routeDatabase = null;
            }
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
            uhy.e((Object) hostnameVerifier, "");
            if (!uhy.e(hostnameVerifier, this.hostnameVerifier)) {
                this.routeDatabase = null;
            }
            this.hostnameVerifier = hostnameVerifier;
            return this;
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner) {
            uhy.e((Object) certificatePinner, "");
            if (!uhy.e(certificatePinner, this.certificatePinner)) {
                this.routeDatabase = null;
            }
            this.certificatePinner = certificatePinner;
            return this;
    ...
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001a\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u0007¨\u0006\u000b"}, d2 = {"Lokhttp3/OkHttpClient$Companion;", "", "()V", "DEFAULT_CONNECTION_SPECS", "", "Lokhttp3/ConnectionSpec;", "getDEFAULT_CONNECTION_SPECS$okhttp", "()Ljava/util/List;", "DEFAULT_PROTOCOLS", "Lokhttp3/Protocol;", "getDEFAULT_PROTOCOLS$okhttp", y.b.j}, k = 1, mv = {1, 8, 0}, xi = 48)
