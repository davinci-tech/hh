...
public final class Route {
    ...
    public boolean equals(Object other) {
        if (other instanceof Route) {
            ...
            if (uhy.e(route.address, this.address) && uhy.e(route.proxy, this.proxy) && uhy.e(route.socketAddress, this.socketAddress)) {
                return true;
            }
        }
        return false;
