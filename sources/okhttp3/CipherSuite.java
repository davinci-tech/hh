...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\u0018\u0000 \b2\u00020\u0001:\u0001\bB\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\r\u0010\u0002\u001a\u00020\u0003H\u0007¢\u0006\u0002\b\u0006J\b\u0010\u0007\u001a\u00020\u0003H\u0016R\u0013\u0010\u0002\u001a\u00020\u00038\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0002\u0010\u0005¨\u0006\t"}, d2 = {"Lokhttp3/CipherSuite;", "", "javaName", "", "(Ljava/lang/String;)V", "()Ljava/lang/String;", "-deprecated_javaName", "toString", "Companion", y.b.j}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final CipherSuite forJavaName(String javaName) {
            CipherSuite cipherSuite;
            synchronized (this) {
                uhy.e((Object) javaName, "");
        ...
        private final String secondaryName(String javaName) {
            if (ujy.c(javaName, "TLS_", false, 2, (Object) null)) {
            ...
            if (!ujy.c(javaName, "SSL_", false, 2, (Object) null)) {
                return javaName;
            }
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String a2, String b) {
                ...
                for (int i = 4; i < min; i++) {
                    ...
                    if (charAt != charAt2) {
                        return uhy.c(charAt, charAt2) < 0 ? -1 : 1;
                    }
                }
        ...
        TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", UserInfomation.WEIGHT_DEFAULT_ENGLISH);
        ...
        TLS_PSK_WITH_RC4_128_SHA = companion.init("TLS_PSK_WITH_RC4_128_SHA", OldToNewMotionPath.SPORT_TYPE_PILATES);
        TLS_PSK_WITH_3DES_EDE_CBC_SHA = companion.init("TLS_PSK_WITH_3DES_EDE_CBC_SHA", OldToNewMotionPath.SPORT_TYPE_AEROBICS);
        ...
        TLS_DHE_DSS_WITH_AES_128_GCM_SHA256 = companion.init("TLS_DHE_DSS_WITH_AES_128_GCM_SHA256", MachineControlPointResponse.OP_CODE_EXTENSION_SET_DYNAMIC_ENERGY);
        TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 = companion.init("TLS_DHE_DSS_WITH_AES_256_GCM_SHA384", MachineControlPointResponse.OP_CODE_EXTENSION_SET_STEP_COUNT);
        TLS_DH_anon_WITH_AES_128_GCM_SHA256 = companion.init("TLS_DH_anon_WITH_AES_128_GCM_SHA256", MachineControlPointResponse.OP_CODE_EXTENSION_SET_SUPPRESS_AUTO_PAUSE);
        TLS_DH_anon_WITH_AES_256_GCM_SHA384 = companion.init("TLS_DH_anon_WITH_AES_256_GCM_SHA384", MachineControlPointResponse.OP_CODE_EXTENSION_SET_TARGETED_EXPENDED_ENERGY);
    ...
    public /* synthetic */ CipherSuite(String str, uib uibVar) {
        this(str);
    }
}
