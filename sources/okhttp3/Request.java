...
public final class Request {
    ...
    public final CacheControl m1093deprecated_cacheControl() {
        return cacheControl();
    }
    ...
    public String toString() {
        ...
        if (this.headers.size() != 0) {
            sb.append(", headers=[");
            int i = 0;
            for (ueo<? extends String, ? extends String> ueoVar : this.headers) {
                if (i < 0) {
                    ufe.e();
                }
                ueo<? extends String, ? extends String> ueoVar2 = ueoVar;
                String b = ueoVar2.b();
                String d = ueoVar2.d();
                if (i > 0) {
                    sb.append(", ");
    ...
    public static class Builder {
        ...
        public Builder(Request request) {
            ...
            if (request.getTags$okhttp().isEmpty()) {
                ...
                b = ufs.b(request.getTags$okhttp());
            }
            this.tags = b;
        ...
        public Builder url(String url) {
            uhy.e((Object) url, "");
            if (ujy.b(url, "ws:", true)) {
                StringBuilder sb = new StringBuilder("http:");
                String substring = url.substring(3);
                uhy.a(substring, "");
                sb.append(substring);
                url = sb.toString();
            } else if (ujy.b(url, "wss:", true)) {
        ...
        public Builder delete(RequestBody body) {
            return method(ProfileRequestConstants.DELETE_TYPE, body);
        }

        public Builder put(RequestBody body) {
            uhy.e((Object) body, "");
            return method(ProfileRequestConstants.PUT_TYPE, body);
        }
