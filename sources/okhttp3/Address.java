...
public final class Address {
    ...
    public Address(String str, int i, Dns dns, SocketFactory socketFactory, SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier, CertificatePinner certificatePinner, Authenticator authenticator, Proxy proxy, List<? extends Protocol> list, List<ConnectionSpec> list2, ProxySelector proxySelector) {
        ...
        this.url = new HttpUrl.Builder().scheme(sSLSocketFactory != null ? ProxyConfig.MATCH_HTTPS : "http").host(str).port(i).build();
    ...
    public final List<Protocol> m984deprecated_protocols() {
        return this.protocols;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m981deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof Address) {
            ...
            if (uhy.e(this.url, address.url) && equalsNonHost$okhttp(address)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean equalsNonHost$okhttp(Address that) {
        uhy.e((Object) that, "");
        return uhy.e(this.dns, that.dns) && uhy.e(this.proxyAuthenticator, that.proxyAuthenticator) && uhy.e(this.protocols, that.protocols) && uhy.e(this.connectionSpecs, that.connectionSpecs) && uhy.e(this.proxySelector, that.proxySelector) && uhy.e(this.proxy, that.proxy) && uhy.e(this.sslSocketFactory, that.sslSocketFactory) && uhy.e(this.hostnameVerifier, that.hostnameVerifier) && uhy.e(this.certificatePinner, that.certificatePinner) && this.url.port() == that.url.port();
    }
