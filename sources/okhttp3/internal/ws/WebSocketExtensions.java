...
public final /* data */ class WebSocketExtensions {
    ...
    public /* synthetic */ WebSocketExtensions(boolean z, Integer num, boolean z2, Integer num2, boolean z3, boolean z4, int i, uib uibVar) {
    ...
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lokhttp3/internal/ws/WebSocketExtensions$Companion;", "", "()V", "HEADER_WEB_SOCKET_EXTENSION", "", "parse", "Lokhttp3/internal/ws/WebSocketExtensions;", "responseHeaders", "Lokhttp3/Headers;", y.b.j}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(Headers responseHeaders) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                if (ujy.c(responseHeaders.name(i), "Sec-WebSocket-Extensions", true)) {
                    ...
                    while (i2 < value.length()) {
                        ...
                        if (ujy.c(trimSubstring, ua.M, true)) {
                            i2 = i3;
                            if (z) {
                                z4 = true;
                            }
                            while (i2 < delimiterOffset$default) {
                                ...
                                String a2 = delimiterOffset3 < delimiterOffset2 ? ujy.a(Util.trimSubstring(value, delimiterOffset3 + 1, delimiterOffset2), "\"") : null;
                                i2 = delimiterOffset2 + 1;
                                if (ujy.c(trimSubstring2, "client_max_window_bits", true)) {
                                    if (num != null) {
                                        z4 = true;
                                    }
                                    num = a2 != null ? ujy.c(a2) : null;
                                    if (num == null) {
                                        z4 = true;
                                    }
                                } else if (ujy.c(trimSubstring2, ua.N, true)) {
                                    if (z2) {
                                        z4 = true;
                                    }
                                    if (a2 != null) {
                                    ...
                                    z2 = true;
                                } else if (ujy.c(trimSubstring2, "server_max_window_bits", true)) {
                                    if (num2 != null) {
                                        z4 = true;
                                    }
                                    num2 = a2 != null ? ujy.c(a2) : null;
                                    if (num2 == null) {
                                        z4 = true;
                                    }
                                } else if (ujy.c(trimSubstring2, ua.O, true)) {
                                    if (z3) {
                                        z4 = true;
                                    }
                                    if (a2 != null) {
    ...
    public boolean equals(Object other) {
        ...
        return this.perMessageDeflate == webSocketExtensions.perMessageDeflate && uhy.e(this.clientMaxWindowBits, webSocketExtensions.clientMaxWindowBits) && this.clientNoContextTakeover == webSocketExtensions.clientNoContextTakeover && uhy.e(this.serverMaxWindowBits, webSocketExtensions.serverMaxWindowBits) && this.serverNoContextTakeover == webSocketExtensions.serverNoContextTakeover && this.unknownValues == webSocketExtensions.unknownValues;
    }
