...
public final class Http2 {
    ...
    private static final String[] FRAME_NAMES = {JsUtil.ServiceType.DATA, "HEADERS", "PRIORITY", "RST_STREAM", "SETTINGS", "PUSH_PROMISE", "PING", "GOAWAY", "WINDOW_UPDATE", "CONTINUATION"};
    ...
    static {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            uhy.a(binaryString, "");
            strArr[i] = ujy.a(Util.format("%8s", binaryString), ' ', '0', false, 4, (Object) null);
        }
        BINARY = strArr;
    ...
    public final String formatFlags(int type, int flags) {
        ...
        if (type != 2 && type != 3) {
            ...
            if (type != 7 && type != 8) {
                ...
                String str2 = str;
                if (type != 5 || (flags & 4) == 0) {
                    return (type != 0 || (flags & 32) == 0) ? str2 : ujy.c(str2, "PRIORITY", "COMPRESSED", false, 4, (Object) null);
                }
                return ujy.c(str2, "HEADERS", "PUSH_PROMISE", false, 4, (Object) null);
            }
        }
        return BINARY[flags];
    }
