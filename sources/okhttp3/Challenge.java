...
public final class Challenge {
    ...
    */
    ...
    public final Challenge withCharset(Charset charset) {
        ...
        Map b = ufs.b(this.authParams);
        String name = charset.name();
        uhy.a(name, "");
        b.put("charset", name);
        return new Challenge(this.scheme, (Map<String, String>) b);
    }
    ...
    public final Charset m1003deprecated_charset() {
        return charset();
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof Challenge) {
            ...
            if (uhy.e((Object) challenge.scheme, (Object) this.scheme) && uhy.e(challenge.authParams, this.authParams)) {
                return true;
            }
        }
        return false;
