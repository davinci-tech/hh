...
public abstract class AbstractFileHeader extends ZipHeader {
    private use aesExtraDataRecord;
    private CompressionMethod compressionMethod;
    private boolean dataDescriptorExists;
    private List<usp> extraDataRecords;
    ...
    public long getLastModifiedTimeEpoch() {
        return utd.a(this.lastModifiedTime);
    }
    ...
    public uss getZip64ExtendedInfo() {
        return this.zip64ExtendedInfo;
    }

    public void setZip64ExtendedInfo(uss ussVar) {
        this.zip64ExtendedInfo = ussVar;
    }

    public use getAesExtraDataRecord() {
        return this.aesExtraDataRecord;
    }

    public void setAesExtraDataRecord(use useVar) {
        this.aesExtraDataRecord = useVar;
    }
    ...
    public List<usp> getExtraDataRecords() {
        return this.extraDataRecords;
    }

    public void setExtraDataRecords(List<usp> list) {
