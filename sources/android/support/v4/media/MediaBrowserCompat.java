...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            int i = this.mState;
            if (i != 0 && i != 1) {
                throw new IllegalStateException("connect() called while neigther disconnecting nor disconnected (state=" + getStateLabel(this.mState) + Constants.RIGHT_BRACKET_ONLY);
            }
            this.mState = 2;
                ...
                */
                public void run() {
                    ...
                    L31:
                        ...
                        android.support.v4.media.MediaBrowserCompat$MediaBrowserImplBase r2 = android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.this     // Catch: java.lang.Exception -> L64
                        android.content.Context r2 = r2.mContext     // Catch: java.lang.Exception -> L64
                        android.support.v4.media.MediaBrowserCompat$MediaBrowserImplBase r3 = android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.this     // Catch: java.lang.Exception -> L64
                        android.support.v4.media.MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection r3 = r3.mServiceConnection     // Catch: java.lang.Exception -> L64
                        r4 = 1
                        boolean r1 = r2.bindService(r1, r3, r4)     // Catch: java.lang.Exception -> L64
                        if (r1 != 0) goto L85
                        goto L79
                    L64:
                        java.lang.StringBuilder r1 = new java.lang.StringBuilder
        ...
        public ComponentName getServiceComponent() {
            if (!isConnected()) {
                throw new IllegalStateException("getServiceComponent() called while not connected (state=" + this.mState + Constants.RIGHT_BRACKET_ONLY);
            }
        ...
        public String getRoot() {
            if (!isConnected()) {
                throw new IllegalStateException("getRoot() called while not connected(state=" + getStateLabel(this.mState) + Constants.RIGHT_BRACKET_ONLY);
            }
            return this.mRootId;
        }
        ...
        public Bundle getExtras() {
            if (!isConnected()) {
                throw new IllegalStateException("getExtras() called while not connected (state=" + getStateLabel(this.mState) + Constants.RIGHT_BRACKET_ONLY);
            }
            return this.mExtras;
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            if (!isConnected()) {
                throw new IllegalStateException("getSessionToken() called while not connected(state=" + this.mState + Constants.RIGHT_BRACKET_ONLY);
            }
        ...
        public void search(final String str, final Bundle bundle, final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException("search() called while not connected (state=" + getStateLabel(this.mState) + Constants.RIGHT_BRACKET_ONLY);
            }
            try {
            ...
            public void onServiceConnected(final ComponentName componentName, final IBinder iBinder) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.1
                    ...
                    public void run() {
                        ...
                        if (MediaServiceConnection.this.isCurrent(Constant.SERVICE_CONNECT_MESSAGE)) {
    ...
    static class CustomActionResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int i, Bundle bundle) {
            ...
            Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + i + " (extras=" + this.mExtras + ", resultData=" + bundle + Constants.RIGHT_BRACKET_ONLY);
        }
    }
}
