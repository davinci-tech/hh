...
public interface IOStream<T> extends IOBaseStream<T, IOStream<T>, Stream<T>> {
    ...
    default boolean allMatch(final IOPredicate<? super T> iOPredicate) throws IOException {
        return unwrap().allMatch(new Predicate() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda12
    ...
    default boolean anyMatch(final IOPredicate<? super T> iOPredicate) throws IOException {
        return unwrap().anyMatch(new Predicate() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean test;
                test = Erase.test(IOPredicate.this, obj);
    ...
    default <R> R collect(final IOSupplier<R> iOSupplier, final IOBiConsumer<R, ? super T> iOBiConsumer, final IOBiConsumer<R, R> iOBiConsumer2) throws IOException {
        return (R) unwrap().collect(new Supplier() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda5
    ...
    default IOStream<T> filter(final IOPredicate<? super T> iOPredicate) throws IOException {
        return adapt(unwrap().filter(new Predicate() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda16
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean test;
                test = Erase.test(IOPredicate.this, obj);
    ...
    default <R> IOStream<R> flatMap(final IOFunction<? super T, ? extends IOStream<? extends R>> iOFunction) throws IOException {
        return adapt(unwrap().flatMap(new Function() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda10
    ...
    default DoubleStream flatMapToDouble(final IOFunction<? super T, ? extends DoubleStream> iOFunction) throws IOException {
        return unwrap().flatMapToDouble(new Function() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda14
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return IOStream.lambda$flatMapToDouble$7(IOFunction.this, obj);
            }
        });
    }
    ...
    default IntStream flatMapToInt(final IOFunction<? super T, ? extends IntStream> iOFunction) throws IOException {
        return unwrap().flatMapToInt(new Function() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda3
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return IOStream.lambda$flatMapToInt$8(IOFunction.this, obj);
            }
        });
    }
    ...
    default LongStream flatMapToLong(final IOFunction<? super T, ? extends LongStream> iOFunction) throws IOException {
        return unwrap().flatMapToLong(new Function() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda2
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return IOStream.lambda$flatMapToLong$9(IOFunction.this, obj);
            }
        });
    }
    ...
    default void forAll(IOConsumer<T> iOConsumer, final BiFunction<Integer, IOException, IOException> biFunction) throws IOExceptionList {
        ...
        unwrap().forEach(new Consumer() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda22
    ...
    default <R> IOStream<R> map(final IOFunction<? super T, ? extends R> iOFunction) throws IOException {
        return adapt(unwrap().map(new Function() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda11
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Object apply;
    ...
    default Optional<T> max(final IOComparator<? super T> iOComparator) throws IOException {
        return unwrap().max(new Comparator() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda17
    ...
    default Optional<T> min(final IOComparator<? super T> iOComparator) throws IOException {
        return unwrap().min(new Comparator() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda8
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                int compare;
                compare = Erase.compare(IOComparator.this, obj, obj2);
    ...
    default boolean noneMatch(final IOPredicate<? super T> iOPredicate) throws IOException {
        return unwrap().noneMatch(new Predicate() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda23
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean test;
                test = Erase.test(IOPredicate.this, obj);
    ...
    default IOStream<T> peek(final IOConsumer<? super T> iOConsumer) throws IOException {
        return adapt(unwrap().peek(new Consumer() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda9
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                Erase.accept(IOConsumer.this, obj);
            }
    ...
    default Optional<T> reduce(final IOBinaryOperator<T> iOBinaryOperator) throws IOException {
        return unwrap().reduce(new BinaryOperator() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda15
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
                Object apply;
    ...
    default T reduce(T t, final IOBinaryOperator<T> iOBinaryOperator) throws IOException {
        return unwrap().reduce(t, new BinaryOperator() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda21
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
                Object apply;
                apply = Erase.apply(IOBinaryOperator.this, obj, obj2);
    ...
    default <U> U reduce(U u, final IOBiFunction<U, ? super T, U> iOBiFunction, final IOBinaryOperator<U> iOBinaryOperator) throws IOException {
        return (U) unwrap().reduce(u, new BiFunction() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda18
            @Override // java.util.function.BiFunction
            public final Object apply(Object obj, Object obj2) {
                Object apply;
    ...
    default IOStream<T> sorted(final IOComparator<? super T> iOComparator) throws IOException {
        return adapt(unwrap().sorted(new Comparator() { // from class: org.apache.commons.io.function.IOStream$$ExternalSyntheticLambda1
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                int compare;
                compare = Erase.compare(IOComparator.this, obj, obj2);
