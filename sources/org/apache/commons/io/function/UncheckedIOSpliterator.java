...
final class UncheckedIOSpliterator<T> implements Spliterator<T> {
    ...
    public void forEachRemaining(Consumer<? super T> consumer) {
        ...
        IOConsumer iOConsumer = new IOConsumer() { // from class: org.apache.commons.io.function.UncheckedIOSpliterator$$ExternalSyntheticLambda0
    ...
    public boolean tryAdvance(Consumer<? super T> consumer) {
        final IOSpliterator<T> iOSpliterator = this.delegate;
        Objects.requireNonNull(iOSpliterator);
        IOFunction iOFunction = new IOFunction() { // from class: org.apache.commons.io.function.UncheckedIOSpliterator$$ExternalSyntheticLambda3
