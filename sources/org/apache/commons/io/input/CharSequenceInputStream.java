...
public class CharSequenceInputStream extends InputStream {
    ...
    public static class Builder extends AbstractStreamBuilder<CharSequenceInputStream, Builder> {
        ...
        public CharSequenceInputStream get() {
            return (CharSequenceInputStream) Uncheck.get(new IOSupplier() { // from class: org.apache.commons.io.input.CharSequenceInputStream$Builder$$ExternalSyntheticLambda0
                @Override // org.apache.commons.io.function.IOSupplier
                public final Object get() {
                    return CharSequenceInputStream.Builder.this.m1180xc0c8f29c();
                }
            });
        }

        /* renamed from: lambda$get$0$org-apache-commons-io-input-CharSequenceInputStream$Builder, reason: not valid java name */
        /* synthetic */ CharSequenceInputStream m1180xc0c8f29c() throws IOException {
        ...
        /* synthetic */ CharsetEncoder m1181xabe124b9() {
        ...
        public Builder setCharsetEncoder(CharsetEncoder charsetEncoder) {
            CharsetEncoder charsetEncoder2 = CharsetEncoders.toCharsetEncoder(charsetEncoder, new Supplier() { // from class: org.apache.commons.io.input.CharSequenceInputStream$Builder$$ExternalSyntheticLambda1
                @Override // java.util.function.Supplier
                public final Object get() {
                    return CharSequenceInputStream.Builder.this.m1181xabe124b9();
                }
            });
    ...
    private CharSequenceInputStream(CharSequence charSequence, int i, CharsetEncoder charsetEncoder) {
        ...
        ByteBuffer allocate = ByteBuffer.allocate(ReaderInputStream.checkMinBufferSize(charsetEncoder, i));
        this.bBuf = allocate;
        allocate.flip();
