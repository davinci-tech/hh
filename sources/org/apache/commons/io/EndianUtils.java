...
public class EndianUtils {
    ...
    public static int readSwappedInteger(byte[] bArr, int i) {
        validateByteArrayOffset(bArr, i, 4);
    ...
    public static long readSwappedLong(byte[] bArr, int i) {
        validateByteArrayOffset(bArr, i, 8);
    ...
    public static short readSwappedShort(byte[] bArr, int i) {
        validateByteArrayOffset(bArr, i, 2);
    ...
    private static void validateByteArrayOffset(byte[] bArr, int i, int i2) {
        int i3 = i + i2;
        if (bArr.length >= i3) {
            return;
        }
