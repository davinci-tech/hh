...
public class CompositeFileComparator extends AbstractFileComparator implements Serializable {
    ...
    public CompositeFileComparator(Iterable<Comparator<File>> iterable) {
        ...
        if (iterable == null) {
            ...
            comparatorArr = (Comparator[]) StreamSupport.stream(iterable.spliterator(), false).toArray(new IntFunction() { // from class: org.apache.commons.io.comparator.CompositeFileComparator$$ExternalSyntheticLambda0
    ...
    public int compare(final File file, final File file2) {
        return ((Integer) Stream.of((Object[]) this.delegates).map(new Function() { // from class: org.apache.commons.io.comparator.CompositeFileComparator$$ExternalSyntheticLambda1
            ...
            public final Object apply(Object obj) {
                Integer valueOf;
                valueOf = Integer.valueOf(((Comparator) obj).compare(file, file2));
                return valueOf;
            }
