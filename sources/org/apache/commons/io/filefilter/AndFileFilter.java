...
public class AndFileFilter extends AbstractFileFilter implements ConditionalFileFilter, Serializable {
    ...
    public boolean accept(final File file, final String str) {
        return !isEmpty() && this.fileFilters.stream().allMatch(new Predicate() { // from class: org.apache.commons.io.filefilter.AndFileFilter$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean accept;
    ...
    public FileVisitResult accept(final Path path, final BasicFileAttributes basicFileAttributes) {
        return isEmpty() ? FileVisitResult.TERMINATE : toDefaultFileVisitResult(this.fileFilters.stream().allMatch(new Predicate() { // from class: org.apache.commons.io.filefilter.AndFileFilter$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public void addFileFilter(IOFileFilter... iOFileFilterArr) {
        Stream.of((Object[]) Objects.requireNonNull(iOFileFilterArr, "fileFilters")).forEach(new Consumer() { // from class: org.apache.commons.io.filefilter.AndFileFilter$$ExternalSyntheticLambda0
