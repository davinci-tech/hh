...
public class FileFilterUtils {
    ...
    private static <R, A> R filterFiles(final IOFileFilter iOFileFilter, Stream<File> stream, Collector<? super File, A, R> collector) {
        ...
        return (R) stream.filter(new Predicate() { // from class: org.apache.commons.io.filefilter.FileFilterUtils$$ExternalSyntheticLambda1
    ...
    public static List<IOFileFilter> toList(IOFileFilter... iOFileFilterArr) {
        return (List) Stream.of((Object[]) Objects.requireNonNull(iOFileFilterArr, "filters")).map(new Function() { // from class: org.apache.commons.io.filefilter.FileFilterUtils$$ExternalSyntheticLambda0
