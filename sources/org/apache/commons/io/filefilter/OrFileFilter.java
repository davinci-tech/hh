...
public class OrFileFilter extends AbstractFileFilter implements ConditionalFileFilter, Serializable {
    ...
    public boolean accept(final File file, final String str) {
        return this.fileFilters.stream().anyMatch(new Predicate() { // from class: org.apache.commons.io.filefilter.OrFileFilter$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean accept;
    ...
    public FileVisitResult accept(final Path path, final BasicFileAttributes basicFileAttributes) {
        return toDefaultFileVisitResult(this.fileFilters.stream().anyMatch(new Predicate() { // from class: org.apache.commons.io.filefilter.OrFileFilter$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
    ...
    public void addFileFilter(IOFileFilter... iOFileFilterArr) {
        Stream.of((Object[]) Objects.requireNonNull(iOFileFilterArr, "fileFilters")).forEach(new Consumer() { // from class: org.apache.commons.io.filefilter.OrFileFilter$$ExternalSyntheticLambda2
