...
public enum FileSystem {
    ...
    public boolean isLegalFileName(CharSequence charSequence) {
        ...
        return charSequence.chars().noneMatch(new IntPredicate() { // from class: org.apache.commons.io.FileSystem$$ExternalSyntheticLambda0
    ...
    public String toLegalFileName(String str, final char c) {
        ...
        int[] array = str.chars().map(new IntUnaryOperator() { // from class: org.apache.commons.io.FileSystem$$ExternalSyntheticLambda1
            @Override // java.util.function.IntUnaryOperator
            public final int applyAsInt(int i2) {
                return FileSystem.this.m1139lambda$toLegalFileName$0$orgapachecommonsioFileSystem(c, i2);
            }
        }).toArray();
    ...
    /* synthetic */ int m1139lambda$toLegalFileName$0$orgapachecommonsioFileSystem(char c, int i) {
