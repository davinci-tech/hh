...
public class FilterCollectionWriter extends Writer {
    ...
    public Writer append(final CharSequence charSequence) throws IOException {
        return forAllWriters(new IOConsumer() { // from class: org.apache.commons.io.output.FilterCollectionWriter$$ExternalSyntheticLambda6
            @Override // org.apache.commons.io.function.IOConsumer
            public final void accept(Object obj) {
    ...
    public Writer append(final CharSequence charSequence, final int i, final int i2) throws IOException {
        return forAllWriters(new IOConsumer() { // from class: org.apache.commons.io.output.FilterCollectionWriter$$ExternalSyntheticLambda4
            @Override // org.apache.commons.io.function.IOConsumer
            public final void accept(Object obj) {
    ...
    public void flush() throws IOException {
        forAllWriters(new IOConsumer() { // from class: org.apache.commons.io.output.FilterCollectionWriter$$ExternalSyntheticLambda9
            @Override // org.apache.commons.io.function.IOConsumer
            public final void accept(Object obj) {
                ((Writer) obj).flush();
            }
    ...
    public void write(final char[] cArr, final int i, final int i2) throws IOException {
        forAllWriters(new IOConsumer() { // from class: org.apache.commons.io.output.FilterCollectionWriter$$ExternalSyntheticLambda10
            @Override // org.apache.commons.io.function.IOConsumer
            public final void accept(Object obj) {
    ...
    public void write(final String str, final int i, final int i2) throws IOException {
        forAllWriters(new IOConsumer() { // from class: org.apache.commons.io.output.FilterCollectionWriter$$ExternalSyntheticLambda1
            @Override // org.apache.commons.io.function.IOConsumer
            public final void accept(Object obj) {
    ...
    private Stream<Writer> writers() {
        return this.writers.stream().filter(new Predicate() { // from class: org.apache.commons.io.output.FilterCollectionWriter$$ExternalSyntheticLambda0
